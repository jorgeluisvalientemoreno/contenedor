...
use_nl( g h )
*/
 instancias_flujo.package_id Solicitud,
 level "Nivel",
  ...
  FROM (SELECT /*+ leading( a )
         ...
         mp.package_id
          FROM open.wf_data_external a,
               ...
               open.wf_unit          f,
               open.mo_packages      mp
         WHERE a.package_id = mp.package_id --998937
           AND b.unit_type_id = a.unit_type_id -- 31657381
           AND c.plan_id = a.plan_id
           AND f.unit_id(+) = c.unit_id
           and mp.package_type_id = 100229
           and mp.motive_status_id = 13
        --and c.unit_type_id = 100221
        ) instancias_flujo,
 ...
 WHERE 1 = 1
   and d.instance_status_id = instancias_flujo.status_id
   ...
   and instancias_flujo.unit_type_id = 100221
   and d.instance_status_id = 1
