        ...
        if nuCategory = 3 then
            ...
            if nuParentId IS not null then
                ...
                for rcProcssDinam in cuProcssDinam(nuUnitType) loop
                    ...
                    if nuParentId IS not null then
                        dbms_output.put_Line('Proceso din�mico [Tipo de Componente :['||rcProcssDinam.component_type_id||' Tipo de Motivo:'||rcProcssDinam.motive_type_id||' Activo:'||rcProcssDinam.active||']');
