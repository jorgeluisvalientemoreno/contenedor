...
SELECT /*+
                ...
                */
 ge_items.items_id,
 decode((select mp.liquidation_method
          from open.mo_packages mp
         where mp.package_id = 224551078), --mo_boPackages.fnugetliquidmethod(224551078)
 ...
 --pkBillConst.DEBITO 
  AS sign_
  FROM /*+ CC_BCQuotationItem.cuConceptsInQuotation */
       open.cc_quotation_item item,
