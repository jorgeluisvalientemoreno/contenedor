...
-- and gis.serie = 'MB-1414'
 where 1 = 1
   and a.operating_unit_id in (4559, 4560)
   and a.items_id in (10002011);
...
--Inventario 
select a.* from open.ldc_inv_ouib a where a.operating_unit_id = 799;
...
select *
 ...
 where gis.serie in ('MB-1414', 'MA-2718')
