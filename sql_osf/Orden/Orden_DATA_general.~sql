...
select distinct oo.order_id Orden,
                ...
                gc.class_causal_id || ' - ' || x.description Clasificacion_Causal,
                ...
                ms.suspension_type_id Tipo_suspension_Solicitud
  ...
  left join open.mo_suspension ms
    on ms.motive_id = mm.motive_id
   and 'S' = &Consulta_Tipo_Suspen_Solicitud
 where 1 = 1
---Orden
-- and ooa.order_id in (360396755 )
