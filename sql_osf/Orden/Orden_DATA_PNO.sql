--DATA Orden
select distinct fpn.possible_ntl_id Proyecto_PNO,
                DECODE(fpn.status,
                       'P',
                       'P - Pendiente',
                       'E',
 ...
 where ooa.order_id = oo.order_id
   ...
   and fpn.order_id = oo.order_id
   AND (fpn.product_id = ooa.product_id or fpn.address_id = ooa.address_id)
