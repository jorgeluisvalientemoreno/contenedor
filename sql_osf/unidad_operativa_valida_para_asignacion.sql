SELECT /*+ ordered
 ...
 or_oper_unit_status.valid_for_assign,or_operating_unit.valid_for_assign 
...
/*+ OR_BCOperUnit_Admin.fsbValidOperUnitAssign SAO168500 */
 WHERE or_oper_unit_status.oper_unit_status_id =
   ...
   AND or_operating_unit.operating_unit_id = 4251 
   AND or_ope_uni_task_type.task_type_id = 11293
   --AND ge_sectorope_zona.id_sector_operativo = 666 
   ...
   AND or_operating_unit.assign_type not in
       (/*or_bcorderoperatingunit.csbASSIGN_SCHED,
        or_bcorderoperatingunit.csbASSIGN_ROUTE*/'S,R')
