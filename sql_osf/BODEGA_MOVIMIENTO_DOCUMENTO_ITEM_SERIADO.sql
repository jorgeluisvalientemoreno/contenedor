SELECT gis.id_items_seriado,
       ...
       DECODE(gis.estado_tecnico,
              ...
              '(R)EACONDICIONADO',
              'D',
              '(D)AÑADO') ESTADO_TECNICO,
       gis.id_items_estado_inv || ' - ' || giei.descripcion ESTADO_SERIADO_FINAL,
       a.id_items_estado_inv || ' - ' || gieim.descripcion ESTADO_FINAL_INVENTARIO,
       a.init_inv_stat_items || ' - ' || gieis.descripcion ESTADO_INICIAL_INVENTARIO,
 ...
 WHERE 1 = 1
   ...
   and a.id_items_seriado = 1432621
