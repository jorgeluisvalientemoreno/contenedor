SELECT ge_items.code || ' - ' || ge_items.description item_description,
  ...
  FROM open.ge_items, open.ge_item_classif, open.ge_items_seriado /*+ OR_BCOperUnit_Admin.frfGetOperUnitItems SAO197153 */
 WHERE 1 = 1
...
select *
 ...
 where serie in ('T-20900343-2009',
                 '982912',
                 'N-602198',
                 'R-982908',
                 'N-20502603V',
