select distinct dt.OWNER Propietario,
                dt.TABLE_NAME ENTIDAD,
                decode(nvl(ge.description, '0'),
                       '0',
                       atc.COMMENTS,
                       ge.description) Comentario,
 ...
 where 1 = 1
   AND dt.OWNER in
       ('OPEN', 'ADM_PERSON', 'PERSONALIZACIONES', 'MULTIEMPRESA')
      --and ge.name_ in UPPEr('mo_packages')
   and 1 = 1;
