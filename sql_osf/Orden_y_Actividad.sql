...
select distinct oo.order_id, ---||',',
  ...
  from open.or_order_activity  ooa,
       ...
       open.pr_product         pp,
       open.or_related_order   orden_padre,
       open.or_related_order   orden_hija
 where ooa.order_id = oo.order_id
   and ooa.order_id in (329681621)
   ...
   and orden_hija.order_id(+) = oo.order_id
   and orden_padre.related_order_id(+) = oo.order_id
