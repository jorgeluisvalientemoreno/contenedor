  ...
  BEGIN
    ...
    FOR i IN cuordenesgenerarnovedadact(nuparacta) LOOP
      ...
      IF i.actividad_novedad_ofertados is not null THEN
        BEGIN
          dbms_output.put_line('ldc_uni_act_ot2
            (nussesion,
             unidad_operativa,
             actividad,
             item,
          ...
          VALUES
            (' || nuparsesion || ',' ||
                               ...
                               nuitems || ',' || i.cantidad_legalizada || ',' ||
                               i.liquidacion || ',' || nuparacta || ',' ||
...
BEGIN
  ...
  dbms_output.put_line('sbEntrega554: ' || sbEntrega554);
  ...
  IF fblaplicaentrega(sbEntrega) THEN
    ...
    dbms_output.put_line('ldcprollenaldcuniactot(nupaacta:' || nupaacta ||
                         ', nuvaanoper:' || nuvaanoper || ', nuvamesper:' ||
                         nuvamesper || ', dtfechafinacta:' ||
                         dtfechafinacta || ', nusession:' || nusession || ')');
