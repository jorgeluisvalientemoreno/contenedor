...
set linesize 1000
set timing on
execute dbms_application_info.set_action('APLICANDO OSF-2724');
...
prompt "src/gascaribe/fnb/siniestros/ldc_pkcrmtramisegbri.sql"
@src/gascaribe/fnb/siniestros/ldc_pkcrmtramisegbri.sql
