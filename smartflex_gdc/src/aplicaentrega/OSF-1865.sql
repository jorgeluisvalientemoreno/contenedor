...
prompt Borrado del paquete y sinónimos para: ldc_proccreasolicitudnotifi
@src/gascaribe/papelera-reciclaje/procedimientos/ldc_proccreasolicitudnotifi.sql
show errors; 

prompt Inserte en tabla homologacion_servicios
@src/gascaribe/datafix/OSF-1865_ajuste_homologacion_servicios.sql
