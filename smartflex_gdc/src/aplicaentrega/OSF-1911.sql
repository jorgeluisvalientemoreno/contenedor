...
prompt "src/gascaribe/gestion-ordenes/paquetes/adm_person.pkg_bcordenes.sql"
@src/gascaribe/gestion-ordenes/paquetes/adm_person.pkg_bcordenes.sql

prompt "src/gascaribe/servicios-nuevos/paquetes/personalizaciones.pkg_gestion_producto.sql"
...
prompt "src/gascaribe/datafix/OSF-1911_1.sql"
@src/gascaribe/datafix/OSF-1911_1.sql
