...
prompt "------------------------------------------------------"
prompt "Aplicandosrc/gascaribe/facturacion/facturacion_electronica/sql/parametros/personalizaciones.condiciones_especial_ventas.sql"
@src/gascaribe/facturacion/facturacion_electronica/sql/parametros/personalizaciones.condiciones_especial_ventas.sql
