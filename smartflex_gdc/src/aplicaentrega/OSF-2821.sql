...
set linesize 1000
set timing on
execute dbms_application_info.set_action('APLICANDO OSF-2821');
...
prompt "src/gascaribe/gestion-ordenes/fwcpb/ORASAR.sql"
@src/gascaribe/gestion-ordenes/fwcpb/ORASAR.sql
