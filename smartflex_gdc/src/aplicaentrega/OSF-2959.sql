...
set linesize 1000
set timing on
execute dbms_application_info.set_action('APLICANDO OSF-2959');
...
prompt "src/gascaribe/cartera/medidores-prepago/procedimientos/ldc_pgeneratebillprep.sql"
