...
prompt Modificación ldcproccreatramirevprpxml
@src/gascaribe/revision-periodica/plugin/ldcproccreatramirevprpxml.sql
show errors; 

prompt Crea sinónimo open.ldcproccreatramirev
@src/gascaribe/revision-periodica/sinonimos/open.ldcproccreatramirevprpxml.sql
