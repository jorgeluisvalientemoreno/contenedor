...
prompt "@src/gascaribe/facturacion/paquetes/adm_person.pkg_cuencobr.sql"
@src/gascaribe/facturacion/paquetes/adm_person.pkg_cuencobr.sql

prompt "@src/gascaribe/general/paquetes/adm_person.pkg_ldc_log_pb.sql"
@src/gascaribe/general/paquetes/adm_person.pkg_ldc_log_pb.sql

prompt "@src/gascaribe/cartera/paquetes/adm_person.pkg_gc_debt_negot_prod.sql"
@src/gascaribe/cartera/paquetes/adm_person.pkg_gc_debt_negot_prod.sql

prompt "@src/gascaribe/cartera/paquetes/adm_person.pkg_gc_debt_negot_charge.sql"
@src/gascaribe/cartera/paquetes/adm_person.pkg_gc_debt_negot_charge.sql
