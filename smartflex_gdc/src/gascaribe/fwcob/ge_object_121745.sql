...
BEGIN
sa_bocreatePackages.CreatePackage('GE_OBJECT_121745_',
'CREATE OR REPLACE PACKAGE GE_OBJECT_121745_ IS ' || chr(10) ||
...
'tb1_1 ty1_1; ' || chr(10) ||
'END GE_OBJECT_121745_;');
END;
/


BEGIN ut_trace.trace('********************Comenzar proceso de objeto:GE_OBJECT_121745_******************************'); END;
/


BEGIN

if (not GE_OBJECT_121745_.blProcessStatus) then
 return;
end if;
  ut_trace.trace('Borrando tabla GE_OBJECT_PARAMETER',1);
  DELETE FROM GE_OBJECT_PARAMETER WHERE (OBJECT_NAME) in (SELECT NAME_ FROM GE_OBJECT WHERE OBJECT_ID=121745);

exception when others then
GE_OBJECT_121745_.blProcessStatus := false;
rollback;
...
if (not GE_OBJECT_121745_.blProcessStatus) then
 return;
  ...
  DELETE FROM GR_CONFTYPE_OBJECT WHERE (OBJECT_NAME) in (SELECT NAME_ FROM GE_OBJECT WHERE OBJECT_ID=121745);
...
SELECT rowid
FROM GE_OBJECT WHERE OBJECT_ID=121745;
...
GE_OBJECT_121745_.tb0_0(0):=121745;
GE_OBJECT_121745_.tb0_2(0):='LDC_PKCONTRATO.PROCONSULTACONTRATO'
;
ut_trace.trace('Actualizar o insertar tabla: GE_OBJECT fila (0)',1);
UPDATE GE_OBJECT SET OBJECT_ID=GE_OBJECT_121745_.tb0_0(0),
OBJECT_TYPE_ID=20,
NAME_=GE_OBJECT_121745_.tb0_2(0),
MODULE_ID=61,
DESCRIPTION='Consultar contratos CTCCO'
,
COMMENT_='Consultar contratos CTCCO'
,
PARAMETERS='()'
,
OBJECT_CLASS='P'
,
RETURN_TYPE=null
 WHERE OBJECT_ID = GE_OBJECT_121745_.tb0_0(0);
...
VALUES (GE_OBJECT_121745_.tb0_0(0),
20,
GE_OBJECT_121745_.tb0_2(0),
61,
'Consultar contratos CTCCO'
,
'Consultar contratos CTCCO'
,
'()'
...
GE_OBJECT_121745_.tb1_0(0):=54;
GE_OBJECT_121745_.tb1_1(0):=GE_OBJECT_121745_.tb0_2(0);
ut_trace.trace('insertando tabla: GR_CONFTYPE_OBJECT fila (0)',1);
INSERT INTO GR_CONFTYPE_OBJECT(CONFIGURA_TYPE_ID,OBJECT_NAME) 
VALUES (GE_OBJECT_121745_.tb1_0(0),
GE_OBJECT_121745_.tb1_1(0));
...
begin
SA_BOCreatePackages.DropPackage('GE_OBJECT_121745_');
end;
/

BEGIN ut_trace.trace('********************FIN  proceso de objeto:GE_OBJECT_121745_******************************'); end;
/
