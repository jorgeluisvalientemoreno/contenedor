Declare
	...
	where owner = 'OPEN'
	  and object_name= 'GC_CONTRACTORSCT321E121008788'
...
Begin
	...
	close cuExiste;
	if nuExiste>0 then
		sbSql := 'drop procedure GC_CONTRACTORSCT321E121008788';
		execute immediate sbSql;
		dbms_output.put_line('GC_CONTRACTORSCT321E121008788'||'|'||'BORRADO CORRECTAMENTE');
	end if;
Exception
	when others then
		dbms_output.put_line('GC_CONTRACTORSCT321E121008788'||'|'||sqlerrm);
End;
/
