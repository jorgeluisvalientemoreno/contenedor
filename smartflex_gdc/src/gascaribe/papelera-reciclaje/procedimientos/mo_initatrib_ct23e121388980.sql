Declare
	...
	where owner = 'OPEN'
	  and object_name= 'MO_INITATRIB_CT23E121388980'
...
Begin
	...
	close cuExiste;
	if nuExiste>0 then
		sbSql := 'drop procedure MO_INITATRIB_CT23E121388980';
		execute immediate sbSql;
		dbms_output.put_line('MO_INITATRIB_CT23E121388980'||'|'||'BORRADO CORRECTAMENTE');
	end if;
Exception
	when others then
		dbms_output.put_line('MO_INITATRIB_CT23E121388980'||'|'||sqlerrm);
End;
/
