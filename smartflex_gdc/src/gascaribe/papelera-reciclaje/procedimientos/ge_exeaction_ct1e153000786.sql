Declare
	...
	where owner = 'OPEN'
	  and object_name= 'GE_EXEACTION_CT1E153000786'
...
Begin
	...
	close cuExiste;
	if nuExiste>0 then
		sbSql := 'drop procedure GE_EXEACTION_CT1E153000786';
		execute immediate sbSql;
		dbms_output.put_line('GE_EXEACTION_CT1E153000786'||'|'||'BORRADO CORRECTAMENTE');
	end if;
Exception
	when others then
		dbms_output.put_line('GE_EXEACTION_CT1E153000786'||'|'||sqlerrm);
End;
/
