Declare
	...
	where owner = 'OPEN'
	  and object_name= 'FWFW_PROCESS_CT54E121000675'
...
Begin
	...
	close cuExiste;
	if nuExiste>0 then
		sbSql := 'drop procedure FWFW_PROCESS_CT54E121000675';
		execute immediate sbSql;
		dbms_output.put_line('FWFW_PROCESS_CT54E121000675'||'|'||'BORRADO CORRECTAMENTE');
	end if;
Exception
	when others then
		dbms_output.put_line('FWFW_PROCESS_CT54E121000675'||'|'||sqlerrm);
End;
/
