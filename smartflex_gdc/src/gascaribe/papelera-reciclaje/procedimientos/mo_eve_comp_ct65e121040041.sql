Declare
	...
	where owner = 'OPEN'
	  and object_name= 'MO_EVE_COMP_CT65E121040041'
...
Begin
	...
	close cuExiste;
	if nuExiste>0 then
		sbSql := 'drop procedure MO_EVE_COMP_CT65E121040041';
		execute immediate sbSql;
		dbms_output.put_line('MO_EVE_COMP_CT65E121040041'||'|'||'BORRADO CORRECTAMENTE');
	end if;
Exception
	when others then
		dbms_output.put_line('MO_EVE_COMP_CT65E121040041'||'|'||sqlerrm);
End;
/
