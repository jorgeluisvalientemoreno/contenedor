Declare
	...
	where owner = 'OPEN'
	  and object_name= 'GEGE_EXERULVAL_CT69E121388989'
...
Begin
	...
	close cuExiste;
	if nuExiste>0 then
		sbSql := 'drop procedure GEGE_EXERULVAL_CT69E121388989';
		execute immediate sbSql;
		dbms_output.put_line('GEGE_EXERULVAL_CT69E121388989'||'|'||'BORRADO CORRECTAMENTE');
	end if;
Exception
	when others then
		dbms_output.put_line('GEGE_EXERULVAL_CT69E121388989'||'|'||sqlerrm);
End;
/
