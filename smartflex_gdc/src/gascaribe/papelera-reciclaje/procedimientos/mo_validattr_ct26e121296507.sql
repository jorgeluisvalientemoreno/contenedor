Declare
	...
	where owner = 'OPEN'
	  and object_name= 'MO_VALIDATTR_CT26E121296507'
...
Begin
	...
	close cuExiste;
	if nuExiste>0 then
		sbSql := 'drop procedure MO_VALIDATTR_CT26E121296507';
		execute immediate sbSql;
		dbms_output.put_line('MO_VALIDATTR_CT26E121296507'||'|'||'BORRADO CORRECTAMENTE');
	end if;
Exception
	when others then
		dbms_output.put_line('MO_VALIDATTR_CT26E121296507'||'|'||sqlerrm);
End;
/
