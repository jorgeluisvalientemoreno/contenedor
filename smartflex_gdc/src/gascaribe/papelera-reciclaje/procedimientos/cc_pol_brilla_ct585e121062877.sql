Declare
	...
	where owner = 'OPEN'
	  and object_name= 'CC_POL_BRILLA_CT585E121062877'
...
Begin
	...
	close cuExiste;
	if nuExiste>0 then
		sbSql := 'drop procedure CC_POL_BRILLA_CT585E121062877';
		execute immediate sbSql;
		dbms_output.put_line('CC_POL_BRILLA_CT585E121062877'||'|'||'BORRADO CORRECTAMENTE');
	end if;
Exception
	when others then
		dbms_output.put_line('CC_POL_BRILLA_CT585E121062877'||'|'||sqlerrm);
End;
/
