Declare
	...
	where owner = 'OPEN'
	  and object_name= 'OR_SEL_TASTYP_CT404E121042185'
...
Begin
	...
	close cuExiste;
	if nuExiste>0 then
		sbSql := 'drop procedure OR_SEL_TASTYP_CT404E121042185';
		execute immediate sbSql;
		dbms_output.put_line('OR_SEL_TASTYP_CT404E121042185'||'|'||'BORRADO CORRECTAMENTE');
	end if;
Exception
	when others then
		dbms_output.put_line('OR_SEL_TASTYP_CT404E121042185'||'|'||sqlerrm);
End;
/
