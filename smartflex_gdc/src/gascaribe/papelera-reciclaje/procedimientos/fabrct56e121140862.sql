Declare
	...
	where owner = 'OPEN'
	  and object_name= 'FABRCT56E121140862'
...
Begin
	...
	close cuExiste;
	if nuExiste>0 then
		sbSql := 'drop procedure FABRCT56E121140862';
		execute immediate sbSql;
		dbms_output.put_line('FABRCT56E121140862'||'|'||'BORRADO CORRECTAMENTE');
	end if;
Exception
	when others then
		dbms_output.put_line('FABRCT56E121140862'||'|'||sqlerrm);
End;
/
