Declare
	...
	where owner = 'OPEN'
	  and object_name= 'FABRCT56E121140861'
...
Begin
	...
	close cuExiste;
	if nuExiste>0 then
		sbSql := 'drop procedure FABRCT56E121140861';
		execute immediate sbSql;
		dbms_output.put_line('FABRCT56E121140861'||'|'||'BORRADO CORRECTAMENTE');
	end if;
Exception
	when others then
		dbms_output.put_line('FABRCT56E121140861'||'|'||sqlerrm);
End;
/
