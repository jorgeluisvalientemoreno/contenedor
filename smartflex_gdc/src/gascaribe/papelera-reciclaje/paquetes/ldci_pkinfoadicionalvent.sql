CREATE OR REPLACE PACKAGE        "LDCI_PKINFOADICIONALVENT" AS
  /*
...
/
CREATE OR REPLACE PACKAGE BODY        "LDCI_PKINFOADICIONALVENT" AS
...
End LDCI_PKINFOADICIONALVENT;
/
GRANT EXECUTE on LDCI_PKINFOADICIONALVENT to SYSTEM_OBJ_PRIVS_ROLE;
/
