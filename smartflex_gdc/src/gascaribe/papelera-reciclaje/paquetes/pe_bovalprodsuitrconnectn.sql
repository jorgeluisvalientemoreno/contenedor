CREATE OR REPLACE PACKAGE PE_BOValProdSuitRconnectn AS
/*
...
/
CREATE OR REPLACE PACKAGE BODY PE_BOValProdSuitRconnectn AS
/*
    Propiedad intelectual de Open International Systems (c).
...
END PE_BOValProdSuitRconnectn;
/
GRANT EXECUTE on PE_BOVALPRODSUITRCONNECTN to SYSTEM_OBJ_PRIVS_ROLE;
GRANT EXECUTE on PE_BOVALPRODSUITRCONNECTN to REXEOPEN;
/
