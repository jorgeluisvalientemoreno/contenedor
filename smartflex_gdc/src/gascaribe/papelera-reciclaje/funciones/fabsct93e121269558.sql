Declare
	...
	where owner = 'OPEN'
	  and object_name= 'FABSCT93E121269558'
...
Begin
	...
	close cuExiste;
	if nuExiste>0 then
		sbSql := 'drop function FABSCT93E121269558';
		execute immediate sbSql;
		dbms_output.put_line('FABSCT93E121269558'||'|'||'BORRADO CORRECTAMENTE');
	end if;
Exception
	when others then
		dbms_output.put_line('FABSCT93E121269558'||'|'||sqlerrm);
End;
/
