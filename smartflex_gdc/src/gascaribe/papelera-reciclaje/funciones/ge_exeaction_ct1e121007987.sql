Declare
	...
	where owner = 'OPEN'
	  and object_name= 'GE_EXEACTION_CT1E121007987'
...
Begin
	...
	close cuExiste;
	if nuExiste>0 then
		sbSql := 'drop function GE_EXEACTION_CT1E121007987';
		execute immediate sbSql;
		dbms_output.put_line('GE_EXEACTION_CT1E121007987'||'|'||'BORRADO CORRECTAMENTE');
	end if;
Exception
	when others then
		dbms_output.put_line('GE_EXEACTION_CT1E121007987'||'|'||sqlerrm);
End;
/
