Declare
	...
	where owner = 'OPEN'
	  and object_name= 'IMIM_CT101E121023985'
...
Begin
	...
	close cuExiste;
	if nuExiste>0 then
		sbSql := 'drop function IMIM_CT101E121023985';
		execute immediate sbSql;
		dbms_output.put_line('IMIM_CT101E121023985'||'|'||'BORRADO CORRECTAMENTE');
	end if;
Exception
	when others then
		dbms_output.put_line('IMIM_CT101E121023985'||'|'||sqlerrm);
End;
/
