Declare
	...
	where owner = 'OPEN'
	  and object_name= 'FABSCT93E121006471'
...
Begin
	...
	close cuExiste;
	if nuExiste>0 then
		sbSql := 'drop function FABSCT93E121006471';
		execute immediate sbSql;
		dbms_output.put_line('FABSCT93E121006471'||'|'||'BORRADO CORRECTAMENTE');
	end if;
Exception
	when others then
		dbms_output.put_line('FABSCT93E121006471'||'|'||sqlerrm);
End;
/
