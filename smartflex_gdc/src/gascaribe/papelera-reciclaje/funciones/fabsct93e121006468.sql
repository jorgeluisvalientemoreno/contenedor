Declare
	...
	where owner = 'OPEN'
	  and object_name= 'FABSCT93E121006468'
...
Begin
	...
	close cuExiste;
	if nuExiste>0 then
		sbSql := 'drop function FABSCT93E121006468';
		execute immediate sbSql;
		dbms_output.put_line('FABSCT93E121006468'||'|'||'BORRADO CORRECTAMENTE');
	end if;
Exception
	when others then
		dbms_output.put_line('FABSCT93E121006468'||'|'||sqlerrm);
End;
/
