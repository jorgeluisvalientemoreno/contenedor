CREATE OR REPLACE TRIGGER   TRG_AU_AI_LDC_CONST__212_372 AFTER INSERT OR UPDATE OR DELETE ON  LDC_CONST_LIQTARRAN
  REFERENCING   OLD   AS   OLD   NEW   AS   NEW  
 FOR EACH ROW 
 DECLARE 
AUDIT_POLICY_IDvar AU_AUDIT_POLICY_LOG.AUDIT_POLICY_ID%type := 212;
AUDIT_LOG_IDvar AU_LOG_POLICY.AUDIT_LOG_ID%type := 372;
AUDIT_POLICY_LOG_IDvar AU_AUDIT_POLICY_LOG.AUDIT_POLICY_LOG_ID%type :=null;
CURRENT_TABLE_NAMEvar AU_AUDIT_POLICY_LOG.CURRENT_TABLE_NAME%type := 'LDC_CONST_LIQTARRAN';
...
BEGIN 
    ...
    -- checks if user the current process is audited BY the Audit Policy
      ...
      tbFIELD(1).FieldName := 'IDEN_REG';
      tbFIELD(1).OldValue := to_char(:OLD.IDEN_REG);
      tbFIELD(1).NewValue := to_char(:NEW.IDEN_REG);
      tbFIELD(1).IsMonitored := 1;
      tbFIELD(1).AttrTypeId := 1;
      -----------------------
      tbFIELD(2).FieldName := 'UNIDAD_OPERATIVA';
      tbFIELD(2).OldValue := to_char(:OLD.UNIDAD_OPERATIVA);
      tbFIELD(2).NewValue := to_char(:NEW.UNIDAD_OPERATIVA);
      tbFIELD(2).IsMonitored := 1;
      tbFIELD(2).AttrTypeId := 1;
      -----------------------
      tbFIELD(3).FieldName := 'ACTIVIDAD_ORDEN';
      tbFIELD(3).OldValue := to_char(:OLD.ACTIVIDAD_ORDEN);
      tbFIELD(3).NewValue := to_char(:NEW.ACTIVIDAD_ORDEN);
      tbFIELD(3).IsMonitored := 1;
      tbFIELD(3).AttrTypeId := 1;
      -----------------------
      tbFIELD(4).FieldName := 'CANTIDAD_INICIAL';
      tbFIELD(4).OldValue := to_char(:OLD.CANTIDAD_INICIAL);
      tbFIELD(4).NewValue := to_char(:NEW.CANTIDAD_INICIAL);
      tbFIELD(4).IsMonitored := 1;
      tbFIELD(4).AttrTypeId := 1;
      -----------------------
      tbFIELD(5).FieldName := 'CANTIDAD_FINAL';
      tbFIELD(5).OldValue := to_char(:OLD.CANTIDAD_FINAL);
      tbFIELD(5).NewValue := to_char(:NEW.CANTIDAD_FINAL);
      tbFIELD(5).IsMonitored := 1;
      tbFIELD(5).AttrTypeId := 1;
      -----------------------
      tbFIELD(6).FieldName := 'VALOR_LIQUIDAR';
      tbFIELD(6).OldValue := to_char(:OLD.VALOR_LIQUIDAR);
      tbFIELD(6).NewValue := to_char(:NEW.VALOR_LIQUIDAR);
      tbFIELD(6).IsMonitored := 1;
      tbFIELD(6).AttrTypeId := 1;
      -----------------------
      tbFIELD(7).FieldName := 'NOVEDAD_GENERAR';
      tbFIELD(7).OldValue := to_char(:OLD.NOVEDAD_GENERAR);
      tbFIELD(7).NewValue := to_char(:NEW.NOVEDAD_GENERAR);
      tbFIELD(7).IsMonitored := 1;
      tbFIELD(7).AttrTypeId := 1;
      -----------------------
      tbFIELD(8).FieldName := 'FECHA_INI_VIGEN';
      If :OLD.FECHA_INI_VIGEN IS not null then
          tbFIELD(8).OldValue := to_char(:OLD.FECHA_INI_VIGEN, ut_date.fsbDATE_FORMAT);
      End if;
      If :NEW.FECHA_INI_VIGEN IS not null then
          tbFIELD(8).NewValue := to_char(:NEW.FECHA_INI_VIGEN, ut_date.fsbDATE_FORMAT);
      End if;
      tbFIELD(8).IsMonitored := 1;
      tbFIELD(8).AttrTypeId := 3;
      -----------------------
      tbFIELD(9).FieldName := 'FECHA_FIN_VIGE';
      If :OLD.FECHA_FIN_VIGE IS not null then
          tbFIELD(9).OldValue := to_char(:OLD.FECHA_FIN_VIGE, ut_date.fsbDATE_FORMAT);
      End if;
      If :NEW.FECHA_FIN_VIGE IS not null then
          tbFIELD(9).NewValue := to_char(:NEW.FECHA_FIN_VIGE, ut_date.fsbDATE_FORMAT);
      End if;
      tbFIELD(9).IsMonitored := 1;
      tbFIELD(9).AttrTypeId := 3;
      -----------------------
      tbFIELD(10).FieldName := 'ITEMS';
      tbFIELD(10).OldValue := to_char(:OLD.ITEMS);
      tbFIELD(10).NewValue := to_char(:NEW.ITEMS);
      tbFIELD(10).IsMonitored := 1;
      tbFIELD(10).AttrTypeId := 1;
      -----------------------
      tbFIELD(11).FieldName := 'ZONA_OFERTADOS';
      tbFIELD(11).OldValue := to_char(:OLD.ZONA_OFERTADOS);
      tbFIELD(11).NewValue := to_char(:NEW.ZONA_OFERTADOS);
      tbFIELD(11).IsMonitored := 1;
      tbFIELD(11).AttrTypeId := 1;
      -----------------------
