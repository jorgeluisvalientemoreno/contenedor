MERGE INTO PERSONALIZACIONES.PARAMETROS A USING
 (SELECT
  'ACT_INS_CER_IND_LDC_FCVC' as "CODIGO",
  'ACTIVIDADES VALIDAS PARA LA CREACION DE LA ORDEN DE INSPECCION/CERTIFICACION INDUSTRIAL EN LA FORMA LDC_FCVC SEPARADOR (,) OSF-3104' as "DESCRIPCION",
  NULL as "VALOR_NUMERICO",
  '100002373,4295761,4294537' as "VALOR_CADENA",
  NULL as "VALOR_FECHA",
  9 as "PROCESO",
