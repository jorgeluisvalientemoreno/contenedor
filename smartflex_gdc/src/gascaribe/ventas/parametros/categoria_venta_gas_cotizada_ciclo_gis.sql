MERGE INTO PARAMETROS A USING
 (SELECT
  'CATEGORIA_VENTA_GAS_COTIZADA_CICLO_GIS' as "CODIGO",
  'CATEGORIA DE VENTA GAS COTIZADA PARA OBTENER CICLO CONFIGURADO EN GIS CON SEPARADOR(,) OSF-3054' as "DESCRIPCION",
