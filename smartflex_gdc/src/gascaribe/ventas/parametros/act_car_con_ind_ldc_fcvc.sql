MERGE INTO PERSONALIZACIONES.PARAMETROS A USING
 (SELECT
  'ACT_CAR_CON_IND_LDC_FCVC' as "CODIGO",
  'ACTIVIDADES VALIDAS PARA LA CREACION DE LA ORDEN DE CARGO POR CONEXION INDUSTRIAL EN LA FORMA LDC_FCVC SEPARADOR (,) OSF-3104' as "DESCRIPCION",
  NULL as "VALOR_NUMERICO",
  '4000054' as "VALOR_CADENA",
  NULL as "VALOR_FECHA",
  9 as "PROCESO",
