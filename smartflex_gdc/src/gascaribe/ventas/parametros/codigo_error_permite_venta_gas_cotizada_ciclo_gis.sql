MERGE INTO PARAMETROS A USING
 (SELECT
  'CODIGO_ERROR_PERMITE_VENTA_GAS_COTIZADA_CICLO_GIS' as "CODIGO",
  'CODIGO DE ERROR QUE PERMITE VENTA DE GAS COTIZADA AL OBTENER CICLO CONFIGURADO EN GIS CON SEPARADOR(,) OSF-3054' as "DESCRIPCION",
