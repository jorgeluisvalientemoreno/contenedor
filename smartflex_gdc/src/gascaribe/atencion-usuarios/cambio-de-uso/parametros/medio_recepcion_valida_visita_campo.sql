MERGE INTO OPEN.PARAMETROS A USING
 (SELECT
  'MEDIO_RECEPCION_VALIDA_VISITA_CAMPO' as "CODIGO",
  'MEDIO DE RECEPCION PARA VALIDAR SI SE REALIZA VISITA A CAMPO EN EL TRAMITE DE CAMBIO DE USO CON SEPARADOR(,) OSF-3674' as "DESCRIPCION",
