...
BEGIN
sa_bocreatePackages.CreatePackage('LDC_USER_NOTI_',
'CREATE OR REPLACE PACKAGE LDC_USER_NOTI_ IS ' || chr(10) ||
...
BEGIN ut_trace.trace('********************Comenzar proceso de objeto:LDC_USER_NOTI_******************************'); END;
/
...
DECLARE
    ...
    CURSOR  cuConfigExpression IS
        ...
        WHERE   GR_CONFIG_EXPRESSION.CONFIG_EXPRESSION_ID IN (
            ...
            WHERE   ENTITY_ID in (SELECT ENTITY_ID FROM GE_ENTITY WHERE NAME_='LDC_USER_NOTI')
            UNION
...
if (not LDC_USER_NOTI_.blProcessStatus) then
 return;
end if;
    ...
    DELETE FROM GE_ATTR_VAL_EXPRESS WHERE (ENTITY_ATTRIBUTE_ID) in (SELECT ENTITY_ATTRIBUTE_ID FROM GE_ENTITY_ATTRIBUTES WHERE (ENTITY_ID) in (SELECT ENTITY_ID FROM GE_ENTITY WHERE NAME_='LDC_USER_NOTI'));
    DELETE FROM GE_ATTR_ALLOWED_VALUES WHERE (ENTITY_ATTRIBUTE_ID) in (SELECT ENTITY_ATTRIBUTE_ID FROM GE_ENTITY_ATTRIBUTES WHERE (ENTITY_ID) in (SELECT ENTITY_ID FROM GE_ENTITY WHERE NAME_='LDC_USER_NOTI'));
...
BEGIN 
  LDC_USER_NOTI_.tbEntityAttributeName(90180183) := 'LDC_USER_NOTI@PRODUCT_ID'; 
  LDC_USER_NOTI_.tbEntityAttributeName(90180184) := 'LDC_USER_NOTI@CORREO'; 
  LDC_USER_NOTI_.tbEntityAttributeName(90180185) := 'LDC_USER_NOTI@NOTIFICABLE'; 
END;
/
...
LDC_USER_NOTI_.old_tb0_0(0):='LDC_USER_NOTI'
;
LDC_USER_NOTI_.tb0_0(0):='LDC_USER_NOTI';
LDC_USER_NOTI_.old_tb0_1(0):=5502;
LDC_USER_NOTI_.tb0_1(0):=GE_BOCATALOG.FNUGETIDSEQFROMCATALOG(LDC_USER_NOTI_.tb0_0(0), 'ENTITY', 'GE_BOSEQUENCE.NEXTGE_ENTITY');
LDC_USER_NOTI_.tb0_1(0):=LDC_USER_NOTI_.tb0_1(0);
ut_trace.trace('Actualizar o insertar tabla: GE_ENTITY fila (0)',1);
UPDATE GE_ENTITY SET NAME_=LDC_USER_NOTI_.tb0_0(0),
ENTITY_ID=LDC_USER_NOTI_.tb0_1(0),
MODULE_ID=61,
SELEC_TYPE_OBJECT_ID=null,
INS_SEQ=null,
IN_PERSIST='Y'
,
DESCRIPTION='Tabla de configuracion de nvio de correos'
,
DISPLAY_NAME='LDC_USER_NOTI'
,
LOAD_CARTRIDGE='N'
,
TABLESPACE='TSD_DEFAULT'
,
CREATION_DATE=to_date('15-08-2019 11:33:07','DD-MM-YYYY HH24:MI:SS'),
LAST_MODIFY_DATE=to_date('15-08-2019 11:33:07','DD-MM-YYYY HH24:MI:SS'),
STATUS='G'
,
ALLOWED_FULL_SCAN='Y'

 WHERE ENTITY_ID = LDC_USER_NOTI_.tb0_1(0);
...
VALUES (LDC_USER_NOTI_.tb0_0(0),
LDC_USER_NOTI_.tb0_1(0),
61,
null,
null,
'Y'
,
'Tabla de configuracion de nvio de correos'
,
'LDC_USER_NOTI'
,
'N'
...
'TSD_DEFAULT'
,
to_date('15-08-2019 11:33:07','DD-MM-YYYY HH24:MI:SS'),
to_date('15-08-2019 11:33:07','DD-MM-YYYY HH24:MI:SS'),
'G'
,
'Y'
...
LDC_USER_NOTI_.blProcessStatus := false;
rollback;
ut_trace.trace('**ERROR:'||sqlerrm);
raise;
END;
...
LDC_USER_NOTI_.tb1_0(0):=LDC_USER_NOTI_.tb0_1(0);
ut_trace.trace('Actualizar o insertar tabla: GE_ENTITY_ADITIONAL fila (0)',1);
UPDATE GE_ENTITY_ADITIONAL SET ENTITY_ID=LDC_USER_NOTI_.tb1_0(0),
STATEMENT_ID=null,
...
IS_CUSTOM_ENTITY='Y'
 ...
 WHERE ENTITY_ID = LDC_USER_NOTI_.tb1_0(0);
if not (sql%found) then
...
LDC_USER_NOTI_.tb2_0(0):=LDC_USER_NOTI_.tb0_1(0);
LDC_USER_NOTI_.old_tb2_1(0):=90180183;
LDC_USER_NOTI_.tb2_1(0):=GE_BOCATALOG.FNUGETIDSEQFROMCATALOG(LDC_USER_NOTI_.TBENTITYATTRIBUTENAME(LDC_USER_NOTI_.old_tb2_1(0)), 'ATTRIBUTE', GE_BOSEQUENCE.NEXTGE_ENTITY_ATTRIBUTES);
LDC_USER_NOTI_.tb2_1(0):=LDC_USER_NOTI_.tb2_1(0);
ut_trace.trace('Actualizar o insertar tabla: GE_ENTITY_ATTRIBUTES fila (0)',1);
UPDATE GE_ENTITY_ATTRIBUTES SET ENTITY_ID=LDC_USER_NOTI_.tb2_0(0),
ENTITY_ATTRIBUTE_ID=LDC_USER_NOTI_.tb2_1(0),
...
PROTECTOR_TEXT=null
 WHERE ENTITY_ATTRIBUTE_ID = LDC_USER_NOTI_.tb2_1(0);
if not (sql%found) then
...
VALUES (LDC_USER_NOTI_.tb2_0(0),
LDC_USER_NOTI_.tb2_1(0),
null,
null,
null,
null,
...
LDC_USER_NOTI_.tb2_0(1):=LDC_USER_NOTI_.tb0_1(0);
LDC_USER_NOTI_.old_tb2_1(1):=90180184;
LDC_USER_NOTI_.tb2_1(1):=GE_BOCATALOG.FNUGETIDSEQFROMCATALOG(LDC_USER_NOTI_.TBENTITYATTRIBUTENAME(LDC_USER_NOTI_.old_tb2_1(1)), 'ATTRIBUTE', GE_BOSEQUENCE.NEXTGE_ENTITY_ATTRIBUTES);
LDC_USER_NOTI_.tb2_1(1):=LDC_USER_NOTI_.tb2_1(1);
ut_trace.trace('Actualizar o insertar tabla: GE_ENTITY_ATTRIBUTES fila (1)',1);
UPDATE GE_ENTITY_ATTRIBUTES SET ENTITY_ID=LDC_USER_NOTI_.tb2_0(1),
ENTITY_ATTRIBUTE_ID=LDC_USER_NOTI_.tb2_1(1),
INIT_EXPRESSION_ID=null,
VALID_EXPRESSION_ID=null,
GI_COMPONENT_ID=null,
MASK_ID=null,
...
UNCHECKED_VALUE=null,
PROTECTOR_TEXT=null
 WHERE ENTITY_ATTRIBUTE_ID = LDC_USER_NOTI_.tb2_1(1);
if not (sql%found) then
INSERT INTO GE_ENTITY_ATTRIBUTES(ENTITY_ID,ENTITY_ATTRIBUTE_ID,INIT_EXPRESSION_ID,VALID_EXPRESSION_ID,GI_COMPONENT_ID,MASK_ID,REFERENCE,ATTRIBUTE_TYPE_ID,TECHNICAL_NAME,SECUENCE_,KEY_,IS_NULL,DISPLAY_NAME,VIEWER_DISPLAY,PRECISION,DEFAULT_VALUE,SCALE,LENGTH,COMMENT_,TAG_ELEMENT,STATUS,IS_DESCRIPTION,IS_LOV_DESCRIPTION,IS_CHECK_BOX,CHECKED_VALUE,UNCHECKED_VALUE,PROTECTOR_TEXT) 
VALUES (LDC_USER_NOTI_.tb2_0(1),
LDC_USER_NOTI_.tb2_1(1),
null,
null,
null,
null,
...
LDC_USER_NOTI_.tb2_0(2):=LDC_USER_NOTI_.tb0_1(0);
LDC_USER_NOTI_.old_tb2_1(2):=90180185;
LDC_USER_NOTI_.tb2_1(2):=GE_BOCATALOG.FNUGETIDSEQFROMCATALOG(LDC_USER_NOTI_.TBENTITYATTRIBUTENAME(LDC_USER_NOTI_.old_tb2_1(2)), 'ATTRIBUTE', GE_BOSEQUENCE.NEXTGE_ENTITY_ATTRIBUTES);
LDC_USER_NOTI_.tb2_1(2):=LDC_USER_NOTI_.tb2_1(2);
ut_trace.trace('Actualizar o insertar tabla: GE_ENTITY_ATTRIBUTES fila (2)',1);
UPDATE GE_ENTITY_ATTRIBUTES SET ENTITY_ID=LDC_USER_NOTI_.tb2_0(2),
ENTITY_ATTRIBUTE_ID=LDC_USER_NOTI_.tb2_1(2),
INIT_EXPRESSION_ID=null,
VALID_EXPRESSION_ID=null,
GI_COMPONENT_ID=null,
MASK_ID=null,
...
,
PROTECTOR_TEXT=null
 WHERE ENTITY_ATTRIBUTE_ID = LDC_USER_NOTI_.tb2_1(2);
if not (sql%found) then
INSERT INTO GE_ENTITY_ATTRIBUTES(ENTITY_ID,ENTITY_ATTRIBUTE_ID,INIT_EXPRESSION_ID,VALID_EXPRESSION_ID,GI_COMPONENT_ID,MASK_ID,REFERENCE,ATTRIBUTE_TYPE_ID,TECHNICAL_NAME,SECUENCE_,KEY_,IS_NULL,DISPLAY_NAME,VIEWER_DISPLAY,PRECISION,DEFAULT_VALUE,SCALE,LENGTH,COMMENT_,TAG_ELEMENT,STATUS,IS_DESCRIPTION,IS_LOV_DESCRIPTION,IS_CHECK_BOX,CHECKED_VALUE,UNCHECKED_VALUE,PROTECTOR_TEXT) 
VALUES (LDC_USER_NOTI_.tb2_0(2),
LDC_USER_NOTI_.tb2_1(2),
null,
null,
null,
null,
...
if (not LDC_USER_NOTI_.blProcessStatus) then
 return;
  ...
  commit;
  gi_boframeworkentityattribute.UpdateEntityReferences('LDC_USER_NOTI');
EXCEPTION
...
begin
SA_BOCreatePackages.DropPackage('LDC_USER_NOTI_');
end;
/

BEGIN ut_trace.trace('********************FIN  proceso de objeto:LDC_USER_NOTI_******************************'); end;
/
