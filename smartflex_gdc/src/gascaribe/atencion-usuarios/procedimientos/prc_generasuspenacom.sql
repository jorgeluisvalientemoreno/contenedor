CREATE OR REPLACE PROCEDURE prc_generasuspenacom
IS

	/*****************************************************************
	Unidad         : prc_generasuspenacom
...
BEGIN
	...
	prc_generasolisuspenacom(nuorden);
...
EXCEPTION
	...
	WHEN others THEN
		...
		RAISE PKG_ERROR.CONTROLLED_ERROR;
END prc_generasuspenacom;
/
PROMPT Otorgando permisos de ejecución a prc_generasuspenacom
BEGIN
	pkg_utilidades.prAplicarPermisos(upper('prc_generasuspenacom'),'OPEN'); 
END;
/
