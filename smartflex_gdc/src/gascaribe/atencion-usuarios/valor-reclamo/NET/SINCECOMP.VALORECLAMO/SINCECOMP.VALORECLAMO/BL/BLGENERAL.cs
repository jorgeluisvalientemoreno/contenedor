...
namespace SINCECOMP.VALORECLAMO.BL
{
    class BLGENERAL
    {
        ...
        */
        ...
        public void setColumnRequiered(UltraGrid ug, String[] Fields)
        {
            foreach (String column in Fields)
            {
                ...
                {
                    //ug.DisplayLayout.Bands[0].Columns[column].Header.Appearance.Image = global::SINCECOMP.VALORECLAMO.Resource.asterisc;
        ...
        */
        ...
        {
            general.CreacionCliente(inuident_type_id, isbidentification, isbsubscriber_name, isbsubs_last_name, isbphone, isbe_mail, inuDireccionContrato, out onuerrorcode, out osberrormessage);
        }
        /////////////
