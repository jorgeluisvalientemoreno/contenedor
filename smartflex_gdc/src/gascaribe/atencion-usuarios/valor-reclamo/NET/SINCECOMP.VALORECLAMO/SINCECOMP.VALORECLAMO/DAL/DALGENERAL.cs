...
namespace SINCECOMP.VALORECLAMO.DAL
{
    class DALGENERAL
    {
        ...
        */
        ...
        //////////OSF-96
        /////Registro de solicitante en OSF cuando no existe
        public void CreacionCliente(Int64 inuident_type_id, String isbidentification, String isbsubscriber_name, String isbsubs_last_name, String isbphone, String isbe_mail, Int64 inuDireccionContrato, out Int64 onuerrorcode, out String osberrormessage)
        {
            using (DbCommand cmdCommand = OpenDataBase.db.GetStoredProcCommand("LDC_PRCLIENTERECLAMO"))
            {
                //Parametro Entrada
                OpenDataBase.db.AddInParameter(cmdCommand, "inuident_type_id", DbType.Int64, inuident_type_id);
                OpenDataBase.db.AddInParameter(cmdCommand, "isbidentification", DbType.String, isbidentification);
                OpenDataBase.db.AddInParameter(cmdCommand, "isbsubscriber_name", DbType.String, isbsubscriber_name);
                OpenDataBase.db.AddInParameter(cmdCommand, "isbsubs_last_name", DbType.String, isbsubs_last_name);
                OpenDataBase.db.AddInParameter(cmdCommand, "isbphone", DbType.String, isbphone);
                OpenDataBase.db.AddInParameter(cmdCommand, "isbe_mail", DbType.String, isbe_mail);
                OpenDataBase.db.AddInParameter(cmdCommand, "inuDireccionContrato", DbType.Int64, inuDireccionContrato);
