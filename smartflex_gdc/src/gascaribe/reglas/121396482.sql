...
BEGIN
  ...
  dbms_output.put_line('Inicia Proceso ajustes regla');
	...
	set expression = 'PRCREGLAVALDIRECCIONCOTIZADA()', author = 'OPEN',
generation_date = to_date ('17-10-2024 15:05:51','DD/MM/YYYY HH24:MI:SS'),
last_modifi_date = to_date ('17-10-2024 15:05:51','DD/MM/YYYY HH24:MI:SS'),
object_type = 'PP'
