...
BEGIN
  ...
  dbms_output.put_line('Inicia Proceso ajustes regla');  
	...
	set expression = '
FNUGETREQBASICCHARGE()', author = 'HERHENAO',
generation_date = to_date ('06/06/14','DD/MM/YYYY HH24:MI:SS'),
last_modifi_date = to_date ('06/06/14','DD/MM/YYYY HH24:MI:SS'),
object_type = 'PF',
code = 'CREATE OR REPLACE FUNCTION FABSCT93E"||IdConfExpre||"
RETURN NUMBER IS
...
BEGIN
V0:=FNUGETREQBASICCHARGE;
RETURN V0;
END;
'
 where config_expression_id = 121063347;
