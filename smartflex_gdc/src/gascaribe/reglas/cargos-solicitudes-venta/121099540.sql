...
BEGIN
  ...
  dbms_output.put_line('Inicia Proceso ajustes regla');  
	...
	set expression = '
FNUGETREQBASICCHARGE()', author = 'ROSCAB',
generation_date = to_date ('22/10/14','DD/MM/YYYY HH24:MI:SS'),
last_modifi_date = to_date ('22/10/14','DD/MM/YYYY HH24:MI:SS'),
object_type = 'PF',
...
END;
'
 where config_expression_id = 121099540;
