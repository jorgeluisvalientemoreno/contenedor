...
'GE_BOINSTANCECONTROL.GETCURRENTINSTANCE(sbInstanciaActual);GE_BOINSTANCECONTROL.GETATTRIBUTENEWVALUE("WORK_INSTANCE",null,'||
'"PR_PRODUCT",'||
'"CATEGORY_ID",'||
...
'"MO_MOTIVE",'||
'"SUBCATEGORY_ID",'||
'sbNewEstratoId);if (sbOldEstratoId = null,'||
'sbOldEstratoId = "-1";,'||
');GE_BOINSTANCECONTROL.GETATTRIBUTENEWVALUE(sbInstanciaActual,'||
'null,'||
'"MO_PROCESS",'||
'"VARCHAR_2",'||
'sbResolucion);if (sbNewUsoId <> sbOldUsoId,'||
'if (sbResolucion = null,'||
'GI_BOERRORS.SETERRORCODEARGUMENT(2741,'||
'"Al cambiar la categoría se debe ingresar obligatoriamente la resolución");,'||
');if (sbNewEstratoId = null,'||
'GI_BOERRORS.SETERRORCODEARGUMENT(2741,'||
'"Al cambiar la Categoría se debe ingresar obligatoriamente la Subcategoría");,'||
');,'||
'if (sbNewEstratoId = sbOldEstratoId,'||
'GI_BOERRORS.SETERRORCODEARGUMENT(2741,'||
'"Debe realizar cambios a los datos del producto");,'||
');if (sbNewEstratoId <> sbOldEstratoId,'||
'GI_BOERRORS.SETERRORCODEARGUMENT(2741,'||
'"La subcategoría solo se puede ingresar cuando se esté cambiando la categoría");,'||
');GI_BOERRORS.SETERRORCODEARGUMENT(2741,'||
'"El trámite no puede ser registrado ya que no a sido modificado la categoría");)', author = 'LBTEST',
generation_date = to_date ('28-11-2023 04:51:25','DD/MM/YYYY HH24:MI:SS'),
last_modifi_date = to_date ('28-11-2023 04:51:25','DD/MM/YYYY HH24:MI:SS'),
object_type = 'PP'
 where config_expression_id = 121400152;
