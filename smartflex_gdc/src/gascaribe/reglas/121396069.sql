...
<03-01-2025>  <Paola Acosta>      OSF-3755: Regeneracion
******************************************************************/
declare
...
BEGIN
  ...
  dbms_output.put_line('Inicia Proceso ajustes regla');
	...
	set expression = 'PKG_UISOLICITUD_INTERACCION.PRCACCIONTRAMITE()', 
    author = 'LBTEST',
    generation_date = to_date ('02/01/25 14:53:53','DD/MM/YYYY HH24:MI:SS'),
    last_modifi_date = to_date ('02/01/25 14:53:53','DD/MM/YYYY HH24:MI:SS'),
    object_type = 'PP'

 where config_expression_id = 121396069;
