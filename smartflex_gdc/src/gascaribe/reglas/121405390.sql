...
BEGIN
  ...
  dbms_output.put_line('Inicia Proceso ajustes regla');
	...
	set expression = '
nuValor = -18484', author = 'PABBAR',
generation_date = to_date ('26-07-2024 16:55:05','DD/MM/YYYY HH24:MI:SS'),
last_modifi_date = to_date ('26-07-2024 16:55:05','DD/MM/YYYY HH24:MI:SS'),
object_type = 'PF',
...
END;
'
 where config_expression_id = 121405390;
