...
BEGIN
  ...
  dbms_output.put_line('Inicia Proceso ajustes regla');
	...
	set expression = 'PRCREGLAINIATRACTSUBCAT()', author = 'OPEN',
generation_date = to_date ('06-12-2013 11:28:06','DD/MM/YYYY HH24:MI:SS'),
last_modifi_date = to_date ('06-12-2013 11:28:06','DD/MM/YYYY HH24:MI:SS'),
object_type = 'PP'

 where config_expression_id = 121057739;
