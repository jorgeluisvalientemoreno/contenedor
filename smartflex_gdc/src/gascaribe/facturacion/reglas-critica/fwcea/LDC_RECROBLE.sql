...
BEGIN
sa_bocreatePackages.CreatePackage('LDC_RECROBLE_',
'CREATE OR REPLACE PACKAGE LDC_RECROBLE_ IS ' || chr(10) ||
...
BEGIN ut_trace.trace('********************Comenzar proceso de objeto:LDC_RECROBLE_******************************'); END;
/
...
DECLARE
    ...
    CURSOR  cuConfigExpression IS
        ...
        WHERE   GR_CONFIG_EXPRESSION.CONFIG_EXPRESSION_ID IN (
            ...
            WHERE   ENTITY_ID in (SELECT ENTITY_ID FROM GE_ENTITY WHERE NAME_='LDC_RECROBLE')
            UNION
...
if (not LDC_RECROBLE_.blProcessStatus) then
 return;
end if;
    ...
    DELETE FROM GE_ATTR_VAL_EXPRESS WHERE (ENTITY_ATTRIBUTE_ID) in (SELECT ENTITY_ATTRIBUTE_ID FROM GE_ENTITY_ATTRIBUTES WHERE (ENTITY_ID) in (SELECT ENTITY_ID FROM GE_ENTITY WHERE NAME_='LDC_RECROBLE'));
    DELETE FROM GE_ATTR_ALLOWED_VALUES WHERE (ENTITY_ATTRIBUTE_ID) in (SELECT ENTITY_ATTRIBUTE_ID FROM GE_ENTITY_ATTRIBUTES WHERE (ENTITY_ID) in (SELECT ENTITY_ID FROM GE_ENTITY WHERE NAME_='LDC_RECROBLE'));
...
BEGIN 
  LDC_RECROBLE_.tbEntityAttributeName(90198903) := 'LDC_RECROBLE@REOBCODI'; 
  LDC_RECROBLE_.tbEntityAttributeName(90198904) := 'LDC_RECROBLE@REOBDESC'; 
  LDC_RECROBLE_.tbEntityAttributeName(90198905) := 'LDC_RECROBLE@REOBREOB'; 
END;
/
...
LDC_RECROBLE_.old_tb0_0(0):='LDC_RECROBLE'
;
LDC_RECROBLE_.tb0_0(0):='LDC_RECROBLE';
LDC_RECROBLE_.old_tb0_1(0):=6079;
LDC_RECROBLE_.tb0_1(0):=GE_BOCATALOG.FNUGETIDSEQFROMCATALOG(LDC_RECROBLE_.tb0_0(0), 'ENTITY', 'GE_BOSEQUENCE.NEXTGE_ENTITY');
LDC_RECROBLE_.tb0_1(0):=LDC_RECROBLE_.tb0_1(0);
ut_trace.trace('Actualizar o insertar tabla: GE_ENTITY fila (0)',1);
UPDATE GE_ENTITY SET NAME_=LDC_RECROBLE_.tb0_0(0),
ENTITY_ID=LDC_RECROBLE_.tb0_1(0),
MODULE_ID=61,
SELEC_TYPE_OBJECT_ID=null,
INS_SEQ=null,
IN_PERSIST='Y'
,
DESCRIPTION='Reglas de observaciones de no lectura'
,
DISPLAY_NAME='LDC_RECROBLE'
,
LOAD_CARTRIDGE='N'
,
TABLESPACE='TSD_DEFAULT'
,
CREATION_DATE=to_date('16-11-2022 10:58:15','DD-MM-YYYY HH24:MI:SS'),
LAST_MODIFY_DATE=to_date('16-11-2022 10:58:15','DD-MM-YYYY HH24:MI:SS'),
STATUS='G'
,
ALLOWED_FULL_SCAN='Y'

 WHERE ENTITY_ID = LDC_RECROBLE_.tb0_1(0);
...
VALUES (LDC_RECROBLE_.tb0_0(0),
LDC_RECROBLE_.tb0_1(0),
61,
null,
null,
'Y'
,
'Reglas de observaciones de no lectura'
,
'LDC_RECROBLE'
,
'N'
...
'TSD_DEFAULT'
,
to_date('16-11-2022 10:58:15','DD-MM-YYYY HH24:MI:SS'),
to_date('16-11-2022 10:58:15','DD-MM-YYYY HH24:MI:SS'),
'G'
,
'Y'
...
LDC_RECROBLE_.blProcessStatus := false;
rollback;
ut_trace.trace('**ERROR:'||sqlerrm);
raise;
END;
...
LDC_RECROBLE_.tb1_0(0):=LDC_RECROBLE_.tb0_1(0);
ut_trace.trace('Actualizar o insertar tabla: GE_ENTITY_ADITIONAL fila (0)',1);
UPDATE GE_ENTITY_ADITIONAL SET ENTITY_ID=LDC_RECROBLE_.tb1_0(0),
STATEMENT_ID=null,
...
IS_CUSTOM_ENTITY='Y'
 ...
 WHERE ENTITY_ID = LDC_RECROBLE_.tb1_0(0);
if not (sql%found) then
...
LDC_RECROBLE_.tb2_0(0):=LDC_RECROBLE_.tb0_1(0);
LDC_RECROBLE_.old_tb2_1(0):=90198903;
LDC_RECROBLE_.tb2_1(0):=GE_BOCATALOG.FNUGETIDSEQFROMCATALOG(LDC_RECROBLE_.TBENTITYATTRIBUTENAME(LDC_RECROBLE_.old_tb2_1(0)), 'ATTRIBUTE', GE_BOSEQUENCE.NEXTGE_ENTITY_ATTRIBUTES);
LDC_RECROBLE_.tb2_1(0):=LDC_RECROBLE_.tb2_1(0);
ut_trace.trace('Actualizar o insertar tabla: GE_ENTITY_ATTRIBUTES fila (0)',1);
UPDATE GE_ENTITY_ATTRIBUTES SET ENTITY_ID=LDC_RECROBLE_.tb2_0(0),
ENTITY_ATTRIBUTE_ID=LDC_RECROBLE_.tb2_1(0),
...
PROTECTOR_TEXT=null
 WHERE ENTITY_ATTRIBUTE_ID = LDC_RECROBLE_.tb2_1(0);
if not (sql%found) then
...
VALUES (LDC_RECROBLE_.tb2_0(0),
LDC_RECROBLE_.tb2_1(0),
null,
null,
null,
null,
...
LDC_RECROBLE_.tb2_0(1):=LDC_RECROBLE_.tb0_1(0);
LDC_RECROBLE_.old_tb2_1(1):=90198904;
LDC_RECROBLE_.tb2_1(1):=GE_BOCATALOG.FNUGETIDSEQFROMCATALOG(LDC_RECROBLE_.TBENTITYATTRIBUTENAME(LDC_RECROBLE_.old_tb2_1(1)), 'ATTRIBUTE', GE_BOSEQUENCE.NEXTGE_ENTITY_ATTRIBUTES);
LDC_RECROBLE_.tb2_1(1):=LDC_RECROBLE_.tb2_1(1);
ut_trace.trace('Actualizar o insertar tabla: GE_ENTITY_ATTRIBUTES fila (1)',1);
UPDATE GE_ENTITY_ATTRIBUTES SET ENTITY_ID=LDC_RECROBLE_.tb2_0(1),
ENTITY_ATTRIBUTE_ID=LDC_RECROBLE_.tb2_1(1),
INIT_EXPRESSION_ID=null,
VALID_EXPRESSION_ID=null,
GI_COMPONENT_ID=null,
MASK_ID=null,
...
IS_NULL='N'
,
DISPLAY_NAME='Descripcion de la regla'
,
VIEWER_DISPLAY='Y'
,
PRECISION=null,
...
UNCHECKED_VALUE=null,
PROTECTOR_TEXT=null
 WHERE ENTITY_ATTRIBUTE_ID = LDC_RECROBLE_.tb2_1(1);
if not (sql%found) then
INSERT INTO GE_ENTITY_ATTRIBUTES(ENTITY_ID,ENTITY_ATTRIBUTE_ID,INIT_EXPRESSION_ID,VALID_EXPRESSION_ID,GI_COMPONENT_ID,MASK_ID,REFERENCE,ATTRIBUTE_TYPE_ID,TECHNICAL_NAME,SECUENCE_,KEY_,IS_NULL,DISPLAY_NAME,VIEWER_DISPLAY,PRECISION,DEFAULT_VALUE,SCALE,LENGTH,COMMENT_,TAG_ELEMENT,STATUS,IS_DESCRIPTION,IS_LOV_DESCRIPTION,IS_CHECK_BOX,CHECKED_VALUE,UNCHECKED_VALUE,PROTECTOR_TEXT) 
VALUES (LDC_RECROBLE_.tb2_0(1),
LDC_RECROBLE_.tb2_1(1),
null,
null,
null,
null,
...
LDC_RECROBLE_.tb2_0(2):=LDC_RECROBLE_.tb0_1(0);
LDC_RECROBLE_.old_tb2_1(2):=90198905;
LDC_RECROBLE_.tb2_1(2):=GE_BOCATALOG.FNUGETIDSEQFROMCATALOG(LDC_RECROBLE_.TBENTITYATTRIBUTENAME(LDC_RECROBLE_.old_tb2_1(2)), 'ATTRIBUTE', GE_BOSEQUENCE.NEXTGE_ENTITY_ATTRIBUTES);
LDC_RECROBLE_.tb2_1(2):=LDC_RECROBLE_.tb2_1(2);
ut_trace.trace('Actualizar o insertar tabla: GE_ENTITY_ATTRIBUTES fila (2)',1);
UPDATE GE_ENTITY_ATTRIBUTES SET ENTITY_ID=LDC_RECROBLE_.tb2_0(2),
ENTITY_ATTRIBUTE_ID=LDC_RECROBLE_.tb2_1(2),
INIT_EXPRESSION_ID=null,
VALID_EXPRESSION_ID=null,
GI_COMPONENT_ID=null,
MASK_ID=null,
...
IS_NULL='Y'
,
DISPLAY_NAME='Recurrencia de las observciones'
,
VIEWER_DISPLAY='Y'
,
PRECISION=15,
...
UNCHECKED_VALUE=null,
PROTECTOR_TEXT=null
 WHERE ENTITY_ATTRIBUTE_ID = LDC_RECROBLE_.tb2_1(2);
if not (sql%found) then
INSERT INTO GE_ENTITY_ATTRIBUTES(ENTITY_ID,ENTITY_ATTRIBUTE_ID,INIT_EXPRESSION_ID,VALID_EXPRESSION_ID,GI_COMPONENT_ID,MASK_ID,REFERENCE,ATTRIBUTE_TYPE_ID,TECHNICAL_NAME,SECUENCE_,KEY_,IS_NULL,DISPLAY_NAME,VIEWER_DISPLAY,PRECISION,DEFAULT_VALUE,SCALE,LENGTH,COMMENT_,TAG_ELEMENT,STATUS,IS_DESCRIPTION,IS_LOV_DESCRIPTION,IS_CHECK_BOX,CHECKED_VALUE,UNCHECKED_VALUE,PROTECTOR_TEXT) 
VALUES (LDC_RECROBLE_.tb2_0(2),
LDC_RECROBLE_.tb2_1(2),
null,
null,
null,
null,
...
'Y'
,
'Recurrencia de las observciones'
,
'Y'
,
15,
...
if (not LDC_RECROBLE_.blProcessStatus) then
 return;
  ...
  commit;
  gi_boframeworkentityattribute.UpdateEntityReferences('LDC_RECROBLE');
EXCEPTION
...
begin
SA_BOCreatePackages.DropPackage('LDC_RECROBLE_');
end;
/

BEGIN ut_trace.trace('********************FIN  proceso de objeto:LDC_RECROBLE_******************************'); end;
/
