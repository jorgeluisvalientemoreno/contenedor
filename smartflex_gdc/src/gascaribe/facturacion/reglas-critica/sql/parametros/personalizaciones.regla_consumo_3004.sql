MERGE INTO PERSONALIZACIONES.PARAMETROS A USING
 (SELECT
  'REGLA_CONSUMO_3004' as CODIGO,
  'Calificacion de consumo, consumo actual disminuyo menos del 40% o aumento menos del 100% del promedio de subcategoria  - lectura' as DESCRIPCION,
  3004 as VALOR_NUMERICO,
