MERGE INTO PERSONALIZACIONES.PARAMETROS A USING
 (SELECT
  'REGLA_CONSUMO_3012' as CODIGO,
  'Calificacion de consumo, el consumo actual disminuyo mas del 40%  con respecto al promedio propio y tiene una suspension en el periodo actual   - relectura' as DESCRIPCION,
  3012 as VALOR_NUMERICO,
