MERGE INTO PERSONALIZACIONES.PARAMETROS A USING
 (SELECT
  'MESES_VALIDACION_ORDERESI' as CODIGO,
  'Numero de meses para validacion de orden legalizada con exito - categoria residencial' as DESCRIPCION,
  12 as VALOR_NUMERICO,
