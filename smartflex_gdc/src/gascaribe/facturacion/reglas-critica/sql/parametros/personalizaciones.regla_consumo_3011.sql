MERGE INTO PERSONALIZACIONES.PARAMETROS A USING
 (SELECT
  'REGLA_CONSUMO_3011' as CODIGO,
  'Calificacion de consumo, consumo actual disminuyo menos del 40% o aumento menos del 100% del promedio de subcategoria  - relectura' as DESCRIPCION,
  3011 as VALOR_NUMERICO,
