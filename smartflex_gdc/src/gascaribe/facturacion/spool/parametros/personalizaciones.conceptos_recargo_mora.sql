MERGE INTO PERSONALIZACIONES.PARAMETROS A USING
 (SELECT
  'CONCEPTOS_RECARGO_MORA' as CODIGO,
  'Codigo de conceptos de Recargo por Mora' as DESCRIPCION,
  null as VALOR_NUMERICO,
  '153|154|155|156|157|220|284|285|286|332|875|864|871' as VALOR_CADENA,
  NULL as VALOR_FECHA,
  5 as PROCESO,
