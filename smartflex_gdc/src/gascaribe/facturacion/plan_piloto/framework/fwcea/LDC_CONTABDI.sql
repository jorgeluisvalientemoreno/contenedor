...
BEGIN
sa_bocreatePackages.CreatePackage('LDC_CONTABDI_',
'CREATE OR REPLACE PACKAGE LDC_CONTABDI_ IS ' || chr(10) ||
...
BEGIN ut_trace.trace('********************Comenzar proceso de objeto:LDC_CONTABDI_******************************'); END;
/
...
DECLARE
    ...
    CURSOR  cuConfigExpression IS
        ...
        WHERE   GR_CONFIG_EXPRESSION.CONFIG_EXPRESSION_ID IN (
            ...
            WHERE   ENTITY_ID in (SELECT ENTITY_ID FROM GE_ENTITY WHERE NAME_='LDC_CONTABDI')
            UNION
...
if (not LDC_CONTABDI_.blProcessStatus) then
 return;
end if;
    ...
    DELETE FROM GE_ATTR_VAL_EXPRESS WHERE (ENTITY_ATTRIBUTE_ID) in (SELECT ENTITY_ATTRIBUTE_ID FROM GE_ENTITY_ATTRIBUTES WHERE (ENTITY_ID) in (SELECT ENTITY_ID FROM GE_ENTITY WHERE NAME_='LDC_CONTABDI'));
    DELETE FROM GE_ATTR_ALLOWED_VALUES WHERE (ENTITY_ATTRIBUTE_ID) in (SELECT ENTITY_ATTRIBUTE_ID FROM GE_ENTITY_ATTRIBUTES WHERE (ENTITY_ID) in (SELECT ENTITY_ID FROM GE_ENTITY WHERE NAME_='LDC_CONTABDI'));
...
BEGIN 
  LDC_CONTABDI_.tbEntityAttributeName(90198919) := 'LDC_CONTABDI@CONTRATO'; 
END;
/
...
LDC_CONTABDI_.old_tb0_0(0):='LDC_CONTABDI'
;
LDC_CONTABDI_.tb0_0(0):='LDC_CONTABDI';
LDC_CONTABDI_.old_tb0_1(0):=6080;
LDC_CONTABDI_.tb0_1(0):=GE_BOCATALOG.FNUGETIDSEQFROMCATALOG(LDC_CONTABDI_.tb0_0(0), 'ENTITY', 'GE_BOSEQUENCE.NEXTGE_ENTITY');
LDC_CONTABDI_.tb0_1(0):=LDC_CONTABDI_.tb0_1(0);
ut_trace.trace('Actualizar o insertar tabla: GE_ENTITY fila (0)',1);
UPDATE GE_ENTITY SET NAME_=LDC_CONTABDI_.tb0_0(0),
ENTITY_ID=LDC_CONTABDI_.tb0_1(0),
MODULE_ID=61,
SELEC_TYPE_OBJECT_ID=null,
INS_SEQ=null,
IN_PERSIST='Y'
,
DESCRIPTION='contratos para abono de diferido'
,
DISPLAY_NAME='LDC_CONTABDI'
,
LOAD_CARTRIDGE='N'
,
TABLESPACE='TSD_DEFAULT'
,
CREATION_DATE=to_date('07-12-2022 09:44:23','DD-MM-YYYY HH24:MI:SS'),
LAST_MODIFY_DATE=to_date('07-12-2022 09:44:23','DD-MM-YYYY HH24:MI:SS'),
STATUS='G'
,
ALLOWED_FULL_SCAN='Y'

 WHERE ENTITY_ID = LDC_CONTABDI_.tb0_1(0);
...
VALUES (LDC_CONTABDI_.tb0_0(0),
LDC_CONTABDI_.tb0_1(0),
61,
null,
null,
'Y'
,
'contratos para abono de diferido'
,
'LDC_CONTABDI'
,
'N'
...
'TSD_DEFAULT'
,
to_date('07-12-2022 09:44:23','DD-MM-YYYY HH24:MI:SS'),
to_date('07-12-2022 09:44:23','DD-MM-YYYY HH24:MI:SS'),
'G'
,
'Y'
...
LDC_CONTABDI_.blProcessStatus := false;
rollback;
ut_trace.trace('**ERROR:'||sqlerrm);
raise;
END;
...
LDC_CONTABDI_.tb1_0(0):=LDC_CONTABDI_.tb0_1(0);
ut_trace.trace('Actualizar o insertar tabla: GE_ENTITY_ADITIONAL fila (0)',1);
UPDATE GE_ENTITY_ADITIONAL SET ENTITY_ID=LDC_CONTABDI_.tb1_0(0),
STATEMENT_ID=null,
...
IS_CUSTOM_ENTITY='Y'
 ...
 WHERE ENTITY_ID = LDC_CONTABDI_.tb1_0(0);
if not (sql%found) then
...
LDC_CONTABDI_.tb2_0(0):=LDC_CONTABDI_.tb0_1(0);
LDC_CONTABDI_.old_tb2_1(0):=90198919;
LDC_CONTABDI_.tb2_1(0):=GE_BOCATALOG.FNUGETIDSEQFROMCATALOG(LDC_CONTABDI_.TBENTITYATTRIBUTENAME(LDC_CONTABDI_.old_tb2_1(0)), 'ATTRIBUTE', GE_BOSEQUENCE.NEXTGE_ENTITY_ATTRIBUTES);
LDC_CONTABDI_.tb2_1(0):=LDC_CONTABDI_.tb2_1(0);
ut_trace.trace('Actualizar o insertar tabla: GE_ENTITY_ATTRIBUTES fila (0)',1);
UPDATE GE_ENTITY_ATTRIBUTES SET ENTITY_ID=LDC_CONTABDI_.tb2_0(0),
ENTITY_ATTRIBUTE_ID=LDC_CONTABDI_.tb2_1(0),
...
PROTECTOR_TEXT=null
 WHERE ENTITY_ATTRIBUTE_ID = LDC_CONTABDI_.tb2_1(0);
if not (sql%found) then
...
VALUES (LDC_CONTABDI_.tb2_0(0),
LDC_CONTABDI_.tb2_1(0),
null,
null,
null,
null,
...
if (not LDC_CONTABDI_.blProcessStatus) then
 return;
  ...
  commit;
  gi_boframeworkentityattribute.UpdateEntityReferences('LDC_CONTABDI');
EXCEPTION
...
begin
SA_BOCreatePackages.DropPackage('LDC_CONTABDI_');
end;
/

BEGIN ut_trace.trace('********************FIN  proceso de objeto:LDC_CONTABDI_******************************'); end;
/
