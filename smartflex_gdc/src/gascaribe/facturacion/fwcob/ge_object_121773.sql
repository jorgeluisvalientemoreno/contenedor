...
BEGIN
sa_bocreatePackages.CreatePackage('GE_OBJECT_121773_',
'CREATE OR REPLACE PACKAGE GE_OBJECT_121773_ IS ' || chr(10) ||
...
'tb2_1 ty2_1; ' || chr(10) ||
'END GE_OBJECT_121773_;');
END;
/


BEGIN ut_trace.trace('********************Comenzar proceso de objeto:GE_OBJECT_121773_******************************'); END;
/


BEGIN

if (not GE_OBJECT_121773_.blProcessStatus) then
 return;
end if;
  ut_trace.trace('Borrando tabla GE_OBJECT_PARAMETER',1);
  DELETE FROM GE_OBJECT_PARAMETER WHERE (OBJECT_NAME) in (SELECT NAME_ FROM GE_OBJECT WHERE OBJECT_ID=121773);

exception when others then
GE_OBJECT_121773_.blProcessStatus := false;
rollback;
...
if (not GE_OBJECT_121773_.blProcessStatus) then
 return;
  ...
  DELETE FROM GR_CONFTYPE_OBJECT WHERE (OBJECT_NAME) in (SELECT NAME_ FROM GE_OBJECT WHERE OBJECT_ID=121773);
...
SELECT rowid
FROM GE_OBJECT WHERE OBJECT_ID=121773;
...
GE_OBJECT_121773_.tb0_0(0):=121773;
GE_OBJECT_121773_.tb0_2(0):='PKG_CLIENTESESTACIONALES.PRC_VALIDAFECHAFINALVIG'
;
ut_trace.trace('Actualizar o insertar tabla: GE_OBJECT fila (0)',1);
UPDATE GE_OBJECT SET OBJECT_ID=GE_OBJECT_121773_.tb0_0(0),
OBJECT_TYPE_ID=20,
NAME_=GE_OBJECT_121773_.tb0_2(0),
MODULE_ID=5,
DESCRIPTION='Valida fecha final de vigencia cliente estacional'
,
COMMENT_='Valida fecha final de vigencia cliente estacional'
,
...
,
RETURN_TYPE=null
 WHERE OBJECT_ID = GE_OBJECT_121773_.tb0_0(0);
...
VALUES (GE_OBJECT_121773_.tb0_0(0),
20,
GE_OBJECT_121773_.tb0_2(0),
5,
'Valida fecha final de vigencia cliente estacional'
,
'Valida fecha final de vigencia cliente estacional'
,
'(_e_, _e_, _e_)'
...
GE_OBJECT_121773_.tb1_0(0):=GE_OBJECT_121773_.tb0_2(0);
GE_OBJECT_121773_.tb1_1(0):='IDTFECHAFINVIGE'
;
...
VALUES (GE_OBJECT_121773_.tb1_0(0),
GE_OBJECT_121773_.tb1_1(0),
'DATE'
,
'IN'
,
...
GE_OBJECT_121773_.tb1_0(1):=GE_OBJECT_121773_.tb0_2(0);
GE_OBJECT_121773_.tb1_1(1):='IDTFECHAINIVIGE'
;
ut_trace.trace('insertando tabla: GE_OBJECT_PARAMETER fila (1)',1);
INSERT INTO GE_OBJECT_PARAMETER(OBJECT_NAME,PARAMETER_NAME,DATA_TYPE,IN_OUT,COMMENT_,SEQUENCE) 
VALUES (GE_OBJECT_121773_.tb1_0(1),
GE_OBJECT_121773_.tb1_1(1),
'DATE'
,
'IN'
,
...
GE_OBJECT_121773_.tb1_0(2):=GE_OBJECT_121773_.tb0_2(0);
GE_OBJECT_121773_.tb1_1(2):='OSBCUMPLEFECHA'
;
ut_trace.trace('insertando tabla: GE_OBJECT_PARAMETER fila (2)',1);
INSERT INTO GE_OBJECT_PARAMETER(OBJECT_NAME,PARAMETER_NAME,DATA_TYPE,IN_OUT,COMMENT_,SEQUENCE) 
VALUES (GE_OBJECT_121773_.tb1_0(2),
GE_OBJECT_121773_.tb1_1(2),
'VARCHAR2'
,
'OUT'
,
...
GE_OBJECT_121773_.tb2_0(0):=26;
GE_OBJECT_121773_.tb2_1(0):=GE_OBJECT_121773_.tb0_2(0);
ut_trace.trace('insertando tabla: GR_CONFTYPE_OBJECT fila (0)',1);
INSERT INTO GR_CONFTYPE_OBJECT(CONFIGURA_TYPE_ID,OBJECT_NAME) 
VALUES (GE_OBJECT_121773_.tb2_0(0),
GE_OBJECT_121773_.tb2_1(0));
...
begin
SA_BOCreatePackages.DropPackage('GE_OBJECT_121773_');
end;
/

BEGIN ut_trace.trace('********************FIN  proceso de objeto:GE_OBJECT_121773_******************************'); end;
/
