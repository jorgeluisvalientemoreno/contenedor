MERGE INTO PERSONALIZACIONES.PARAMETROS A USING
 (SELECT
  'CONFEXME_FACTURA_SERVICIO_PBIFSE' as "CODIGO",
  'CODIGO CONFEXME PARA GENERAR FACTURA SERVICIO EN PDF PARA LA FORMA PBIFSE' as "DESCRIPCION",
  59 as "VALOR_NUMERICO",
