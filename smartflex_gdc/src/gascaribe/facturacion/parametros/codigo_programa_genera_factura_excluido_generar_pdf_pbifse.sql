MERGE INTO PERSONALIZACIONES.PARAMETROS A USING
 (SELECT
  'CODIGO_PROGRAMA_GENERA_FACTURA_EXCLUIDO_GENERAR_PDF_PBIFSE' as "CODIGO",
  'CODIGO DE PROGRAMA QUE GENERA FACTURA QUE SERA EXCLUIDO PARA GENERAR PDF EN PBIFSE' as "DESCRIPCION",
