MERGE INTO PERSONALIZACIONES.PARAMETROS A USING
 (SELECT
  'HORA_RESTRICCION_FINANCIACION' as CODIGO,
  'Hora en formato 24HH para restringir los movimientos de facturas y notas para la Fact. Electronica' as DESCRIPCION,
  20 as VALOR_NUMERICO,
