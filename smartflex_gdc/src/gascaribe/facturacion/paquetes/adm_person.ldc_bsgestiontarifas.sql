CREATE OR REPLACE package adm_person.LDC_BSGESTIONTARIFAS is
    /***************************************************************
    Propiedad intelectual de Sincecomp Ltda.
    
    Unidad	     : LDC_BSGESTIONTARIFAS
    Descripcion	 : 
  ...
  /**************************************************************************
    ...
    DescripciÃ³n: Retorna informacion de la configuracion de tarifas
  ...
  ***************************************************************************/
  ...
  /**************************************************************************
    ...
    DescripciÃ³n: envia correo de aprobacion de tarifa
  ...
  ***************************************************************************/
  PROCEDURE prGetInfoProyTari( inuproytari IN ta_proytari.PRTACONS%type,
   ...
   /**************************************************************************
    ...
    DescripciÃ³n: proceso que devuelve informacion del proyecto
  ...
  ***************************************************************************/
  ...
  PROCEDURE prLeerarchivoPlano( inuCodigo_Proyecto   IN NUMBER,
   ...
   /**************************************************************************
    ...
    DescripciÃ³n: proceso que se encarga de leer archivo plano
...
/
CREATE OR REPLACE package BODY adm_person.LDC_BSGESTIONTARIFAS is
  ...
  /**************************************************************************
    ...
    Ticket      : 583
    Proceso     : frfgetConftari
    DescripciÃƒÂ³n: Retorna informacion de la configuracion de tarifas

    ParÃƒÂ¡metros Entrada
     inutipoprod tipo de producto
    Valor de salida
     onuerror   codigo de erorr 0 - correcto, otro valor incorrecto
     osberror   mensaje de error
  ...
  ***************************************************************************/
  ...
  PROCEDURE prGetInfoProyTari( inuproytari IN ta_proytari.PRTACONS%type,
   ...
   /**************************************************************************
    ...
    Ticket      : 583
    Proceso     : prGetInfoProyTari
    DescripciÃƒÂ³n: proceso que devuelve informacion del proyecto
  ...
  ***************************************************************************/
  ...
  PROCEDURE prEnviarCorreo( inuproyecto IN NUMBER,
   ...
   /**************************************************************************
    ...
    Ticket      : 583
    Proceso     : prEnviarCorreo
    DescripciÃƒÂ³n: envia correo de aprobacion de tarifa
  ...
  ***************************************************************************/
  ...
  PROCEDURE prLeerarchivoPlano( inuCodigo_Proyecto   IN NUMBER,
   ...
   /**************************************************************************
    ...
    Ticket      : 583
    Proceso     : prLeerarchivoPlano
    DescripciÃƒÂ³n: proceso que se encarga de leer archivo plano
...
/
PROMPT Otorgando permisos de ejecucion a LDC_BSGESTIONTARIFAS
BEGIN
    pkg_utilidades.praplicarpermisos('LDC_BSGESTIONTARIFAS', 'ADM_PERSON');
END;
/
