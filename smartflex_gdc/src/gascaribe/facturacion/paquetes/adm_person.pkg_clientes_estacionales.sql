CREATE OR REPLACE PACKAGE adm_person.pkg_clientes_estacionales AS

	/******************************************************************
    <Package Fuente="Propiedad Intelectual de GDC">
    <Unidad> pkg_clientes_estacionales </Unidad>
    ...
    <Historial>
		<Modificacion Autor="Jhon.Erazo" Fecha="12-12-2024" Inc="OSF-3713" Empresa="GDC">
			1. Se modifican los siguientes procedimiento:
				- prAcFECHA_INICIAL_VIGENCIA
				- prAcFECHA_FINAL_VIGENCIA
				- prAcACTIVO
				- fsbObtACTIVO
				- fdtObtFECHA_REGISTRO
				- fdtObtFECHA_INICIAL_VIGENCIA
				- fdtObtFECHA_FINAL_VIGENCIA
			2. Se crea el procedimiento
				- prcActFechaInactivacion
        </Modificacion>
    ...
    **************************************************************************/
	...
	/**************************************************************************
    <PROCEDURE Fuente="Propiedad Intelectual de <Empresa>">
    <Unidad> prcActFechaInactivacion </Unidad>
    <Autor> Jhon Eduar Erazo </Autor>
    <Fecha> 12-12-2024 </Fecha>
    <Descripcion> 
        Actualiza la fecha de inactivación del contrato activo
    </Descripcion>
    <Historial>
		<Modificacion Autor="Jhon.Erazo" Fecha="12-12-2024" Inc="OSF-3241" Empresa="GDC">
			Creación
        </Modificacion>
    </Historial>
    </PROCEDURE>
    **************************************************************************/
	PROCEDURE prcActFechaInactivacion(inuCONTRATO  			NUMBER,
									  idtFechaInactivacion	DATE
									  );
...
END pkg_clientes_estacionales;
/
CREATE OR REPLACE PACKAGE BODY adm_person.pkg_clientes_estacionales AS
    ...
    **************************************************************************/
    ...
    <Historial>
		<Modificacion Autor="Jhon.Erazo" Fecha="13-12-2024" Inc="OSF-3713" Empresa="GDC">
			1. Se ajusta para que retorne la fecha de registro del contrato activo
        </Modificacion>
		<Modificacion Autor="Jhon.Erazo" Fecha="21-01-2024" Inc="OSF-3241" Empresa="GDC">
			Creación
        </Modificacion>
    ...
    **************************************************************************/
    ...
    IS
		...
		CURSOR cuFechaRegistroActivo
		IS
			SELECT FECHA_REGISTRO
			FROM clientes_estacionales
    ...
    BEGIN
		...
		IF (cuFechaRegistroActivo%ISOPEN) THEN
			CLOSE cuFechaRegistroActivo;
		END IF;
		
		OPEN cuFechaRegistroActivo;
		FETCH cuFechaRegistroActivo INTO dtFechaRegistro;
		CLOSE cuFechaRegistroActivo;
		
		pkg_traza.trace('dtFechaRegistro ' || dtFechaRegistro, csbNivelTraza);
    ...
    <Historial>
		<Modificacion Autor="Jhon.Erazo" Fecha="13-12-2024" Inc="OSF-3713" Empresa="GDC">
			1. Se ajusta para que retorne la fecha inicial de vigencia del contrato activo
        </Modificacion>
		<Modificacion Autor="Jhon.Erazo" Fecha="21-01-2024" Inc="OSF-3241" Empresa="GDC">
			Creación
        </Modificacion>
    ...
    **************************************************************************/
    ...
    IS
		...
		CURSOR cuFechaInicialActivo
		IS
			SELECT FECHA_INICIAL_VIGENCIA
			FROM clientes_estacionales
			WHERE contrato 	= inuCONTRATO
			AND activo 		= 'Y';
    BEGIN
		...
		IF (cuFechaInicialActivo%ISOPEN) THEN
			CLOSE cuFechaInicialActivo;
		END IF;
		
		OPEN cuFechaInicialActivo;
		FETCH cuFechaInicialActivo INTO dtInicialVig;
		CLOSE cuFechaInicialActivo;
		
		pkg_traza.trace('dtInicialVig ' || dtInicialVig, csbNivelTraza);
    ...
    <Historial>
		<Modificacion Autor="Jhon.Erazo" Fecha="13-12-2024" Inc="OSF-3713" Empresa="GDC">
			1. Se ajusta para que retorne la fecha final de vigencia del contrato activo
        </Modificacion>
		<Modificacion Autor="Jhon.Erazo" Fecha="21-01-2024" Inc="OSF-3241" Empresa="GDC">
			Creación
        </Modificacion>
    ...
    **************************************************************************/
    ...
    IS
		...
		CURSOR cuFechaFinalActivo
		IS
			SELECT FECHA_FINAL_VIGENCIA
			FROM clientes_estacionales
			WHERE contrato 	= inuCONTRATO
			AND activo 		= 'Y';
    BEGIN
		...
		IF (cuFechaFinalActivo%ISOPEN) THEN
			CLOSE cuFechaFinalActivo;
		END IF;
		
		OPEN cuFechaFinalActivo;
		FETCH cuFechaFinalActivo INTO dtFinalVig;
		CLOSE cuFechaFinalActivo;
		
		pkg_traza.trace('dtFinalVig ' || dtFinalVig, csbNivelTraza);
    ...
    <Historial>
		<Modificacion Autor="Jhon.Erazo" Fecha="13-12-2024" Inc="OSF-3713" Empresa="GDC">
			1. Se ajusta para que valide si el contrato tiene un registro activo
        </Modificacion>
		<Modificacion Autor="Jhon.Erazo" Fecha="21-01-2024" Inc="OSF-3241" Empresa="GDC">
			Creación
		</Modificacion>
    ...
    **************************************************************************/
    ...
    IS
        ...
        nuError         		NUMBER;
		nuCantiClienteActivo	NUMBER;
        sbError         		VARCHAR2(4000);
		sbActivo				clientes_estacionales.ACTIVO%TYPE := 'Y';
		
		CURSOR cuCountClienteActivo
		IS
			SELECT count(*)
			FROM clientes_estacionales
			WHERE contrato 	= inuCONTRATO
    ...
    BEGIN
		...
		IF (cuCountClienteActivo%ISOPEN) THEN
			CLOSE cuCountClienteActivo;
		END IF;
		
		OPEN cuCountClienteActivo;
		FETCH cuCountClienteActivo INTO nuCantiClienteActivo;
		CLOSE cuCountClienteActivo;
		
		pkg_traza.trace('nuCantiClienteActivo' || nuCantiClienteActivo, csbNivelTraza);
		
		IF (nuCantiClienteActivo = 0) THEN
			sbActivo := 'N';
		END IF;
		
		pkg_traza.trace('sbActivo: ' || sbActivo, csbNivelTraza);
    ...
    **************************************************************************/
    ...
    <Historial>
		<Modificacion Autor="Jhon.Erazo" Fecha="13-12-2024" Inc="OSF-3713" Empresa="GDC">
			1. Se agrega condición para actualice la fecha inicial de vigencia
				para el contrato activo.
        </Modificacion>
		<Modificacion Autor="Jhon.Erazo" Fecha="21-01-2024" Inc="OSF-3241" Empresa="GDC">
			Creación
        </Modificacion>
    ...
    **************************************************************************/
    ...
    BEGIN
		...
		pkg_traza.trace('inuCONTRATO: ' 				|| inuCONTRATO || CHR(10) ||
						'idtFECHA_INICIAL_VIGENCIA: ' 	|| idtFECHA_INICIAL_VIGENCIA, csbNivelTraza);
    ...
    <Historial>
		<Modificacion Autor="Jhon.Erazo" Fecha="13-12-2024" Inc="OSF-3713" Empresa="GDC">
			1. Se agrega condición para actualice la fecha final de vigencia
				para el contrato activo.
        </Modificacion>
		<Modificacion Autor="Jhon.Erazo" Fecha="21-01-2024" Inc="OSF-3241" Empresa="GDC">
			Creación
    ...
    **************************************************************************/
    ...
    BEGIN
		...
		pkg_traza.trace('inuCONTRATO: ' 			|| inuCONTRATO || CHR(10) ||
						'idtFECHA_FINAL_VIGENCIA: '	|| idtFECHA_FINAL_VIGENCIA, csbNivelTraza);
    ...
    <Historial>
		<Modificacion Autor="Jhon.Erazo" Fecha="13-12-2024" Inc="OSF-3713" Empresa="GDC">
			1. Se agrega condición para actualice el flag activo, para el contrato activo.
        </Modificacion>
		<Modificacion Autor="Jhon.Erazo" Fecha="21-01-2024" Inc="OSF-3241" Empresa="GDC">
			Creación
        </Modificacion>
    ...
    **************************************************************************/
    ...
    BEGIN
		...
		pkg_traza.trace('inuCONTRATO: '	|| inuCONTRATO || CHR(10) ||
						'isbACTIVO: '	|| isbACTIVO, csbNivelTraza);
    ...
    **************************************************************************/
    ...
    IS
		...
		csbMetodo       CONSTANT VARCHAR2(70) := csbSP_NAME||'prcActFechaInactivacion';
        nuError         NUMBER;
        sbError         VARCHAR2(4000);
    ...
    BEGIN
		...
		pkg_traza.trace('inuCONTRATO: '				|| inuCONTRATO || CHR(10) ||
						'idtFechaInactivacion: '	|| idtFechaInactivacion, csbNivelTraza);
		
        UPDATE clientes_estacionales
        SET fecha_inactivacion = idtFechaInactivacion 
        WHERE contrato 	= inuCONTRATO
		AND activo 		= 'Y';
...
BEGIN
    -- OSF-3241
    pkg_Utilidades.prAplicarPermisos( UPPER('pkg_clientes_estacionales'), UPPER('adm_person'));
END;
/
