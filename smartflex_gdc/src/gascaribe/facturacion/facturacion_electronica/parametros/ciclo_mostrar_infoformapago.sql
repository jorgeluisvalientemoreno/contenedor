Prompt Creando el parametro CICLO_MOSTRAR_INFOFORMAPAGO
BEGIN
MERGE INTO OPEN.PARAMETROS A USING
 (SELECT
  'CICLO_MOSTRAR_INFOFORMAPAGO' as CODIGO,
  'Ciclos que permite mostrar información de pago para el canal 7, opcional 81' as DESCRIPCION,
