...
BEGIN
sa_bocreatePackages.CreatePackage('CONTRATOS_OMITIR_NI_',
'CREATE OR REPLACE PACKAGE CONTRATOS_OMITIR_NI_ IS ' || chr(10) ||
...
' ' || chr(10) ||
'END CONTRATOS_OMITIR_NI_;');
END;
/


BEGIN ut_trace.trace('********************Comenzar proceso de objeto:CONTRATOS_OMITIR_NI_******************************'); END;
/
...
DECLARE
    ...
    CURSOR  cuConfigExpression IS
        ...
        WHERE   GR_CONFIG_EXPRESSION.CONFIG_EXPRESSION_ID IN (
            ...
            WHERE   ENTITY_ID in (SELECT ENTITY_ID FROM GE_ENTITY WHERE NAME_='CONTRATOS_OMITIR_NIT_GENERICO')
            UNION
...
if (not CONTRATOS_OMITIR_NI_.blProcessStatus) then
 return;
end if;
    ...
    DELETE FROM GE_ATTR_VAL_EXPRESS WHERE (ENTITY_ATTRIBUTE_ID) in (SELECT ENTITY_ATTRIBUTE_ID FROM GE_ENTITY_ATTRIBUTES WHERE (ENTITY_ID) in (SELECT ENTITY_ID FROM GE_ENTITY WHERE NAME_='CONTRATOS_OMITIR_NIT_GENERICO'));
    DELETE FROM GE_ATTR_ALLOWED_VALUES WHERE (ENTITY_ATTRIBUTE_ID) in (SELECT ENTITY_ATTRIBUTE_ID FROM GE_ENTITY_ATTRIBUTES WHERE (ENTITY_ID) in (SELECT ENTITY_ID FROM GE_ENTITY WHERE NAME_='CONTRATOS_OMITIR_NIT_GENERICO'));
...
BEGIN 
  CONTRATOS_OMITIR_NI_.tbEntityAttributeName(90200367) := 'CONTRATOS_OMITIR_NIT_GENERICO@CONTRATO'; 
END;
/
...
CONTRATOS_OMITIR_NI_.old_tb0_0(0):='CONTRATOS_OMITIR_NIT_GENERICO'
;
CONTRATOS_OMITIR_NI_.tb0_0(0):='CONTRATOS_OMITIR_NIT_GENERICO';
CONTRATOS_OMITIR_NI_.old_tb0_1(0):=6231;
CONTRATOS_OMITIR_NI_.tb0_1(0):=GE_BOCATALOG.FNUGETIDSEQFROMCATALOG(CONTRATOS_OMITIR_NI_.tb0_0(0), 'ENTITY', 'GE_BOSEQUENCE.NEXTGE_ENTITY');
CONTRATOS_OMITIR_NI_.tb0_1(0):=CONTRATOS_OMITIR_NI_.tb0_1(0);
ut_trace.trace('Actualizar o insertar tabla: GE_ENTITY fila (0)',1);
UPDATE GE_ENTITY SET NAME_=CONTRATOS_OMITIR_NI_.tb0_0(0),
ENTITY_ID=CONTRATOS_OMITIR_NI_.tb0_1(0),
MODULE_ID=61,
SELEC_TYPE_OBJECT_ID=null,
INS_SEQ=null,
IN_PERSIST='Y'
,
DESCRIPTION='Contratos para Omitir Cedula Genérica '
,
DISPLAY_NAME='CONTRATOS_OMITIR_NIT_GENERICO'
,
LOAD_CARTRIDGE='N'
,
TABLESPACE='TSD_DEFAULT'
,
CREATION_DATE=to_date('27-11-2024 10:56:51','DD-MM-YYYY HH24:MI:SS'),
LAST_MODIFY_DATE=to_date('27-11-2024 10:56:51','DD-MM-YYYY HH24:MI:SS'),
STATUS='G'
,
ALLOWED_FULL_SCAN='Y'

 WHERE ENTITY_ID = CONTRATOS_OMITIR_NI_.tb0_1(0);
...
VALUES (CONTRATOS_OMITIR_NI_.tb0_0(0),
CONTRATOS_OMITIR_NI_.tb0_1(0),
61,
null,
null,
'Y'
,
'Contratos para Omitir Cedula Genérica '
,
'CONTRATOS_OMITIR_NIT_GENERICO'
,
'N'
,
'TSD_DEFAULT'
,
to_date('27-11-2024 10:56:51','DD-MM-YYYY HH24:MI:SS'),
to_date('27-11-2024 10:56:51','DD-MM-YYYY HH24:MI:SS'),
'G'
,
'Y'
...
CONTRATOS_OMITIR_NI_.blProcessStatus := false;
rollback;
ut_trace.trace('**ERROR:'||sqlerrm);
raise;
END;
...
CONTRATOS_OMITIR_NI_.tb1_0(0):=CONTRATOS_OMITIR_NI_.tb0_1(0);
ut_trace.trace('Actualizar o insertar tabla: GE_ENTITY_ADITIONAL fila (0)',1);
UPDATE GE_ENTITY_ADITIONAL SET ENTITY_ID=CONTRATOS_OMITIR_NI_.tb1_0(0),
STATEMENT_ID=null,
...
IS_CUSTOM_ENTITY='Y'
 ...
 WHERE ENTITY_ID = CONTRATOS_OMITIR_NI_.tb1_0(0);
if not (sql%found) then
...
VALUES (CONTRATOS_OMITIR_NI_.tb1_0(0),
null,
null,
null,
null,
...
CONTRATOS_OMITIR_NI_.tb2_0(0):=CONTRATOS_OMITIR_NI_.tb0_1(0);
CONTRATOS_OMITIR_NI_.old_tb2_1(0):=90200367;
CONTRATOS_OMITIR_NI_.tb2_1(0):=GE_BOCATALOG.FNUGETIDSEQFROMCATALOG(CONTRATOS_OMITIR_NI_.TBENTITYATTRIBUTENAME(CONTRATOS_OMITIR_NI_.old_tb2_1(0)), 'ATTRIBUTE', GE_BOSEQUENCE.NEXTGE_ENTITY_ATTRIBUTES);
CONTRATOS_OMITIR_NI_.tb2_1(0):=CONTRATOS_OMITIR_NI_.tb2_1(0);
ut_trace.trace('Actualizar o insertar tabla: GE_ENTITY_ATTRIBUTES fila (0)',1);
UPDATE GE_ENTITY_ATTRIBUTES SET ENTITY_ID=CONTRATOS_OMITIR_NI_.tb2_0(0),
ENTITY_ATTRIBUTE_ID=CONTRATOS_OMITIR_NI_.tb2_1(0),
...
IS_NULL='N'
,
DISPLAY_NAME='Numero de contrato'
,
VIEWER_DISPLAY='Y'
,
PRECISION=10,
...
PROTECTOR_TEXT=null
 WHERE ENTITY_ATTRIBUTE_ID = CONTRATOS_OMITIR_NI_.tb2_1(0);
if not (sql%found) then
...
VALUES (CONTRATOS_OMITIR_NI_.tb2_0(0),
CONTRATOS_OMITIR_NI_.tb2_1(0),
null,
null,
null,
null,
...
if (not CONTRATOS_OMITIR_NI_.blProcessStatus) then
 return;
  ...
  commit;
  gi_boframeworkentityattribute.UpdateEntityReferences('CONTRATOS_OMITIR_NIT_GENERICO');
EXCEPTION
...
begin
SA_BOCreatePackages.DropPackage('CONTRATOS_OMITIR_NI_');
end;
/

BEGIN ut_trace.trace('********************FIN  proceso de objeto:CONTRATOS_OMITIR_NI_******************************'); end;
/
