...
BEGIN
sa_bocreatePackages.CreatePackage('TIDOFAEL_',
'CREATE OR REPLACE PACKAGE TIDOFAEL_ IS ' || chr(10) ||
...
BEGIN ut_trace.trace('********************Comenzar proceso de objeto:TIDOFAEL_******************************'); END;
/
...
DECLARE
    ...
    CURSOR  cuConfigExpression IS
        ...
        WHERE   GR_CONFIG_EXPRESSION.CONFIG_EXPRESSION_ID IN (
            ...
            WHERE   ENTITY_ID in (SELECT ENTITY_ID FROM GE_ENTITY WHERE NAME_='TIDOFAEL')
            UNION
...
if (not TIDOFAEL_.blProcessStatus) then
 return;
end if;
    ...
    DELETE FROM GE_ATTR_VAL_EXPRESS WHERE (ENTITY_ATTRIBUTE_ID) in (SELECT ENTITY_ATTRIBUTE_ID FROM GE_ENTITY_ATTRIBUTES WHERE (ENTITY_ID) in (SELECT ENTITY_ID FROM GE_ENTITY WHERE NAME_='TIDOFAEL'));
    DELETE FROM GE_ATTR_ALLOWED_VALUES WHERE (ENTITY_ATTRIBUTE_ID) in (SELECT ENTITY_ATTRIBUTE_ID FROM GE_ENTITY_ATTRIBUTES WHERE (ENTITY_ID) in (SELECT ENTITY_ID FROM GE_ENTITY WHERE NAME_='TIDOFAEL'));
...
BEGIN 
  TIDOFAEL_.tbEntityAttributeName(90199583) := 'TIDOFAEL@CODIGO'; 
  TIDOFAEL_.tbEntityAttributeName(90199584) := 'TIDOFAEL@DESCRIPCION'; 
  TIDOFAEL_.tbEntityAttributeName(90199586) := 'TIDOFAEL@UMBRAL'; 
END;
/
...
TIDOFAEL_.old_tb0_0(0):='TIDOFAEL'
;
TIDOFAEL_.tb0_0(0):='TIDOFAEL';
TIDOFAEL_.old_tb0_1(0):=6162;
TIDOFAEL_.tb0_1(0):=GE_BOCATALOG.FNUGETIDSEQFROMCATALOG(TIDOFAEL_.tb0_0(0), 'ENTITY', 'GE_BOSEQUENCE.NEXTGE_ENTITY');
TIDOFAEL_.tb0_1(0):=TIDOFAEL_.tb0_1(0);
ut_trace.trace('Actualizar o insertar tabla: GE_ENTITY fila (0)',1);
UPDATE GE_ENTITY SET NAME_=TIDOFAEL_.tb0_0(0),
ENTITY_ID=TIDOFAEL_.tb0_1(0),
MODULE_ID=61,
SELEC_TYPE_OBJECT_ID=null,
INS_SEQ=null,
IN_PERSIST='Y'
,
DESCRIPTION='Tipo de Documento Facturación Electronica'
,
DISPLAY_NAME='TIDOFAEL'
,
LOAD_CARTRIDGE='N'
,
TABLESPACE='TSD_DEFAULT'
,
CREATION_DATE=to_date('04-01-2024 08:51:41','DD-MM-YYYY HH24:MI:SS'),
LAST_MODIFY_DATE=to_date('04-01-2024 08:53:09','DD-MM-YYYY HH24:MI:SS'),
STATUS='G'
,
ALLOWED_FULL_SCAN='Y'

 WHERE ENTITY_ID = TIDOFAEL_.tb0_1(0);
...
'Y'
,
'Tipo de Documento Facturación Electronica'
,
'TIDOFAEL'
,
'N'
...
'TSD_DEFAULT'
,
to_date('04-01-2024 08:51:41','DD-MM-YYYY HH24:MI:SS'),
to_date('04-01-2024 08:53:09','DD-MM-YYYY HH24:MI:SS'),
'G'
,
'Y'
);
...
TIDOFAEL_.blProcessStatus := false;
rollback;
ut_trace.trace('**ERROR:'||sqlerrm);
raise;
END;
...
TIDOFAEL_.tb1_0(0):=TIDOFAEL_.tb0_1(0);
ut_trace.trace('Actualizar o insertar tabla: GE_ENTITY_ADITIONAL fila (0)',1);
UPDATE GE_ENTITY_ADITIONAL SET ENTITY_ID=TIDOFAEL_.tb1_0(0),
STATEMENT_ID=null,
...
IS_CUSTOM_ENTITY='Y'
 ...
 WHERE ENTITY_ID = TIDOFAEL_.tb1_0(0);
if not (sql%found) then
...
TIDOFAEL_.old_tb2_0(0):=121400597;
TIDOFAEL_.tb2_0(0):=GR_BOSEQUENCE.NEXTGR_CONFIG_EXPRESSION;
TIDOFAEL_.tb2_0(0):=TIDOFAEL_.tb2_0(0);
TIDOFAEL_.old_tb2_2(0):='GEGE_EXERULINI_CT67E121400597'
;
TIDOFAEL_.tb2_2(0):=TIDOFAEL_.tb2_0(0);
...
VALUES (TIDOFAEL_.tb2_0(0),
67,
TIDOFAEL_.tb2_2(0),
'PKGENERALSERVICES.FNUGETNEXTSEQUENCEVAL("SEQ_TIDOFAEL")'
,
'OPEN'
,
to_date('04-01-2024 08:54:41','DD-MM-YYYY HH24:MI:SS'),
to_date('04-01-2024 08:54:41','DD-MM-YYYY HH24:MI:SS'),
to_date('04-01-2024 08:54:41','DD-MM-YYYY HH24:MI:SS'),
'R'
,
...
TIDOFAEL_.tb3_0(0):=TIDOFAEL_.tb0_1(0);
TIDOFAEL_.old_tb3_1(0):=90199583;
TIDOFAEL_.tb3_1(0):=GE_BOCATALOG.FNUGETIDSEQFROMCATALOG(TIDOFAEL_.TBENTITYATTRIBUTENAME(TIDOFAEL_.old_tb3_1(0)), 'ATTRIBUTE', GE_BOSEQUENCE.NEXTGE_ENTITY_ATTRIBUTES);
TIDOFAEL_.tb3_1(0):=TIDOFAEL_.tb3_1(0);
TIDOFAEL_.tb3_2(0):=TIDOFAEL_.tb2_0(0);
ut_trace.trace('Actualizar o insertar tabla: GE_ENTITY_ATTRIBUTES fila (0)',1);
UPDATE GE_ENTITY_ATTRIBUTES SET ENTITY_ID=TIDOFAEL_.tb3_0(0),
ENTITY_ATTRIBUTE_ID=TIDOFAEL_.tb3_1(0),
INIT_EXPRESSION_ID=TIDOFAEL_.tb3_2(0),
...
PROTECTOR_TEXT=null
 WHERE ENTITY_ATTRIBUTE_ID = TIDOFAEL_.tb3_1(0);
if not (sql%found) then
...
TIDOFAEL_.tb3_0(1):=TIDOFAEL_.tb0_1(0);
TIDOFAEL_.old_tb3_1(1):=90199584;
TIDOFAEL_.tb3_1(1):=GE_BOCATALOG.FNUGETIDSEQFROMCATALOG(TIDOFAEL_.TBENTITYATTRIBUTENAME(TIDOFAEL_.old_tb3_1(1)), 'ATTRIBUTE', GE_BOSEQUENCE.NEXTGE_ENTITY_ATTRIBUTES);
TIDOFAEL_.tb3_1(1):=TIDOFAEL_.tb3_1(1);
ut_trace.trace('Actualizar o insertar tabla: GE_ENTITY_ATTRIBUTES fila (1)',1);
UPDATE GE_ENTITY_ATTRIBUTES SET ENTITY_ID=TIDOFAEL_.tb3_0(1),
ENTITY_ATTRIBUTE_ID=TIDOFAEL_.tb3_1(1),
...
UNCHECKED_VALUE=null,
PROTECTOR_TEXT=null
 WHERE ENTITY_ATTRIBUTE_ID = TIDOFAEL_.tb3_1(1);
if not (sql%found) then
INSERT INTO GE_ENTITY_ATTRIBUTES(ENTITY_ID,ENTITY_ATTRIBUTE_ID,INIT_EXPRESSION_ID,VALID_EXPRESSION_ID,GI_COMPONENT_ID,MASK_ID,REFERENCE,ATTRIBUTE_TYPE_ID,TECHNICAL_NAME,SECUENCE_,KEY_,IS_NULL,DISPLAY_NAME,VIEWER_DISPLAY,PRECISION,DEFAULT_VALUE,SCALE,LENGTH,COMMENT_,TAG_ELEMENT,STATUS,IS_DESCRIPTION,IS_LOV_DESCRIPTION,IS_CHECK_BOX,CHECKED_VALUE,UNCHECKED_VALUE,PROTECTOR_TEXT) 
VALUES (TIDOFAEL_.tb3_0(1),
TIDOFAEL_.tb3_1(1),
null,
null,
null,
...
TIDOFAEL_.tb3_0(2):=TIDOFAEL_.tb0_1(0);
TIDOFAEL_.old_tb3_1(2):=90199586;
TIDOFAEL_.tb3_1(2):=GE_BOCATALOG.FNUGETIDSEQFROMCATALOG(TIDOFAEL_.TBENTITYATTRIBUTENAME(TIDOFAEL_.old_tb3_1(2)), 'ATTRIBUTE', GE_BOSEQUENCE.NEXTGE_ENTITY_ATTRIBUTES);
TIDOFAEL_.tb3_1(2):=TIDOFAEL_.tb3_1(2);
ut_trace.trace('Actualizar o insertar tabla: GE_ENTITY_ATTRIBUTES fila (2)',1);
UPDATE GE_ENTITY_ATTRIBUTES SET ENTITY_ID=TIDOFAEL_.tb3_0(2),
ENTITY_ATTRIBUTE_ID=TIDOFAEL_.tb3_1(2),
INIT_EXPRESSION_ID=null,
VALID_EXPRESSION_ID=null,
GI_COMPONENT_ID=null,
MASK_ID=null,
...
IS_NULL='N'
,
DISPLAY_NAME='Umbral para notificación'
,
VIEWER_DISPLAY='Y'
,
PRECISION=2,
...
UNCHECKED_VALUE=null,
PROTECTOR_TEXT=null
 WHERE ENTITY_ATTRIBUTE_ID = TIDOFAEL_.tb3_1(2);
if not (sql%found) then
INSERT INTO GE_ENTITY_ATTRIBUTES(ENTITY_ID,ENTITY_ATTRIBUTE_ID,INIT_EXPRESSION_ID,VALID_EXPRESSION_ID,GI_COMPONENT_ID,MASK_ID,REFERENCE,ATTRIBUTE_TYPE_ID,TECHNICAL_NAME,SECUENCE_,KEY_,IS_NULL,DISPLAY_NAME,VIEWER_DISPLAY,PRECISION,DEFAULT_VALUE,SCALE,LENGTH,COMMENT_,TAG_ELEMENT,STATUS,IS_DESCRIPTION,IS_LOV_DESCRIPTION,IS_CHECK_BOX,CHECKED_VALUE,UNCHECKED_VALUE,PROTECTOR_TEXT) 
VALUES (TIDOFAEL_.tb3_0(2),
TIDOFAEL_.tb3_1(2),
null,
null,
null,
...
if (not TIDOFAEL_.blProcessStatus) then
 return;
  ...
  commit;
  gi_boframeworkentityattribute.UpdateEntityReferences('TIDOFAEL');
EXCEPTION
...
nuRowProcess:=TIDOFAEL_.tb2_0.first;
while (nuRowProcess is not null) loop 
ut_trace.trace('Genera expresión regla:'|| TIDOFAEL_.tb2_0(nuRowProcess),1); 
begin
GR_BOINTERFACE_BODY.MakeExpression(TIDOFAEL_.tb2_0(nuRowProcess)); 
exception when others then
ut_trace.trace('Fallo la generacion de la regla:'|| TIDOFAEL_.tb2_0(nuRowProcess),1);
end;
nuRowProcess := TIDOFAEL_.tb2_0.next(nuRowProcess);
END loop;
COMMIT;
...
begin
SA_BOCreatePackages.DropPackage('TIDOFAEL_');
end;
/

BEGIN ut_trace.trace('********************FIN  proceso de objeto:TIDOFAEL_******************************'); end;
/
