...
BEGIN 
   MDCCFE_.tbEntityName(6159) := 'RECOFAEL';
   MDCCFE_.tbEntityAttributeName(90199573) := 'RECOFAEL@CODIGO';
   MDCCFE_.tbEntityAttributeName(90199585) := 'RECOFAEL@TIPO_DOCUMENTO';
   MDCCFE_.tbEntityAttributeName(90199574) := 'RECOFAEL@PREFIJO';
   MDCCFE_.tbEntityAttributeName(90199582) := 'RECOFAEL@RESOLUCION';
   MDCCFE_.tbEntityAttributeName(90199575) := 'RECOFAEL@CONS_INICIAL';
   MDCCFE_.tbEntityAttributeName(90199576) := 'RECOFAEL@CONS_FINAL';
   MDCCFE_.tbEntityAttributeName(90199577) := 'RECOFAEL@ULTIMO_CONS';
   MDCCFE_.tbEntityAttributeName(90199751) := 'RECOFAEL@FECHA_RESOLUCION';
   MDCCFE_.tbEntityAttributeName(90199752) := 'RECOFAEL@FECHA_INI_VIGENCIA';
   MDCCFE_.tbEntityAttributeName(90199753) := 'RECOFAEL@FECHA_FIN_VIGENCIA';
   MDCCFE_.tbEntityAttributeName(90199578) := 'RECOFAEL@ESTADO';
   MDCCFE_.tbEntityAttributeName(90199579) := 'RECOFAEL@FECHA_REGISTRO';
   MDCCFE_.tbEntityAttributeName(90199580) := 'RECOFAEL@USUARIO';
   MDCCFE_.tbEntityAttributeName(90199581) := 'RECOFAEL@TERMINAL';
...
MDCCFE_.old_tb0_1(0):=500000000015765;
...
16,
'C',
to_date('19-02-2024 15:05:37','DD-MM-YYYY HH24:MI:SS'),
null);
