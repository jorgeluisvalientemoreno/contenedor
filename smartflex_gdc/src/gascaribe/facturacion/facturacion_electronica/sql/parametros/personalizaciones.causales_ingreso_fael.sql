MERGE INTO PERSONALIZACIONES.PARAMETROS A USING
 (SELECT
  'CAUSALES_INGRESO_FAEL' as CODIGO,
  'Codigo de causales a tener en cuenta para el ingreso de facturacion electronica' as DESCRIPCION,
  null as VALOR_NUMERICO,
  '15, 51, 59, 16,53' as VALOR_CADENA,
  NULL as VALOR_FECHA,
  18 as PROCESO,
