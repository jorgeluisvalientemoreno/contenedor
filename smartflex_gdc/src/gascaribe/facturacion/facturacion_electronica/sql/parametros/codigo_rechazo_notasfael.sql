MERGE INTO PARAMETROS A USING
 (SELECT
  'CODIGO_RECHAZO_NOTASFAEL' as CODIGO,
  'Codigos de rechazo por factura aceptada por cliente - facturación electrónica' as DESCRIPCION,
  null as VALOR_NUMERICO,
  'LGC15|LGC16'  as VALOR_CADENA,
  NULL as VALOR_FECHA,
  18 as PROCESO,
