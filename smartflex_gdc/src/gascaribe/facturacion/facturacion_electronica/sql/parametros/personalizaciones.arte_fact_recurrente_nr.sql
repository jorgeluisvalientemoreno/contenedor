MERGE INTO PERSONALIZACIONES.PARAMETROS A USING
 (SELECT
  'ARTE_FACT_RECURRENTE_NR' as CODIGO,
  'Arte facturacion bo recurrente - facturacion electronica' as DESCRIPCION,
  null as VALOR_NUMERICO,
  'ARTE_FACTURA_RECURRENTE_NO_REGULADOS.PDF'  as VALOR_CADENA,
  NULL as VALOR_FECHA,
  18 as PROCESO,
