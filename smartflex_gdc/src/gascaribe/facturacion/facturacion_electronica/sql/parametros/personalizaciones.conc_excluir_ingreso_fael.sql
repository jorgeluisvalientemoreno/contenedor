MERGE INTO PERSONALIZACIONES.PARAMETROS A USING
 (SELECT
  'CONC_EXCLUIR_INGRESO_FAEL' as CODIGO,
  'Codigo de conceptos a excluir para el ingreso de facturacion electronica' as DESCRIPCION,
  null as VALOR_NUMERICO,
  '196, 37, 167, 142, 108, 596, 717, 24, 832,895,936,1006' as VALOR_CADENA,
  NULL as VALOR_FECHA,
  18 as PROCESO,
