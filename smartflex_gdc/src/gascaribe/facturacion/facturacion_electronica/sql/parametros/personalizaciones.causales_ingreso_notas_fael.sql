MERGE INTO PERSONALIZACIONES.PARAMETROS A USING
 (SELECT
  'CAUSALES_INGRESO_NOTAS_FAEL' as CODIGO,
  'Codigo de causales a tener en cuenta para el ingreso de notas - facturacion electronica' as DESCRIPCION,
  null as VALOR_NUMERICO,
  '1,3,4,12' as VALOR_CADENA,
  NULL as VALOR_FECHA,
  18 as PROCESO,
