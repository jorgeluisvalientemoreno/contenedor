...
GE_OBJECT_121794_.tb0_2(0):='PKG_UILDEJO.PRCREGLAINICIALIZAFECHAINICIO'
;
...
MODULE_ID=4,
DESCRIPTION='LDEJO - Inicializa Fecha Inicio de Ejecución'
,
COMMENT_='LDEJO - Inicializa Fecha Inicio de Ejecución'
,
PARAMETERS='()'
,
OBJECT_CLASS='P'
...
4,
'LDEJO - Inicializa Fecha Inicio de Ejecución'
,
'LDEJO - Inicializa Fecha Inicio de Ejecución'
,
'()'
