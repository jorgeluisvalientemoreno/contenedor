create or replace PACKAGE fcfldc_detallefact_gascaribe6 IS
  /*****************************************************************
...
END fcfldc_detallefact_gascaribe6;
/
create or replace PACKAGE BODY fcfLDC_DetalleFact_GasCaribe6 IS
