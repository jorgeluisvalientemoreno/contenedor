create or replace PACKAGE fcfldc_detallefact_gascaribe3 IS
  /*****************************************************************
...
END fcfldc_detallefact_gascaribe3;
/
create or replace PACKAGE BODY fcfLDC_DetalleFact_GasCaribe3 IS
