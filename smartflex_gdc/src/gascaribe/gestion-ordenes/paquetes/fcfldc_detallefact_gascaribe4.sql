create or replace PACKAGE fcfldc_detallefact_gascaribe4 IS
  /*****************************************************************
...
END fcfldc_detallefact_gascaribe4;
/
create or replace PACKAGE BODY fcfLDC_DetalleFact_GasCaribe4 IS
