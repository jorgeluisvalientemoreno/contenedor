MERGE INTO PERSONALIZACIONES.PARAMETROS A USING
 (SELECT
  'TIPO_SOL_EXCLU_VALIDA_FINANCIA' as "CODIGO",
  'TIPO DE SOLICITUD EXCLUIDAS DE LA VALDACION DE FINANCIACION DE CARGO A LA -1 SEPARADOR(,) OSF-3103' as "DESCRIPCION",
  NULL as "VALOR_NUMERICO",
  '100229,323' as "VALOR_CADENA",
  NULL as "VALOR_FECHA",
  1 as "PROCESO",
