MERGE INTO OPEN.LD_PARAMETER A USING
 (SELECT
  'MAR_PROD_FNUASIGNAAUTORECOREP' as "PARAMETER_ID",
  NULL as "NUMERIC_VALUE",
  '102,104' as "VALUE_CHAIN",
  'MARCA PRODUCTO VALIDADO EN EL SERVICIO FNUASIGNAAUTORECOREP PARA AUTORECONECTADOS OSF-2443' as "DESCRIPTION"
  FROM DUAL) B
