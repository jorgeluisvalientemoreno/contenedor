Prompt Creando el parametro TITR_VALIDA_OT_ABIERTA
BEGIN
MERGE INTO OPEN.PARAMETROS A USING
 (SELECT
  'TITR_VALIDA_OT_ABIERTA' as CODIGO,
  'Tipos de trabajo que valida ordenes abiertas' as DESCRIPCION,
  NULL as VALOR_NUMERICO,
  '10949' as VALOR_CADENA,
  NULL as VALOR_FECHA,
  4 as PROCESO,
  'A' as ESTADO,
  'S' as OBLIGATORIO,
