MERGE INTO PERSONALIZACIONES.PARAMETROS A USING
 (SELECT
  'TIPOS_TRABAJO_ORD_SERVICIOS_ING' as CODIGO,
  'Tipos de trabajo verificación de medidor para tramite de venta de servicios de ingeniera' as DESCRIPCION,
  NULL as VALOR_NUMERICO,
  '11177,11056,11178' as VALOR_CADENA,
  NULL as VALOR_FECHA,
  15 as PROCESO,
