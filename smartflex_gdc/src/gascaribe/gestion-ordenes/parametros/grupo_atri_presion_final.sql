Prompt Creando el parametro GRUPO_ATRI_PRESION_FINAL 
BEGIN
MERGE INTO OPEN.PARAMETROS A USING
 (SELECT
  'GRUPO_ATRI_PRESION_FINAL' as CODIGO,
  'Valor grupo de atributos de presion final' as DESCRIPCION,
  11339 as VALOR_NUMERICO,
