DECLARE
    ...
    -- OSF-2604
    csbMetodo        CONSTANT VARCHAR2(70) :=  'LDC_GENERAVTINGVIS';
...
begin
    ...
    IF nuCantObj = 1 THEN
        ...
        dbms_output.put_line('Se hizo drop al procedure ' || csbEsquema || '.' || csbMetodo );
    
    ELSE

        dbms_output.put_line('No existe el procedure ' ||  csbEsquema ||'.' || csbMetodo );
