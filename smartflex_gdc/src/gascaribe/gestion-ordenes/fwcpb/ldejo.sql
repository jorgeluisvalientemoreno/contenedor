...
LDEJO_.old_tb0_1(0):=500000000011491;
...
'C'
,
to_date('12-12-2024 08:53:51','DD-MM-YYYY HH24:MI:SS'),
null);
...
<PB xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema">
  <APPLICATION>
    <EXECUTABLE_ID>500000000011491</EXECUTABLE_ID>
    <NAME>LDEJO</NAME>
    ...
    <PATH_FILE_HELP/>
    <OBJECT_NAME>PKG_UILDEJO.PRCOBJETO</OBJECT_NAME>
    <QUERY_NAME/>
  ...
  <COMPOSITION>
    ...
    <EXTERNAL_TYPE_ID>500000000011491</EXTERNAL_TYPE_ID>
    <ENTITY_ID>9623</ENTITY_ID>
    <EXTERNAL_ID>500000000011491</EXTERNAL_ID>
...
'TABLE>
    ...
    <TAG_NAME/>
    <AFTER_EXPRESSION_ID/>
    <BEFORE_EXPRESSION_ID>121221966</BEFORE_EXPRESSION_ID>
...
ORDER BY COMMENT_TYPE_ID </SELECT_STATEMENT>
      <SELECT_STATEMENT_ID>120120589</SELECT_STATEMENT_ID>
      <TAG_NAME/>
      <PROCESS_SEQUENCE/>
      <STATEMENT_CACHE>N</STATEMENT_CACHE>
      <USER_DEFAULT_ALLOWED>N</USER_DEFAULT_ALLOWED>
...
'E>DATE</DATA_TYPE>
      ...
      <INIT_BASIC_EXP_ID/>
      <VALID_BASIC_EXP_ID/>
      <INIT_EXPRESSION_ID>121221967</INIT_EXPRESSION_ID>
      <VALID_EXPRESSION_ID/>
      <DEFAULT_VALUE/>
      <SELECT_STATEMENT/>
      <SELECT_STATEMENT_ID/>
...
'_ID>3294</ENTITY_ID>
      ...
      <INIT_BASIC_EXP_ID/>
      <VALID_BASIC_EXP_ID/>
      <INIT_EXPRESSION_ID>121221968</INIT_EXPRESSION_ID>
      <VALID_EXPRESSION_ID/>
      <DEFAULT_VALUE/>
      <SELECT_STATEMENT/>
      <SELECT_STATEMENT_ID/>
...
,
null,
'9a065af551db9ac51f15baa6722ff0a4'
,
3);
...
if (not LDEJO_.blProcessStatus) then
 ...
 ut_trace.trace('Borrando tabla GR_CONFIG_EXPRESSION['||'121221966'||']',1);
delete from GR_CONFIG_EXPRESSION where 
  OBJECT_NAME = 'FWFW_PROCESS_CT54E121221966';
...
to_date('28-11-2016 21:11:42','DD-MM-YYYY HH24:MI:SS'), to_date('28-11-2016 21:11:42','DD-MM-YYYY HH24:MI:SS'), 'G', 
'N', 'PU', null, 
'DS', 'LDEJO - Valida que la orden no puede ser administrativa', 'PP', 
'CREATE OR REPLACE PROCEDURE FWFW_PROCESS_CT54E121221966(errorNumber OUT NUMBER, errorMessage OUT VARCHAR2)
IS
...
if (not LDEJO_.blProcessStatus) then
 return;
  ...
  BEGIN
   delete from GE_STATEMENT where STATEMENT_ID = 120120589 and MODULE_ID = 14 and NAME = 'LDEJO - Tipo de comentario';
  EXCEPTION
  when ex.RECORD_HAVE_CHILDREN then
    ut_trace.trace('No se pudo borrar la sentencia: [120120589]',1);
   null;
  END;
...
if (not LDEJO_.blProcessStatus) then
 ...
 ut_trace.trace('Borrando tabla GR_CONFIG_EXPRESSION['||'121221967'||']',1);
delete from GR_CONFIG_EXPRESSION where 
  OBJECT_NAME = 'FWFW_PROCESS_CT54E121221967';
...
INSERT INTO GR_CONFIG_EXPRESSION(CONFIG_EXPRESSION_ID,OBJECT_NAME,CONFIGURA_TYPE_ID,EXPRESSION,AUTHOR,CREATION_DATE,GENERATION_DATE,LAST_MODIFI_DATE,STATUS,USED_OTHER_EXPRESION,MODIFICATION_TYPE,PASSWORD,EXECUTION_TYPE,DESCRIPTION,OBJECT_TYPE,CODE) 
VALUES (nuNewRule, nuNewRule, 54, 
'PKG_UILDEJO.PRCREGLAINICIALIZAFECHAINICIO()',
'OPEN', to_date('31-10-2016 09:02:03','DD-MM-YYYY HH24:MI:SS'), 
to_date('11-12-2024 17:12:19','DD-MM-YYYY HH24:MI:SS'), to_date('11-12-2024 17:12:19','DD-MM-YYYY HH24:MI:SS'), 'R', 
'N', 'PU', null, 
'DS', 'Fecha inicio de ejecució LDEJO', 'PP', 
'CREATE OR REPLACE PROCEDURE FWFW_PROCESS_CT54E121221967(errorNumber OUT NUMBER, errorMessage OUT VARCHAR2)
IS
-- Generated by Code Generator (PVCS Version 1.5)
 -- Open Systems Ltd, Copyright 2003.
V0 NUMBER;
...
if (not LDEJO_.blProcessStatus) then
 ...
 ut_trace.trace('Borrando tabla GR_CONFIG_EXPRESSION['||'121221968'||']',1);
delete from GR_CONFIG_EXPRESSION where 
  OBJECT_NAME = 'FWFW_PROCESS_CT54E121221968';
...
INSERT INTO GR_CONFIG_EXPRESSION(CONFIG_EXPRESSION_ID,OBJECT_NAME,CONFIGURA_TYPE_ID,EXPRESSION,AUTHOR,CREATION_DATE,GENERATION_DATE,LAST_MODIFI_DATE,STATUS,USED_OTHER_EXPRESION,MODIFICATION_TYPE,PASSWORD,EXECUTION_TYPE,DESCRIPTION,OBJECT_TYPE,CODE) 
VALUES (nuNewRule, nuNewRule, 54, 
'PKG_UILDEJO.PRCREGLAINICIALIZAFECHAFIN()',
'OPEN', to_date('31-10-2016 08:52:10','DD-MM-YYYY HH24:MI:SS'), 
to_date('11-12-2024 17:12:46','DD-MM-YYYY HH24:MI:SS'), to_date('11-12-2024 17:12:46','DD-MM-YYYY HH24:MI:SS'), 'R', 
'N', 'PU', null, 
'DS', 'Fecha Fin de ejecución LDEJO', 'PP', 
'CREATE OR REPLACE PROCEDURE FWFW_PROCESS_CT54E121221968(errorNumber OUT NUMBER, errorMessage OUT VARCHAR2)
IS
-- Generated by Code Generator (PVCS Version 1.5)
 -- Open Systems Ltd, Copyright 2003.
V0 NUMBER;
