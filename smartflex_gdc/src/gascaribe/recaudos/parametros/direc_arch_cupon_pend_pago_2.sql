BEGIN
	MERGE INTO PERSONALIZACIONES.PARAMETROS A USING
	 (SELECT
	  'DIREC_ARCH_CUPON_PEND_PAGO_2' as CODIGO,
	  'Directorio de los archivos de cupones de duplicados pendientes de pago para Asobancaria' as DESCRIPCION,
	  NULL as VALOR_NUMERICO,
	  '/smartfiles/Recaudos/Envio2' as VALOR_CADENA,
	  NULL as VALOR_FECHA,
	  6 as PROCESO,
