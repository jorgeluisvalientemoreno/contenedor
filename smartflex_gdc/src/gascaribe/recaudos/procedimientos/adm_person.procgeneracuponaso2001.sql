create or replace procedure adm_person.ProcGeneraCuponAso2001 is
  /************************************************************************
    Copyright (c) 2014 GASES DEL CARIBE

    NOMBRE       : ProcGeneraCuponAso2001
    ...
    jpinedc     15/02/2024   OSF-2328: Ajustes nuevas directrices desarrollo
  ************************************************************************/

    csbNivelTraza    CONSTANT NUMBER(2)    := pkg_traza.fnuNivelTrzDef;
    
    csbMetodo        CONSTANT VARCHAR2(70) := 'ProcGeneraCuponAso2001';
...
begin
    ...
    for rgPeriodo in cuPeriodo loop
