...
BEGIN
  ...
  set expression = 'PKG_REGLASPLANCONDICIONES.PRCEXCLUIRORDENESTADODOCUMENTO()', author = 'FRESIE',
generation_date = to_date ('01/08/18','DD/MM/YYYY HH24:MI:SS'),
last_modifi_date = to_date ('01/08/18','DD/MM/YYYY HH24:MI:SS'),
object_type = 'PP'
 where config_expression_id = 121310391;
