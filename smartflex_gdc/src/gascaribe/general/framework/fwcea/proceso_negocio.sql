...
BEGIN
sa_bocreatePackages.CreatePackage('PROCESO_NEGOCIO_',
'CREATE OR REPLACE PACKAGE PROCESO_NEGOCIO_ IS ' || chr(10) ||
...
' ' || chr(10) ||
'END PROCESO_NEGOCIO_;');
END;
/


BEGIN ut_trace.trace('********************Comenzar proceso de objeto:PROCESO_NEGOCIO_******************************'); END;
/
...
DECLARE
    ...
    CURSOR  cuConfigExpression IS
        ...
        WHERE   GR_CONFIG_EXPRESSION.CONFIG_EXPRESSION_ID IN (
            ...
            WHERE   ENTITY_ID in (SELECT ENTITY_ID FROM GE_ENTITY WHERE NAME_='PROCESO_NEGOCIO')
            UNION
...
if (not PROCESO_NEGOCIO_.blProcessStatus) then
 return;
end if;
    ...
    DELETE FROM GE_ATTR_VAL_EXPRESS WHERE (ENTITY_ATTRIBUTE_ID) in (SELECT ENTITY_ATTRIBUTE_ID FROM GE_ENTITY_ATTRIBUTES WHERE (ENTITY_ID) in (SELECT ENTITY_ID FROM GE_ENTITY WHERE NAME_='PROCESO_NEGOCIO'));
    DELETE FROM GE_ATTR_ALLOWED_VALUES WHERE (ENTITY_ATTRIBUTE_ID) in (SELECT ENTITY_ATTRIBUTE_ID FROM GE_ENTITY_ATTRIBUTES WHERE (ENTITY_ID) in (SELECT ENTITY_ID FROM GE_ENTITY WHERE NAME_='PROCESO_NEGOCIO'));
...
BEGIN 
  PROCESO_NEGOCIO_.tbEntityAttributeName(90199943) := 'PROCESO_NEGOCIO@CODIGO'; 
  PROCESO_NEGOCIO_.tbEntityAttributeName(90199944) := 'PROCESO_NEGOCIO@DESCRIPCION'; 
END;
/
...
PROCESO_NEGOCIO_.old_tb0_0(0):='PROCESO_NEGOCIO'
;
PROCESO_NEGOCIO_.tb0_0(0):='PROCESO_NEGOCIO';
PROCESO_NEGOCIO_.old_tb0_1(0):=6176;
PROCESO_NEGOCIO_.tb0_1(0):=GE_BOCATALOG.FNUGETIDSEQFROMCATALOG(PROCESO_NEGOCIO_.tb0_0(0), 'ENTITY', 'GE_BOSEQUENCE.NEXTGE_ENTITY');
PROCESO_NEGOCIO_.tb0_1(0):=PROCESO_NEGOCIO_.tb0_1(0);
ut_trace.trace('Actualizar o insertar tabla: GE_ENTITY fila (0)',1);
UPDATE GE_ENTITY SET NAME_=PROCESO_NEGOCIO_.tb0_0(0),
ENTITY_ID=PROCESO_NEGOCIO_.tb0_1(0),
MODULE_ID=61,
SELEC_TYPE_OBJECT_ID=null,
INS_SEQ=null,
IN_PERSIST='Y'
,
DESCRIPTION='Procesos de Negocios'
,
DISPLAY_NAME='PROCESO_NEGOCIO'
,
LOAD_CARTRIDGE='N'
,
TABLESPACE='TSD_DEFAULT'
,
CREATION_DATE=to_date('15-08-2024 15:35:18','DD-MM-YYYY HH24:MI:SS'),
LAST_MODIFY_DATE=to_date('04-09-2024 16:21:23','DD-MM-YYYY HH24:MI:SS'),
STATUS='G'
,
ALLOWED_FULL_SCAN='Y'

 WHERE ENTITY_ID = PROCESO_NEGOCIO_.tb0_1(0);
...
VALUES (PROCESO_NEGOCIO_.tb0_0(0),
PROCESO_NEGOCIO_.tb0_1(0),
61,
null,
null,
'Y'
...
'TSD_DEFAULT'
,
to_date('15-08-2024 15:35:18','DD-MM-YYYY HH24:MI:SS'),
to_date('04-09-2024 16:21:23','DD-MM-YYYY HH24:MI:SS'),
'G'
,
'Y'
);
...
PROCESO_NEGOCIO_.blProcessStatus := false;
rollback;
ut_trace.trace('**ERROR:'||sqlerrm);
raise;
END;
...
PROCESO_NEGOCIO_.tb1_0(0):=PROCESO_NEGOCIO_.tb0_1(0);
ut_trace.trace('Actualizar o insertar tabla: GE_ENTITY_ADITIONAL fila (0)',1);
UPDATE GE_ENTITY_ADITIONAL SET ENTITY_ID=PROCESO_NEGOCIO_.tb1_0(0),
STATEMENT_ID=null,
...
IS_CUSTOM_ENTITY='Y'
 ...
 WHERE ENTITY_ID = PROCESO_NEGOCIO_.tb1_0(0);
if not (sql%found) then
...
VALUES (PROCESO_NEGOCIO_.tb1_0(0),
null,
null,
null,
null,
...
PROCESO_NEGOCIO_.tb2_0(0):=PROCESO_NEGOCIO_.tb0_1(0);
PROCESO_NEGOCIO_.old_tb2_1(0):=90199943;
PROCESO_NEGOCIO_.tb2_1(0):=GE_BOCATALOG.FNUGETIDSEQFROMCATALOG(PROCESO_NEGOCIO_.TBENTITYATTRIBUTENAME(PROCESO_NEGOCIO_.old_tb2_1(0)), 'ATTRIBUTE', GE_BOSEQUENCE.NEXTGE_ENTITY_ATTRIBUTES);
PROCESO_NEGOCIO_.tb2_1(0):=PROCESO_NEGOCIO_.tb2_1(0);
ut_trace.trace('Actualizar o insertar tabla: GE_ENTITY_ATTRIBUTES fila (0)',1);
UPDATE GE_ENTITY_ATTRIBUTES SET ENTITY_ID=PROCESO_NEGOCIO_.tb2_0(0),
ENTITY_ATTRIBUTE_ID=PROCESO_NEGOCIO_.tb2_1(0),
...
PROTECTOR_TEXT=null
 WHERE ENTITY_ATTRIBUTE_ID = PROCESO_NEGOCIO_.tb2_1(0);
if not (sql%found) then
...
VALUES (PROCESO_NEGOCIO_.tb2_0(0),
PROCESO_NEGOCIO_.tb2_1(0),
null,
null,
null,
null,
...
PROCESO_NEGOCIO_.tb2_0(1):=PROCESO_NEGOCIO_.tb0_1(0);
PROCESO_NEGOCIO_.old_tb2_1(1):=90199944;
PROCESO_NEGOCIO_.tb2_1(1):=GE_BOCATALOG.FNUGETIDSEQFROMCATALOG(PROCESO_NEGOCIO_.TBENTITYATTRIBUTENAME(PROCESO_NEGOCIO_.old_tb2_1(1)), 'ATTRIBUTE', GE_BOSEQUENCE.NEXTGE_ENTITY_ATTRIBUTES);
PROCESO_NEGOCIO_.tb2_1(1):=PROCESO_NEGOCIO_.tb2_1(1);
ut_trace.trace('Actualizar o insertar tabla: GE_ENTITY_ATTRIBUTES fila (1)',1);
UPDATE GE_ENTITY_ATTRIBUTES SET ENTITY_ID=PROCESO_NEGOCIO_.tb2_0(1),
ENTITY_ATTRIBUTE_ID=PROCESO_NEGOCIO_.tb2_1(1),
INIT_EXPRESSION_ID=null,
VALID_EXPRESSION_ID=null,
GI_COMPONENT_ID=null,
MASK_ID=null,
...
UNCHECKED_VALUE=null,
PROTECTOR_TEXT=null
 WHERE ENTITY_ATTRIBUTE_ID = PROCESO_NEGOCIO_.tb2_1(1);
if not (sql%found) then
INSERT INTO GE_ENTITY_ATTRIBUTES(ENTITY_ID,ENTITY_ATTRIBUTE_ID,INIT_EXPRESSION_ID,VALID_EXPRESSION_ID,GI_COMPONENT_ID,MASK_ID,REFERENCE,ATTRIBUTE_TYPE_ID,TECHNICAL_NAME,SECUENCE_,KEY_,IS_NULL,DISPLAY_NAME,VIEWER_DISPLAY,PRECISION,DEFAULT_VALUE,SCALE,LENGTH,COMMENT_,TAG_ELEMENT,STATUS,IS_DESCRIPTION,IS_LOV_DESCRIPTION,IS_CHECK_BOX,CHECKED_VALUE,UNCHECKED_VALUE,PROTECTOR_TEXT) 
VALUES (PROCESO_NEGOCIO_.tb2_0(1),
PROCESO_NEGOCIO_.tb2_1(1),
null,
null,
null,
null,
...
if (not PROCESO_NEGOCIO_.blProcessStatus) then
 return;
  ...
  commit;
  gi_boframeworkentityattribute.UpdateEntityReferences('PROCESO_NEGOCIO');
EXCEPTION
...
begin
SA_BOCreatePackages.DropPackage('PROCESO_NEGOCIO_');
end;
/

BEGIN ut_trace.trace('********************FIN  proceso de objeto:PROCESO_NEGOCIO_******************************'); end;
/
