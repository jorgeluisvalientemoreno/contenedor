...
Nombre: adm_person.ldc_vainsldsendauthori.sql
Descripción: Borrado objeto LDC_VAINSLDSENDAUTHORI  

Historia de Modificaciones
Fecha           Autor.                  Modificación
-----------     -------------------     -------------------------------------
12-06-2025      Paola Acosta            OSF-4507: Borrado objeto LDC_VAINSLDSENDAUTHORI  
******************************************************************/ 
DECLARE
    -- OSF-3450
    csbobjeto      CONSTANT VARCHAR2(70) := 'LDC_VAINSLDSENDAUTHORI';
    csbesquema     CONSTANT VARCHAR2(30) := 'ADM_PERSON';
    csbtipoobjeto  CONSTANT VARCHAR2(30) := 'PROCEDURE';
    nuerror        NUMBER;
