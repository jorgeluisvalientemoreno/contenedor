...
Parametro       : CAUSALES_FLAG_VALIDATE  
Autor           : Paola Acosta
Fecha           : 17-12-2024
Modificaciones  :
...
MERGE INTO OPEN.PARAMETROS A USING
 (SELECT
  'CAUSALES_FLAG_VALIDATE' as CODIGO,
  'Causales para el atributo FLAG_VALIDATE del flujo de interacción' as DESCRIPCION,
  NULL as VALOR_NUMERICO,
  '11,13' as VALOR_CADENA,
  NULL as VALOR_FECHA,
  20 as PROCESO, 
  'A' as ESTADO,
  'N' as OBLIGATORIO,
