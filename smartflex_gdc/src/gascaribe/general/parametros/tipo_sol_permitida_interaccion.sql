...
Parametro       : TIPO_SOL_PERMITIDA_INTERACCION  
Autor           : Paola Acosta
Fecha           : 26-12-2024
Modificaciones  :
Autor       Fecha           Caso        Descripcion
pacosta     26-12-2024      OSF-3755    Creacion
***************************************************************************/

MERGE INTO OPEN.PARAMETROS A USING
 (SELECT
  'TIPO_SOL_PERMITIDA_INTERACCION' as CODIGO,
  'Código tipo solicitud para permitir interacción osf-679' as DESCRIPCION,
  NULL as VALOR_NUMERICO,
  '545,50,52,100030' as VALOR_CADENA,
  NULL as VALOR_FECHA,
  20 as PROCESO, 
  'A' as ESTADO,
  'N' as OBLIGATORIO,
