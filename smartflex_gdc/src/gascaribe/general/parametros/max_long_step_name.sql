Prompt Creando el parametro MAX_LONG_STEP_NAME
BEGIN
	MERGE INTO PERSONALIZACIONES.PARAMETROS A USING
	 (SELECT
	  'MAX_LONG_STEP_NAME' as CODIGO,
	  'Longitud maxima del nombre de un paso de cadena de Jobs' as DESCRIPCION,
	  24 as VALOR_NUMERICO,
