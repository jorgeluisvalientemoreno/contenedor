MERGE INTO PERSONALIZACIONES.PARAMETROS A USING
 (SELECT
  'TOKEN_FACTELECT' as CODIGO,
  'token para solicitud de facturacion electronica - Energia' as DESCRIPCION,
  null as VALOR_NUMERICO,
  '79e5882dc85af5deeabe64fd76a2d77dfeb6a8c5' as VALOR_CADENA,
  NULL as VALOR_FECHA,
  8 as PROCESO,
