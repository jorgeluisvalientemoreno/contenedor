CREATE OR REPLACE PACKAGE LDCI_PKFACTELECTRONICA_EMI AS
/*
...
*/
  ...
  PROCEDURE PROENVIAENERGIASOLAR(inuSucripc IN NUMBER, inuConsFact IN NUMBER, icbXMLFac IN CLOB, ocbResponse OUT CLOB, onuErrorCode OUT NUMBER,osbErrorMessage OUT VARCHAR2);
...
/
CREATE OR REPLACE PACKAGE BODY LDCI_PKFACTELECTRONICA_EMI AS
...
Begin
  ...
  open rfMensaje for
            select  sbClasPed as "ClasPed",
                    ...
                    FROM  open.ge_acta ga,open.ge_contrato co,open.ge_contratista oc,open.ge_subscriber cl
                    ...
                    cursor (SELECT
                             ...
                             ,Decode((select cb.celocebe
                                       from open.ldci_centbenelocal cb
                    ...
                    WHERE da.id_acta = inuActaId
                       ...
                       AND EXISTS(SELECT 'X' FROM OPEN.GE_ACTA A
...
END LDCI_PKFACTELECTRONICA_EMI;
/
GRANT EXECUTE on LDCI_PKFACTELECTRONICA_EMI to SYSTEM_OBJ_PRIVS_ROLE;
