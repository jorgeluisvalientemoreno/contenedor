...
CREATE OR REPLACE PACKAGE BODY PERSONALIZACIONES.LDCI_PKG_BOINTEGRAGIS AS
  ...
  **/
   ...
   * Autor   : Freddy Enrique Sierra Yepez
   * Fecha   : 15/11/2024
   * Descripcion : Procedimiento que permite realizar la actualización de categoria y subcategoria de un contrato en Gis
   *
   * Parametros
   *inuContrato     NUMBER
   *inuCategoria     NUMBER
...
BEGIN
  ...
  dbms_output.put_line('Permisos de la tabla PERSONALIZACIONES.LDCI_PKG_BOINTEGRAGIS Ok.');
END;
/