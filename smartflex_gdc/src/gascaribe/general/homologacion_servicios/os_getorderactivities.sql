...
MERGE INTO PERSONALIZACIONES.HOMOLOGACION_SERVICIOS A USING
 (SELECT
  ...
  'OS_GETORDERACTIVITIES' as SERVICIO_ORIGEN,
  'Permite consultar las actividades de una orden' as DESCRIPCION_ORIGEN,
  'ADM_PERSON' as ESQUEMA_DESTINO,
  'API_GETORDERACTIVITIES' as SERVICIO_DESTINO,
  'Permite consultar las actividades de una orden' as DESCRIPCION_DESTINO,
  NULL as OBSERVACION
  FROM DUAL) B
