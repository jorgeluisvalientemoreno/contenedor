...
MERGE INTO PERSONALIZACIONES.HOMOLOGACION_SERVICIOS A USING
 (SELECT
  ...
  'GE_BOPERSONAL.GETCURRENTCHANNEL' as SERVICIO_ORIGEN,
  'Obtener punto de atencion de la persona' as DESCRIPCION_ORIGEN,
  'ADM_PERSON' as ESQUEMA_DESTINO,
  'PKG_BOPERSONAL.FNUGETPUNTOATENCIONID' as SERVICIO_DESTINO,
