DECLARE
    ...
    csbObjeto        CONSTANT VARCHAR2(70) :=   upper('ldc_pksatabmirror');
    ...
    BEGIN
        ...
        dbms_output.put_line('INFO: Ok Sentencia[' || isbSent || ']');
...
begin
    ...
    IF tbDBA_Objects.COUNT > 0 THEN
        ...
        END LOOP;
    ELSE
        dbms_output.put_line('INFO: No existe [' || csbEsquema || '.' || csbObjeto || ']');    
    END IF;
