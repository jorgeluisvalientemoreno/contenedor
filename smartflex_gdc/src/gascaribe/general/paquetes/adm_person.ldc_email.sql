CREATE OR REPLACE PACKAGE adm_person.LDC_Email IS
    /***************************************************************
  ...
  smtp_host   VARCHAR2(256) := DAGE_PARAMETER.FSBGETVALUE('HOST_MAIL',NULL);--'192.168.10.110';
  --smtp_port   PLS_INTEGER := 25;
  smtp_port   PLS_INTEGER := TO_NUMBER(DAGE_PARAMETER.FSBGETVALUE('HOST_MAIL_PORT',NULL));-- 26;
...
END;
/
CREATE OR REPLACE PACKAGE BODY adm_person.LDC_Email IS
...
END;
/
PROMPT Otorgando permisos de ejecucion a LDC_EMAIL
BEGIN
    pkg_utilidades.praplicarpermisos('LDC_EMAIL', 'ADM_PERSON');
END;
/

PROMPT Otorgando permisos de ejecucion sobre LDC_EMAIL para reportes
GRANT EXECUTE ON adm_person.LDC_EMAIL TO rexereportes;
/
