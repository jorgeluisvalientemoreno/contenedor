CREATE OR REPLACE package adm_person.expresar_en_letras is
    /***************************************************************
    Propiedad intelectual de Sincecomp Ltda.
    
    Unidad	     : expresar_en_letras
    Descripcion	 : 
...
/
CREATE OR REPLACE package body adm_person.expresar_en_letras is
...
/
PROMPT Otorgando permisos de ejecucion a EXPRESAR_EN_LETRAS
BEGIN
    pkg_utilidades.praplicarpermisos('EXPRESAR_EN_LETRAS', 'ADM_PERSON');
END;
/
PROMPT Otorgando permisos de ejecucion sobre EXPRESAR_EN_LETRAS para reportes
GRANT EXECUTE ON adm_person.EXPRESAR_EN_LETRAS TO rexereportes;
/
