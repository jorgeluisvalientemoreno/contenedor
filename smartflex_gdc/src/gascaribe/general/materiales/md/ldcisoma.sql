...
'C'
,
to_date('30-04-2025 11:22:56','DD-MM-YYYY HH24:MI:SS'),
null);
...
'N'
,
'SELECT  ID_CONTRATISTA "CÓDIGO" , NOMBRE_CONTRATISTA "NOMBRE" , DESCRIPCION "DESCRIPCIÓN"  FROM GE_CONTRATISTA WHERE   ID_CONTRATISTA IN (
...
'DESCRIPCIÓN'
,
'ID_CONTRATISTA Código|NOMBRE_CONTRATISTA Nombre|DESCRIPCION Descripción|'
,
'FROM GE_CONTRATISTA|'
,
...
'N'
,
'SELECT  OPERATING_UNIT_ID "IDENTIFICADOR DE LA UNIDAD DE TRABAJO" , NAME "NOMBRE"  FROM OR_OPERATING_UNIT ,BASE_ADMIN BA,CONTRATISTA CT
WHERE
CT.CONTRATISTA = [TRSMCONT]
...
AND BASE_ADMINISTRATIVA = ADMIN_BASE_ID
AND CT.EMPRESA = BA.EMPRESA
 '
,
'N'
,
...
'N'
,
'SELECT  OFVECODI "CODIGO DE LA OFICINA" , OFVEDESC "DESCRIPCION DE LA OFICINA"  FROM LDCI_OFICVENT ,CONTRATISTA CT
WHERE 
CT.CONTRATISTA = [TRSMCONT]
AND LDCI_OFICVENT.EMPRESA = CT.EMPRESA
 '
,
'N'
,
...
,
'OFVECODI Codigo de la Oficina|OFVEDESC Descripcion de la Oficina|'
,
'FROM LDCI_OFICVENT|'
,
',CONTRATISTA CT
...
'N'
,
'SELECT  TRSMCODI "CODIGO NRO. FRONT" , TRSMSOL "DESCRIPCION"  FROM LDCI_TRANSOMA WHERE TRSMESTA = 3 '
,
'N'
,
'CODIGO NRO. FRONT'
...
'DESCRIPCION'
,
'TRSMCODI CODIGO NRO. FRONT|TRSMSOL DESCRIPCION|'
,
'FROM LDCI_TRANSOMA|'
,
'WHERE TRSMESTA = 3|'
...
'N'
,
'SELECT  MDMACODI "CODIGO MOTIVO DEVOLUCION DEL MATERIAL" , MDMADESC "DESCRIPCION MOTIVO DE DEVOLUCION DEL MATERIAL"  FROM LDCI_MOTIDEMA '
,
'N'
,
'CODIGO MOTIVO DEVOLUCION DEL MATERIAL'
,
'DESCRIPCION MOTIVO DE DEVOLUCION DEL MATERIAL'
,
'MDMACODI Codigo Motivo devolucion del material|MDMADESC Descripción motivo de devolución del material|'
,
'FROM LDCI_MOTIDEMA|'
,
null,
...
'N'
,
'SELECT  MOPECODI "CODIGO MOTIVO" , MOPEDESC "DESCRIPCION"  FROM LDCI_MOTIPEDI ,CONTRATISTA CT
WHERE 
CT.CONTRATISTA = [TRSMCONT]
AND LDCI_MOTIPEDI.EMPRESA = CT.EMPRESA '
,
'N'
,
'CODIGO MOTIVO'
...
'N'
,
'SELECT  ITEMS_ID "CÓDIGO" , DESCRIPTION "DESCRIPCIÓN" , CODE "CÓDIGO EXTERNO"  FROM GE_ITEMS WHERE ITEM_CLASSIF_ID IN (8,3,21)  '
,
'N'
,
'CÓDIGO'
...
'DESCRIPCIÓN'
,
'ITEMS_ID Código|DESCRIPTION Descripción|CODE Código Externo|'
,
'FROM GE_ITEMS|'
,
