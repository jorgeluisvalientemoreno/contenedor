CREATE OR REPLACE PROCEDURE      LDC_CIER_PROD_H2_TMP IS
/**************************************************************************
  Fecha       : 2015-09-25
...
ldc_proretornafechavalcierr(nuccano,nuccmes,nuhora,pfecin,pfecfin,dtfecheject,horaej,sbesta,nunsali);
    ...
    ldc_proactualizaestaprog(nusession,nvl(sbmensa,'Ok'),'LDC_CIER_PROD_H2','Termino '||nuerror);
	-- Termina proceso ldc_progencierre
	 ...
	 ldc_actconcceroultplafi_tmp('LDC_OSF_SESUCIER_TMP2',sbmensa,nuerror);
	...
	ldc_procactudatsesu('LDC_OSF_SESUCIER_TMP2',sbmensa,nuerror);
