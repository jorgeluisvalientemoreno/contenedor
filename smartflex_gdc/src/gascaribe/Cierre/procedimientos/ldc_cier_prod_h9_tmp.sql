CREATE OR REPLACE PROCEDURE      LDC_CIER_PROD_H9_TMP IS
/**************************************************************************
  Fecha       : 2015-09-25
...
ldc_proretornafechavalcierr(nuccano,nuccmes,nuhora,pfecin,pfecfin,dtfecheject,horaej,sbesta,nunsali);
	...
	ldc_proactualizaestaprog(nusession,nvl(sbmensa,'Ok'),'LDC_CIER_PROD_H9','Termino '||nuerror);
...
--	ldc_proactualizaestaprog(nusession,nvl(sbmensa,'Ok'),'LDC_LLENASESUCIER_H1','Termino '||nuerror);
	...
	ldc_actconcceroultplafi_tmp('LDC_OSF_SESUCIER_TMP9',sbmensa,nuerror);
	...
	ldc_procactudatsesu('LDC_OSF_SESUCIER_TMP9',sbmensa,nuerror);
