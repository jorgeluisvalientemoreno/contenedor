CREATE OR REPLACE PROCEDURE      LDC_CIER_PROD_H7_TMP IS
/**************************************************************************
  Fecha       : 2015-09-25
...
--	ldc_proactualizaestaprog(nusession,nvl(sbmensa,'Ok'),'LDC_LLENASESUCIER_H1','Termino '||nuerror);
	-- Termina proceso ldc_progencierre
	 ...
	 ldc_actconcceroultplafi_tmp('LDC_OSF_SESUCIER_TMP7',sbmensa,nuerror);
	...
	ldc_procactudatsesu('LDC_OSF_SESUCIER_TMP7',sbmensa,nuerror);
