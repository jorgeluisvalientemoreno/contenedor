DECLARE
    ...
    CURSOR cuDBA_SCHEDULER_JOBS IS
        SELECT job_name
         ...
         WHERE JOB_NAME LIKE 'JOB_TRUNCATEIC_CARTCOCO';
BEGIN
    ...
    END IF;
    sbNombreJob := 'JOB_TRUNCATEIC_CARTCOCO';
    ...
    BEGIN
        DBMS_SCHEDULER.Create_Job (
            ...
            Job_Action        => q'#BEGIN EXECUTE IMMEDIATE 'Truncate table OPEN.IC_CARTCOCO'; END;#',
            Start_Date        => systimestamp,
            End_Date          => NULL,
            Comments          => 'Trunca la tabla IC_CARTCOCO',
            Enabled           => TRUE,
            Auto_Drop         => FALSE);
    END;
