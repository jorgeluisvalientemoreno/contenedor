CREATE OR REPLACE PROCEDURE      LDC_CIER_PROD_H6_TMP IS
/**************************************************************************
  Fecha       : 2015-09-25
...
--	ldc_proactualizaestaprog(nusession,nvl(sbmensa,'Ok'),'LDC_LLENASESUCIER_H1','Termino '||nuerror);
	...
	ldc_actconcceroultplafi_tmp('LDC_OSF_SESUCIER_TMP6',sbmensa,nuerror);
	...
	ldc_procactudatsesu('LDC_OSF_SESUCIER_TMP6',sbmensa,nuerror);
