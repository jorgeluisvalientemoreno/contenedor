...
declare
    ...
    csbCaso         constant varchar2(20)   := 'OSF-1096';
    cnuPackage_id1  constant MO_WF_PACK_INTERFAC.package_id%TYPE := 196507316;
    cnuPackage_id2  constant MO_WF_PACK_INTERFAC.package_id%TYPE := 192760880;
