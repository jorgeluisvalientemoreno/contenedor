BEGIN
    ...
    MERGE INTO OPEN.PARAMETROS A USING
     (SELECT
      'TIPO_PRODUCTO_COBRO_SERVICIOS' as CODIGO,
      'Tipo de producto cobro de servicios' as DESCRIPCION,
      3 as VALOR_NUMERICO,
      ...
      'A' as ESTADO,
      'S' as OBLIGATORIO,
      TO_DATE('21/02/2025 15:08:19', 'DD/MM/YYYY HH24:MI:SS') as FECHA_CREACION,
      TO_DATE('21/02/2025 15:08:19', 'DD/MM/YYYY HH24:MI:SS') as FECHA_ACTUALIZACION,
      'OPEN' as USUARIO,
      'PMVM115' as TERMINAL
      FROM DUAL) B
