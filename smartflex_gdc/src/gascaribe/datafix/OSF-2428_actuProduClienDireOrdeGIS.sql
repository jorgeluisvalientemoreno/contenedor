...
DECLARE
	...
	SELECT oa.order_id, 
			case 
				when oa.order_id = 310642585 then  
					52356274 
				WHEN oa.order_id = 310642586 then
					50094765
			end ProdOk, 
			oa.package_id Soli,
	...
	mo_packages pk
	WHERE oa.ORDER_ID IN (310642585, 310642586)
    ...
    IS
		...
		isbOrderComme varchar2(4000) := 'Se actauliza el producto y el cliente por OSF-2428';
...
BEGIN
	...
	dbms_output.put_line('Inicia datafix OSF-2428');   
	...
	dbms_output.put_line('Finaliza datafix OSF-2428');   
