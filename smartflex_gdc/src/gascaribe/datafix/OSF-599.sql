...
declare
  cursor cuSolicitudes is
        ...
        WHERE p.package_id IN (189481012, 186811501, 184522956)
		AND p2.motive_status_id = 13
        ORDER BY  p2.package_id;

  sbComment VARCHAR2(4000) := 'Se cambia estado a anulado por OSF-599';
        ...
        IF nuError = 0 THEN
          ...
          IF nuError = 0 THEN
            ...
            ELSE
              ...
              END IF;
			  IF (rgErrorFlujo.FORma = 'MOPWP') THEN
				UPDATE  MO_WF_PACK_INTERFAC
				SET 	STATUS_ACTIVITY_ID = 2
