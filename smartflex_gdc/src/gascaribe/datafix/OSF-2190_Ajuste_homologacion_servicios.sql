...
Inserta y actualiza homologación de servicios
...
BEGIN
    ...
    rcvalida :=null;
    sbservicio := 'DAGE_GEOGRA_LOCATION.FNUGETGEO_LOCA_FATHER_ID';
    ...
    if rcvalida.servicio_origen is null then
        begin
            ...
            values('OPEN',sbservicio,'Consultar la localidad padre de una localidad','ADM_PERSON','PKG_BCDIRECCIONES.FNUGETUBICAGEOPADRE','','');
            nuins := nuins +1;
        exception 
            when others then
                rollback;
