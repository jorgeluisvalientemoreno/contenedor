...
prompt "------------------------------------------------------"
/***********************************************************
ELABORADO POR:  Luis Felipe Valencia Hurtado
...
Descripción
    ...
    --Modificaciones    
    14/11/2024 - felipe.valencia
    Creación
    
***********************************************************/
DECLARE
    csbCaso             constant varchar2(20)   := 'OSF3598';
    ...
    where cargnuse in (17093528,1040597)
    and cargcuco = -1 
    and cargpefa in (108029,74144);
