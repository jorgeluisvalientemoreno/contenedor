...
begin
  Declare
    ...
    */
    ...
    from open.cargos
    where (
          (cargcuco = 3069551851 and cargcodo = 898495444) 
          )
    and cargsign='PA';

  Begin
      -- Generamos saldo a favor del cupon 232964998
      ...
      commit;
      dbms_output.put_line('Termino del saldo a favor del cupon 898495444 Ok');
      -- End proceso del saldo a favor cupon
