BEGIN
    ...
    MERGE INTO OPEN.PARAMETROS A USING
     (SELECT
      'MULTI_TIPOS_PRODUCTOS' as CODIGO,
      'Tipos de productos para multiempresa' as DESCRIPCION,
      NULL as VALOR_NUMERICO,
      '6121,7014,7055,7057' as VALOR_CADENA,
      NULL as VALOR_FECHA,
      5 as PROCESO,
      'A' as ESTADO,
      'S' as OBLIGATORIO,
      TO_DATE('11/03/2025 14:11:00', 'DD/MM/YYYY HH24:MI:SS') as FECHA_CREACION,
      TO_DATE('11/03/2025 14:11:00', 'DD/MM/YYYY HH24:MI:SS') as FECHA_ACTUALIZACION,
      'OPEN' as USUARIO,
      'PMVM115' as TERMINAL
      FROM DUAL) B
