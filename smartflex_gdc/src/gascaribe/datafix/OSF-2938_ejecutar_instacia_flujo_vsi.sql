...
begin
  ...
  BEGIN
    ...
    ---1
    BEGIN
      dbms_output.put_line('Ejecucion de instancia -1719306261 del flujo de VENTA DE SERVICIOS DE INGENIERIA 215307341');
      errors.Initialize;
      ut_trace.Init;
      ...
      WF_BOAnswer_Receptor.AnswerReceptor(-1719306261, -- Código de la instancia del flujo
