...
begin
  ...
  BEGIN
    ...
    BEGIN
      ...
      WF_BOAnswer_Receptor.AnswerReceptor(-1754566474, -- Código de la instancia del flujo
                                          MO_BOCausal.fnuGetSuccess); --se pasa el codigo del flujo
      
      WF_BOAnswer_Receptor.AnswerReceptor(-1704334074, -- Código de la instancia del flujo
                                          MO_BOCausal.fnuGetSuccess); --se pasa el codigo del flujo
      
    
      WF_BOAnswer_Receptor.AnswerReceptor(-1720861574, -- Código de la instancia del flujo
                                          MO_BOCausal.fnuGetSuccess); --se pasa el codigo del flujo
