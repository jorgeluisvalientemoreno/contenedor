...
Descripción: Agrega producto a la tabla sesuasoc y actualiza grupo de impresión a cuenta de cobro servicio financiero
...
***********************************************************/
DECLARE
    csbCaso             constant varchar2(20)   := 'OSF2505';
    ...
    cnuProducto         constant number         := 52791737;
    cnuContrato         constant number         := 17116566;
