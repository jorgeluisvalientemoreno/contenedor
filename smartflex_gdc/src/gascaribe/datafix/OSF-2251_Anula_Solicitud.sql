...
declare
    cursor cuSolicitudes is
        ...
        WHERE p.package_id IN (205799990)
        AND p2.motive_status_id = 13
        ORDER BY  p2.package_id;
        
	 
    sbComment 		VARCHAR2(4000):='Se cambia estado a anulado por SOSF-2375';
...
BEGIN
	...
	dbms_output.put_line('Inicia OSF-2251 - anula solicitudes');
	...
	dbms_output.put_line('Finaliza OSF-2251 - anula solicitudes');
END;
/
