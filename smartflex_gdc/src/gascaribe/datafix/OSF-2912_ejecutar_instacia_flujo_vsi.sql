...
begin
  ...
  BEGIN
    ...
    ---1
    BEGIN
      dbms_output.put_line('Ejecucion de instancia -1747192468 del flujo de VENTA DE SERVICIOS DE INGENIERIA 211907012');
      errors.Initialize;
      ut_trace.Init;
      ...
      WF_BOAnswer_Receptor.AnswerReceptor(-1747192468, -- Código de la instancia del flujo
