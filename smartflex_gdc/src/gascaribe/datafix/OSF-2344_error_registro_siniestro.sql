...
DECLARE
  ...
  SBCOMMENT                VARCHAR2(4000) := 'SE ANULA POR CASO OSF-2344';
  ...
  select m.package_id
   ...
   where m.package_id in (203711729, 201905003, 209401319);
  -- Mo_Motive
...
BEGIN
    ...
    FOR sol in cuSolicitudes LOOP
        ...
        IF sol.package_id IS NOT NULL  AND DAMO_PACKAGES.FNUGETPACKAGE_ID(sol.package_id,NULL) = sol.package_id THEN
            DBMS_OUTPUT.PUT_LINE(SBCOMMENT||'. Inicia Proceso Solicitud -> '||sol.package_id); 
            ...
            -- anula el plan de wf
            DBMS_OUTPUT.PUT_LINE('Anulando Plan WF: '||nuPlanId||' de la solicitud: '||sol.package_id);
            BEGIN
            ...
            DBMS_OUTPUT.PUT_LINE('Cambiando estado en mo_packages: '||sol.package_id);
            ...
            DBMS_OUTPUT.PUT_LINE('Insertando registro en MO_PACKAGE_CHNG_LOG: '||sol.package_id);
            ...
            DBMS_OUTPUT.PUT_LINE('Cambiando estado en MO_MOTIVE: '||sol.package_id);            
            ...
            IF CuMomotive%FOUND THEN
                ...
                IF CuCargtram%NOTFOUND THEN
                    DBMS_OUTPUT.PUT_LINE('Actualizando CUENCOBR Producto: '||nuprodu);   
                    UPDATE CUENCOBR CO
                      SET CO.CUCOVARE = 0
            ...
            DBMS_OUTPUT.PUT_LINE('Termina Proceso Solicitud -> '||sol.package_id);
        END IF;
