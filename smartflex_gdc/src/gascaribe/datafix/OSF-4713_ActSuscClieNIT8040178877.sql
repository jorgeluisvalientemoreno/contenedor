declare
    ...
    from suscripc sc
    where sc.suscclie	= 1468688 
    and susccodi 		IN (66657659);
...
begin
	...
	dbms_output.put_line('Inicio Datafix OSF-4713');
	...
	dbms_output.put_line('Termina Datafix OSF-4713');
