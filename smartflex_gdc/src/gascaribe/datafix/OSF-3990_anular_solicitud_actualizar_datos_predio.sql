...
execute dbms_application_info.set_action('APLICANDO DATAFIX OSF-3990');
...
DECLARE
  cursor cuSolicitudes is
    SELECT p2.package_id,
     ...
     WHERE p.package_id IN (222277987)
       AND p2.motive_status_id = 13
     ORDER BY p2.package_id;

  sbComment       VARCHAR2(4000) := 'Se cambia a estado anulado por OSF-3990';
