...
Descripción
    ...
    --Modificaciones    
    18/11/2024 - jcatuchemvm
    Creación
    
***********************************************************/
DECLARE
    csbCaso             constant varchar2(20)   := 'OSF3538';
    csbTitulo           constant varchar2(2000) := csbCaso||': Anulación soliicutudes de financiación obsoletas';
    csbFormato          constant varchar2(25)   := 'DD/MM/YYYY HH24:MI:SS';
    cdtFecha            constant date           := sysdate;
    
    cursor cudata is
    select * from mo_packages
    where package_id in (219328559)
