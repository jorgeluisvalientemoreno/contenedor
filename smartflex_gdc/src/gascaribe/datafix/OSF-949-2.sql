DECLARE
  ...
  CURSOR c_escenario1 IS 
        ...
        and cargfecr BETWEEN to_date(to_char('01/05/2023' || ' 00:00:00') , 'dd-mm-yyyy hh24:mi:ss')
  ...
  CURSOR c_escenario2 IS 
        ...
        and ca.cargfecr BETWEEN to_date(to_char('01/05/2023' || ' 00:00:00') , 'dd-mm-yyyy hh24:mi:ss')
                       AND to_date(to_char('29/05/2023' || ' 23:59:59') , 'dd-mm-yyyy hh24:mi:ss')
        and ca.cargprog = 701
        and ca.cargsign = 'SA'
...
BEGIN
  DBMS_OUTPUT.PUT_LINE ('Inicia OSF-949 para Enero a Abril 2023 Diferencias SA Notas');
  ...
  FOR v_escenario1 IN c_escenario1
    LOOP
      ...
      select cargcodo INTO v_cargcodo from cargos where cargsign = 'CR' and  (cargvalo = (v_escenario1.cargvalo*2) or cargvalo = v_escenario1.cargvalo or cargfecr = v_escenario1.cargfecr ) and cargcuco = v_escenario1.cargcuco and cargprog = 20;
