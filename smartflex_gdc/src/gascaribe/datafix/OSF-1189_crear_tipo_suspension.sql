...
begin
  dbms_output.put_line('---- Inicio OSF-1189 ----');

  BEGIN

    MERGE INTO OPEN.GE_SUSPENSION_TYPE A USING
    (SELECT
      108 as SUSPENSION_TYPE_ID,
      'BI' as DIRECTIONALITY_ID,
      'SUSPENSIÓN POR SEGURIDAD CLM' as DESCRIPTION,
      1 as PRIORITY,
      'Y' as ANALIZE,
  ...
  dbms_output.put_line('---- Fin OSF-1189 ----');
EXCEPTION
  WHEN OTHERS THEN
    rollback;
    dbms_output.put_line('---- Error OSF-1189 ----');
