...
DECLARE
  ...
  cursor cuListadoOrden is
    select 83150008 orden from dual;
  ...
  SBCOMMENT     VARCHAR2(4000) := 'SE ANULA ORDEN PARA NO INCLUIR EN ACTA. CASO OSF-3219';
  ...
  for rfcuListadoOrden in cuListadoOrden loop
    ...
    for rfcuDataOrden in cuDataOrden(rfcuListadoOrden.Orden) loop
      BEGIN
        ...
        -- Anulamos la OT
        API_ANULLORDER(rfcuDataOrden.ORDEN,nuCommentType, SBCOMMENT, nuErrorCode,sbErrorMesse );
