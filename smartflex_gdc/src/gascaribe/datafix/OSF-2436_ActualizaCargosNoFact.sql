...
Actualiza cargos liquidados sin facturación por cambio de ciclo antes del cierre
    ...
    --Modificaciones    
    01/03/2024 - jcatuchemvm
    Creación
    
***********************************************************/
declare
    cnuPefa     number := 110680;
    cnuPecs     number := 110619;
    cnuPefaAnt  number := 110685;
    ...
    decode(cargnuse,52766560,3056947097,52765258,3056946966,-1) cuenta,
    c.*
    from cargos c
    where cargnuse in (52766560,52765258)
    ...
    cursor cucuenta is 
    select * from cuencobr where cucocodi in (3056947097,3056946966)
    ;
...
begin
    dbms_output.put_line('OSF-2436: Actualización de cargo sin facturar');
