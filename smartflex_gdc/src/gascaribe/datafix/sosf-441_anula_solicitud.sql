declare
    cursor cuSolicitudes is
        ...
        WHERE p.package_id IN (188648249,188648355,188648370,188648539,188648540,188648548,188648543,188648576,188648247,188648353,188648372,188648410,188648408,188648527,188648578,188649634,188649510,188649520,188649411,188649645,188649751)
        AND p2.user_id='INNOVACION'
		AND p2.motive_status_id = 13
        ORDER BY  p2.package_id;
        
	 
    sbComment 		VARCHAR2(4000):='Se cambia estado a anulado por SOSF-441';
