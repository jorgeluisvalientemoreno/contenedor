...
DECLARE
    ...
    --cursor para Anular ordenes de contratos definidos del CASO OSF-4090 Anulacion ordenes generadas a contratistas viejos.
    cursor cuproductopenins is
      select o.order_id ORDEN 
        from open.or_order o
       where o.order_id in (354912790) ;
    ...
    SBCOMMENT       VARCHAR2(4000) := 'SE ANULA ORDEN SEGUN CASO OSF-4090';
