declare
    cursor cuSolicitudes is
        ...
        WHERE p.package_id IN (206381128, 20638229, 206380572, 206379261, 206624649)
        AND p2.motive_status_id = 13
        ORDER BY  p2.package_id;
        
	 
    sbComment 		VARCHAR2(4000):='Se cambia estado a anulado por SOSF-2110';
...
BEGIN
	...
	dbms_output.put_line('Inicia OSF-2009');
	...
	dbms_output.put_line('Finaliza OSF-2009');
END;
/