...
DECLARE
  ...
  cursor cuListadoOrden is
    select 337994899 orden from dual;
  ...
  SBCOMMENT     VARCHAR2(4000) := 'SE ANULA ORDEN DEL CASO OSF-3748';
...
BEGIN
  ...
  for rfcuListadoOrden in cuListadoOrden loop
    ...
    end loop; --Fin Recorrer DATA de orden
  end loop; --Fin Recorrer Lsitado de ordenes
end;
