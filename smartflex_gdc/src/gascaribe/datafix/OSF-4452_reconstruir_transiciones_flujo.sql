...
DECLARE
  ...
  nuSolicitud     wf_data_external.package_id%TYPE := 25675085;
...
BEGIN
  ...
  dbms_output.put_line('Recuperar Instancia 207269369 detenida y continuar con el flujo');
  WF_BOEIFINSTANCE.RecoverInstance(207269369);
