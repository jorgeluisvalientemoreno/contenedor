...
execute dbms_application_info.set_action('APLICANDO DATAFIX OSF-1618');
...
Declare
  ...
  from open.cargos
  where (
        (cargcuco = 3045338646 and cargcodo = 223635695)
        )
  and cargsign='PA';

BEGIN

	dbms_output.put_line('Inicia aplicación del caso OSF-1618');
