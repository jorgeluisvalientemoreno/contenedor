...
DECLARE
	...
	SELECT oa.order_id, 
			case 
				when oa.order_id = 362129825 then  52376640  
			end ProdOk, 
			oa.package_id Soli,
			pk.package_type_id TiSo
	from or_order_ACTIVITY oa,
	mo_packages pk
	WHERE oa.ORDER_ID IN (362129825)
    ...
    IS
		...
		isbOrderComme varchar2(4000) := 'Se actualiza el producto y el cliente por OSF-4596';
...
BEGIN
	...
	dbms_output.put_line('Inicia datafix OSF-4596');   
	...
	dbms_output.put_line('Finaliza datafix OSF-4596');   
