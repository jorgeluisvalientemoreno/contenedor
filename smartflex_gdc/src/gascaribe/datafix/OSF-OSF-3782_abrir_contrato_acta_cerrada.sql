...
begin
  DECLARE
      ...
      nuActa     NUMBER := 234311;
      sbComm     VARCHAR2(200) :='CASO OSF-3724';
  ...
  BEGIN
      ...
      If sbfactura is NULL then
        ...
        IF nuError = 0 THEN
            COMMIT;
            DBMS_OUTPUT.PUT_LINE('ACTA '||nuActa||' ABIERTA OK ');
        ELSE
            ROLLBACK;
            DBMS_OUTPUT.PUT_LINE('ERROR ACTA '||nuActa||' AL INTENTAR ABRIR Error: '||sbError);
        END IF;
