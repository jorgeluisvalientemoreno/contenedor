...
execute dbms_application_info.set_action('APLICANDO DATAFIX OSF-3351');
...
DECLARE
  cursor cuSolicitudes is
        ...
        WHERE p.package_id IN (218819058)
		AND p2.motive_status_id = 13
        ORDER BY  p2.package_id;

  sbComment VARCHAR2(4000) := 'Se cambia estado a anulado por OSF-3351';
