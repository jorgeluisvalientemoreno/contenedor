...
Descripción
    ...
    --Modificaciones    
    28/10/2024 - jcatuchemvm
    Creación
    
***********************************************************/
DECLARE
    csbCaso             constant varchar2(20)   := 'OSF3387';
    csbTitulo           constant varchar2(2000) := csbCaso||': Programa Job para ejecución repores automáticos TT';
...
BEGIN
    ...
    sbcabecera := 'Observación|Error';
    dbms_output.put_line(csbTitulo);
    dbms_output.put_line('================================================');
    dbms_output.put_line(sbcabecera);
    
    PKG_BOREPORTES_TARIFA_TRANS.prProgramaJob(nuerror,sberror);
    ...
    s_out := 'ProgramaciónJob';
    s_out := s_out||'|'||sberror;
    dbms_output.put_line(s_out);
    
    dbms_output.put_line('================================================');
    dbms_output.put_line('Fin gestión caso '||csbCaso);
    dbms_output.put_line('Cantidad de jobs programados: '||nuok);
