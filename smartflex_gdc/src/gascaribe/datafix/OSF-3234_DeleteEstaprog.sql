...
***********************************************************/
DECLARE
    csbCaso             constant varchar2(20)   := 'OSF3234';
    csbTitulo           constant varchar2(2000) := csbCaso||': Borrado Estaprog';
...
BEGIN
    ...
    begin
        ...
        delete estaprog where esprpefa in (113631,113123) and esprprog like 'FGCC%';
        
        nuRowcount := sql%rowcount;
                
        if nuRowcount = 0 then
            sbComentario := 'Error 1.1|Borrado de registros diferentes a los esperados ['||nuRowcount||']'||'|NA';
