...
DECLARE
    ...
    --cursor para Anular ordenes de contratos definidos del CASO OSF-1044 Anulacion ordenes de comision vendedores.
    cursor cuproductopenins is
      select o.order_id ORDEN 
        from open.or_order o
       where o.order_id in (282180193,
282180096,
282180302,
282179974,
282180348,
...
282180335
    ...
    SBCOMMENT       VARCHAR2(4000) := 'SE ANULA ORDEN SEGUN CASO OSF-1044';
