...
execute dbms_application_info.set_action('APLICANDO DATAFIX OSF-2733');
select to_char(sysdate,'yyyy-mm-dd hh:mi:ss p.m.') fecha_inicio from dual;

DECLARE
/*
    OSF-2733: Se solicita la anulación de las solicitudes, los motivos de solicitud, de ordenes de trabajo (Anuladas), 
              ...
              CONTRATO 67317123 PRODUCTO   52481222 CL 2 KR 7 - 80 APTO 1001A
              CONTRATO 67317133 PRODUCTO   52481231 CL 2 KR 7 - 80 APTO 1004ª

              que pertenecen a solicitudes de venta que El cliente RICASOLI S.A.S. solicita que no va a hacer la conexión 
              de estos servicios unificados hasta el momento porque aun no tiene claro si va a ser uno o van a ser dos. 
              El nos indica que cuando necesiten el servicio nos van a contactar para que les realicemos la venta. 
...
*/
    -- Informacion general
    sbComment       CONSTANT VARCHAR2(200) := 'SE ANULA ORDEN CON EL CASO OSF-2733';
...
BEGIN
    ...
    tbSusc(67317123) := 179342664;
    tbSusc(67317133) := 179342664;
