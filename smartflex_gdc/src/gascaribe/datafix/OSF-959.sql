...
begin
  ...
  BEGIN
    ...
    BEGIN
	  ...
	  update WF_INSTANCE_ATTRIB ooa 
	  set value = 2
	  where ooa.instance_attrib_id = -2055356585
	  and instance_id = -1893666244
	  and attribute_id = 400;
    
	  commit;
	  
	  WF_BOAnswer_Receptor.AnswerReceptor(-1893666244, -- Código de la instancia del flujo
                                          MO_BOCausal.fnuGetFail); --se pasa el codigo del flujo
