declare
    ...
    from suscripc sc
    where sc.suscclie 	= 1617853
    and susccodi 		= 1002950;
    
    CURSOR cuClientes
    IS
    select sr.subscriber_id, sr.RowId rId
    from ge_subscriber sr
    where sr.subscriber_id in (1617853);
...
begin
	...
	dbms_output.put_line('Inicio Datafix OSF-3949');
	...
	dbms_output.put_line('Termina Datafix OSF-3949');
