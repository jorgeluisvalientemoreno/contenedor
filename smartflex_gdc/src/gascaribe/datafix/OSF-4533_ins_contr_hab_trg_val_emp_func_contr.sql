...
begin
    ...
    EXECUTE IMMEDIATE 'ALTER TRIGGER multiempresa.trg_val_emp_func_contr ENABLE';
    DBMS_OUTPUT.PUT_LINE('INFO:[TRIGGER multiempresa.trg_val_emp_func_contr HABILITADO' );
