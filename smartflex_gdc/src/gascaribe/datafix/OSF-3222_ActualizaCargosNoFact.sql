...
***********************************************************/
declare
    cnuPefa     number := 113077;
    cnuPecs     number := 113032;
    cnuPefaAnt  number := 113087;
    ...
    decode(cargnuse,52385247,3067614954,-1) cuenta,
    c.*
    from cargos c
    where cargnuse in (52385247)
    and cargpefa = 113087 --cnuPefa
    ...
    cursor cucuenta is 
    select * from cuencobr where cucocodi in (3067614954)
    ;
...
begin
    ...
    begin
        ...
        for rc in cudata loop
            update cargos
            set cargcuco = rc.cuenta,cargpeco = rc.pecscons,cargpefa = cnuPefa
