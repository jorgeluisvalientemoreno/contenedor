declare
    ...
    from suscripc sc
    where sc.suscclie 	= 2534490
    and susccodi 		= 67371916;
...
begin
	...
	dbms_output.put_line('Inicio Datafix OSF-4114');
	...
	dbms_output.put_line('Termina Datafix OSF-4114');
