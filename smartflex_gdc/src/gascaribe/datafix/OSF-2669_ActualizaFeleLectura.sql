...
***********************************************************/
DECLARE
    csbCaso             constant varchar2(20)   := 'OSF2669';
    ...
    cursor cudata is
    select sesunuse,l.leemsesu,l.leempefa,l.leemfele,to_date('29042024 1701','ddmmyyyy hh24mi') leemfele_act,l.rowid row_id from servsusc,lectelme l
    where sesunuse in 
    (
        50088990,
        19000942,
