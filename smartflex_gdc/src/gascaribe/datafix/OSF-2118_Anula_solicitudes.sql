...
declare
    ...
    sbComment 		VARCHAR2(4000):='Se cambia estado a anulado por SOSF-2150';
...
BEGIN
	...
	dbms_output.put_line('Inicia OSF-2118 - anula solicitudes');
	...
	dbms_output.put_line('Finaliza OSF-2118 - anula solicitudes');
END;
/
