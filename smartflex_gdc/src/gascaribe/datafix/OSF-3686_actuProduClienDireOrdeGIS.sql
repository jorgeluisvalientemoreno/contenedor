...
DECLARE
	...
	SELECT oa.order_id, 
			case 
				when oa.order_id = 344489680 then  
					52894658 
				WHEN oa.order_id = 344489338 then
					52894658
			end ProdOk, 
			oa.package_id Soli,
	...
	mo_packages pk
	WHERE oa.ORDER_ID IN (344489680, 344489338)
...
BEGIN
	...
	dbms_output.put_line('Inicia datafix OSF-3686');   
	...
	dbms_output.put_line('Finaliza datafix OSF-3686');   
