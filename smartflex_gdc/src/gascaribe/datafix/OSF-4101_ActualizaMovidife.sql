...
Descripción
    ...
    --Modificaciones    
    27/03/2025 - jcatuchemvm
    Creación
    
***********************************************************/
DECLARE
    csbCaso             constant varchar2(20)   := 'OSF4101';
    csbTitulo           constant varchar2(2000) := csbCaso||': Actualiza movidife';
    csbFormato          constant varchar2(25)   := 'DD/MM/YYYY HH24:MI:SS';
    cdtFecha            constant date           := sysdate;
    cnuMovidife         constant number         := 95970128;
...
BEGIN
    ...
    begin 
        ...
        update movidife
        set modivacu = 0
        where modidife = cnuMovidife
        and modiusua = 'INNOVACION'
        and modiprog = 'FINAN'
        and modivacu = 10742;
        ...
        if nuRowcount = 1 then 
            ...
            s_out := s_out||'|No actualizado ['||nuRowcount||']';
        end if;
    ...
    exception
        when others then
            ...
            sbcomentario := 'Error en actualización de movidife. Error '||sberror;
    ...
    dbms_output.put_line('Cantidad de movimientos de diferidos actualizadas: '||nuok);
