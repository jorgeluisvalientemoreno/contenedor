...
BEGIN
  DELETE OPEN.ldc_act_ouib b  where b.operating_unit_id in (3557) and exists(select null from open.or_ope_uni_item_bala a where a.items_id=b.items_id and a.operating_unit_id=b.operating_unit_id and a.balance>0);
  DELETE OPEN.ldc_inv_ouib b  where b.operating_unit_id in (3557) and exists(select null from open.or_ope_uni_item_bala a where a.items_id=b.items_id and a.operating_unit_id=b.operating_unit_id and a.balance>0);
