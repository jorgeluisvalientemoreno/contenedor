...
***********************************************************/
DECLARE
    csbCaso             constant varchar2(20)   := 'OSF4153';
    csbTitulo           constant varchar2(2000) := csbCaso||': Anulación soliicutudes de devolución de depósito';
    csbFormato          constant varchar2(25)   := 'DD/MM/YYYY HH24:MI:SS';
    cdtFecha            constant date           := sysdate;
    
    cursor cudata is
    select * from mo_packages
    where package_id in (217734665)
