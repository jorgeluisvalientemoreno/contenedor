declare
    ...
    from suscripc sc
    where sc.suscclie	= 1678989 
    and susccodi 		IN (67136754);
...
begin
	...
	dbms_output.put_line('Inicio Datafix OSF-4536');
	...
	dbms_output.put_line('Termina Datafix OSF-4536');
