  ...
  Declare
    ...
    */
    cursor cuSolicitudes is
          ...
          WHERE p.package_id IN (143381220,143294090,143293771,143255215,143255103,143046139,142707532,140121755,139886223,137383988,137390026,133818377,127080876,124636081,123871532,122953400,
            121604770,120393902,120050212,116158695,115677629,113902573,113900678,111447428,108510839,107939918,107722437,103757937,103473165,102464816,101898007,101342461,101096145,97224625,
            96990098,96338782,95533922,95534107,95544393,95422261,94061295,93528142,91103992,89332054,86639516,85866560,83697217,80081874,79969581,79516433,77787337,77792890,76172634,74859773,
            73203934,73203871,73203772,72907344,72907279,72907222,72907176,72907115,72907023,72200555,72136395,71988159,71822442,71607915,71314263,71225101,71061401,70509967,70191418,70083992,
            69341506,68134773,67581123,67151802,66811190,66686079,66251446,66090483,66090470,65826792,64156700,63982780,63681880,63605708,63162557,62591924,62061701,59751792,59124888,58913871,
            58913754,58867331,58828554,58726235,58692183,57581916,57403368,57009435,56936542,55002493,49801805,48788042,48783532,46419493,45369442,40034356,39060004,35389324,33044841,31151930,
            30035689,29605630,29228690,29228800,27173309,23068095,23068257,23068369,23068422,16975463,16451865)
    ...
    sbComment       VARCHAR2(4000) := 'Se cambia estado a anulado por OSF-2227';
    sbMo_comment    mo_comment.comment_%type := 'En virtud de lo descrito en los artículos del código civil (ARTICULO 2518. <PRESCRIPCION ADQUISITIVA>. Se gana por prescripción el dominio de los bienes corporales, raíces o muebles, que están en el comercio humano, y se han poseído con las condiciones legales. Se ganan de la misma manera los otros derechos reales que no están especialmente exceptuados. ARTICULO 2529. <TIEMPO PARA LA PRESCRIPCION ORDINARIA>. Inciso modificado por el artículo 4 de la Ley 791 de 2002. El nuevo texto es el siguiente:> El tiempo necesario a la prescripción ordinaria es de tres (3) años para los muebles y de cinco (5) años para bienes raíces.), en el ACTA DEPÓSITOS PENDIENTES POR CRUZAR - DICIEMBRE 4 DE 2021 suscrita por GASCARIBE, se contabilizó a otros ingresos aquellas cuotas iniciales no devueltas y pagadas entre el 2015 y 2020. Que, para el contrato en referencia, el valor de la cuota inicial fue utilizada como “Aprovechamiento”';
