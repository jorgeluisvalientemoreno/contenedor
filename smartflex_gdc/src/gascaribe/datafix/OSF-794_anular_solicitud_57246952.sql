...
declare
  cursor cuSolicitudes is
        ...
        WHERE p.package_id IN (57246952)
		AND p2.motive_status_id = 13
        ORDER BY  p2.package_id;

  sbComment VARCHAR2(4000) := 'Se cambia estado a anulado por OSF-794';
        ...
        BEGIN
          ...
          BEGIN                                                               
            ...
            EXCEPTION WHEN OTHERS THEN
                O_MOTIVE_STATUS_IDVar   := -1;
                dbms_output.put_line('INFO: No se encontró motivo para la solicitud|' || reg.package_id );
          END;
