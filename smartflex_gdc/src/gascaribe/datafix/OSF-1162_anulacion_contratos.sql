...
begin
  ...
  FOR reg IN cuInfoCuenta LOOP
	...
	OS_ADDORDERCOMMENT(reg.order_id,
                       nuCommentType,
                       'Se anula por solicitud en el caso OSF-1162',
                       nuerror,
                       sberror);
  ...
  dbms_output.put_line('Termina OSF-1162');
