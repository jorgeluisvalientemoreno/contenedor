...
begin
  ...
  from open.cargos
  where (  
        (cargcuco IN (3063334846) and cargcodo in (889000645)) 
        OR
        (cargcuco IN (3063368287) and cargcodo in (889984657)) 
        OR 
        (cargcuco IN (3063459039) and cargcodo in (889084285))
        OR 
        (cargcuco IN (3063807560) and cargcodo in (889288475)) 
        OR 
        (cargcuco IN (3063823925) and cargcodo in (889863941,890073679)) 
        OR
        (cargcuco IN (3064063295) and cargcodo in (889370989))
        OR
        (cargcuco IN (3064298361) and cargcodo in (889756990))  
        OR
        (cargcuco IN (3064388907) and cargcodo in (889682661))  
        )
  and cargsign='PA';
