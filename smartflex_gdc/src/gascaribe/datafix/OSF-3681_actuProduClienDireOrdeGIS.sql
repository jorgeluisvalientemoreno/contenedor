...
DECLARE
	...
	SELECT oa.order_id, 
			case 
				when oa.order_id = 343452279 then  
					 52376640 
			end ProdOk, 
			oa.package_id Soli,
	...
	mo_packages pk
	WHERE oa.ORDER_ID IN (343452279)
    ...
    IS
		...
		isbOrderComme varchar2(4000) := 'Se actualiza el producto y el cliente por OSF-3691';
...
BEGIN
	...
	dbms_output.put_line('Inicia datafix OSF-3691');   
	...
	dbms_output.put_line('Finaliza datafix OSF-3691');   
