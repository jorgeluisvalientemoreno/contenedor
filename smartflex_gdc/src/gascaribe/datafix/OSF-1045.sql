...
begin
  ...
  LOOP
      BEGIN
          ...
          LDC_CANCEL_ORDER( inuOrderId      => reg.order_id,
                            inuCausalId     => dald_parameter.fnuGetNumeric_Value('CAUSAL_CANCELAR_OT_TERCEROS', NULL),
                            isbComment      => 'Orden anulada por el caso OSF1045',
                            inuCommentType  => cnuCommentType,
