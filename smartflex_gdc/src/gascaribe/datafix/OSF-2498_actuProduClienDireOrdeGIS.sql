...
DECLARE
	...
	SELECT oa.order_id, 
			case 
				when oa.order_id = 309487902 then  
					50616348 
				WHEN oa.order_id = 303983217 then
					50616348
			end ProdOk, 
			oa.package_id Soli,
	...
	mo_packages pk
	WHERE oa.ORDER_ID IN (309487902, 303983217)
    ...
    IS
		...
		isbOrderComme varchar2(4000) := 'Se actualiza el producto y el cliente por OSF-2498';
...
BEGIN
	...
	dbms_output.put_line('Inicia datafix OSF-2498');   
	...
	dbms_output.put_line('Finaliza datafix OSF-2498');   
