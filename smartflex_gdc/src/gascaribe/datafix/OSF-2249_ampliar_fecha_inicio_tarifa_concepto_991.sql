...
BEGIN
  ...
  BEGIN
    ...
    update open.ta_conftaco tc
       set tc.cotcfein = to_date('01/01/2021', 'DD/MM/YYYY')
     where tc.cotcconc = 991;
    dbms_output.put_line('Fecha inicial 01/12/2023 actualizada por la fecha 01/01/2021 Ok.');
  ...
  BEGIN
    ...
    update open.ta_vigetaco tv
       set tv.vitcfein = to_date('01/01/2021', 'DD/MM/YYYY')
  ...
  BEGIN
    ...
    update open.TA_VIGETACP tvt
       set tvt.vitpfein = to_date('01/01/2021', 'DD/MM/YYYY')
  ...
  BEGIN
    Dbms_Output.put_line('Inicio Activar concepto 991 en los servicio configurados');
  
    UPDATE OPEN.concsERV SET coseacti = 'S' WHERE COSECONC = 991;
  
    Dbms_Output.put_line('Fin actualizacion Activar concepto 991 en los servicio configurados Ok.');
  ...
  EXCEPTION
    WHEN OTHERS THEN
      rollback;
      Dbms_Output.put_line('Error Activar concepto 991 en los servicio configurados - Error: ' ||
                           sqlerrm);
  END;
