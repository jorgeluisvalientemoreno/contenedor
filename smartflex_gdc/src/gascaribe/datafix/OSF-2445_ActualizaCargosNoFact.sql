...
***********************************************************/
declare
    cnuPefa     number := 110486;
    cnuPecs     number := 110425;
    cnuPefaAnt  number := 110515;
    ...
    decode(cargnuse,52113786,3057092797,-1) cuenta,
    c.*
    from cargos c
    where cargnuse in (52113786)
    ...
    cursor cucuenta is 
    select * from cuencobr where cucocodi in (3057092797)
    ;
