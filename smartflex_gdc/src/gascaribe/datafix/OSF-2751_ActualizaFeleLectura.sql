...
Descripción
    ...
    --Modificaciones    
    24/05/2024 - jcatuchemvm
    Creación
    
***********************************************************/
DECLARE
    csbCaso             constant varchar2(20)   := 'OSF2751';
    ...
    cursor cudata is
    select leemsesu,leemelme,leempefa,leemfela,leemleto,leemfele,to_date('18042024','ddmmyyyy') leemfele_act,l.rowid row_id
    from lectelme l
    where leemsesu in 
    (
        6020801,
        ...
        for rc in cudata loop
            begin 
                ...
                if nuRowcount != 1 then
                    sbComentario := 'Error 1.2|'||nuProducto||'|Actualización de fecha de lecturas diferente a la esperada  ['||nuRowcount||']'||'|NA';
                    raise raise_continuar;
                else
