...
DECLARE
    ...
    BEGIN
        ...
        pFOTO( 'MO_PACK_ANNUL_DETAIL', 'PACK_ANNUL_DETAIL_ID,ANNUL_PACKAGE_ID,PACKAGE_ID,COMPONENT_ID', tbRowIds, 'ANTES', TRUE );

		DELETE
		FROM   MO_PACK_ANNUL_DETAIL
		WHERE  PACKAGE_ID = nuSolicitud;

        pFOTO( 'MO_PACK_ANNUL_DETAIL', 'PACK_ANNUL_DETAIL_ID,ANNUL_PACKAGE_ID,PACKAGE_ID,COMPONENT_ID', tbRowIds, 'DESPU', FALSE );
