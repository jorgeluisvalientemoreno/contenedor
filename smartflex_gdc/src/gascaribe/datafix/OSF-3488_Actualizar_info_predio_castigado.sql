...
BEGIN
  ...
  dbms_output.put_line('Se actuzalica ldc_info_predio a N');

  UPDATE ldc_info_predio
  SET predio_castigado = 'N'
  WHERE predio_castigado = 'S';

  COMMIT;

  dbms_output.put_line('Fin actuzalica ldc_info_predio a N');
