...
REM Script		 :		idx_ldc_log_proceso_vmp_02.sql
REM Autor 		 :		Lubin Pineda - MVM
REM Fecha 		 :		07-06-2023
REM Descripcion	 :		Se crea el índice IDX_LDC_LOG_PROCESO_VMP_02
REM Caso	     :		OSF-1085
DECLARE
    ...
    sbIndice            VARCHAR2(100) := 'IDX_LDC_LOG_PROCESO_VMP_02';
...
BEGIN
    ...
    IF rcALL_INDEXES.index_name IS NULL THEN
        ...
        sbSentencia := 'CREATE INDEX ' || sbUsuario || '.' || sbIndice || ' ON ' || sbTabla||
                        '(PROCESO, PROCESADO, UNIDAD_TRABAJO)';
