Prompt Creando el parametro ACTI_REST_PL_MAY_PRI_NEG_CAT_2
BEGIN
MERGE INTO OPEN.PARAMETROS A USING
 (SELECT
  'ACTI_REST_PL_MAY_PRI_NEG_CAT_2' as CODIGO,
  'ACTIVAR RESTRICCION PLAN MAYOR PRIORIDAD EN NEGOCIACION PARA USU CATEG DIFERENTE A 1' as DESCRIPCION,
