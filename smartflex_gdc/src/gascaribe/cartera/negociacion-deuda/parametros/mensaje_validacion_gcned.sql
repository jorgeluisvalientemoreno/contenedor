Prompt Creando el parametro MENSAJE_VALIDACION_GCNED
BEGIN
MERGE INTO OPEN.PARAMETROS A USING
 (SELECT
  'MENSAJE_VALIDACION_GCNED' as CODIGO,
  'Parámetro que almacena el mensaje de validacion de financiacion' as DESCRIPCION,
  NULL as VALOR_NUMERICO,
  'Según la segmentación comercial solo puede elegir el plan de financiación: "El que tenga la mayor prioridad de los que aplican al producto":' as VALOR_CADENA,
  NULL as VALOR_FECHA,
  5 as PROCESO,
  'A' as ESTADO,
  'S' as OBLIGATORIO,
