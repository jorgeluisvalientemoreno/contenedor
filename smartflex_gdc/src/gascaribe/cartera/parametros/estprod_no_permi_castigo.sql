Prompt Creando el parametro ESTPROD_NO_PERMI_CASTIGO
BEGIN
MERGE INTO OPEN.PARAMETROS A USING
 (SELECT
  'ESTPROD_NO_PERMI_CASTIGO' as CODIGO,
  'ALMACENARA LOS CODIGOS DE LOS ESTADOS DE PRODUCTO (SI SON VARIOS SE SEPARARAN POR ,) QUE NO SERAN CASTIGADOS' as DESCRIPCION,
