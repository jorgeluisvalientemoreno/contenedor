Prompt Creando el parametro TIPOPROD_VAL_ESTPROD_INCLU
BEGIN
MERGE INTO OPEN.PARAMETROS A USING
 (SELECT
  'TIPOPROD_VAL_ESTPROD_INCLU' as CODIGO,
  'Almacenara los tipos de producto que aplican para validacion de estado de producto INCLUMAS (Si son varios se separaran por ,) que no seran castigados' as DESCRIPCION,
  NULL as VALOR_NUMERICO,
  '7014' as VALOR_CADENA,
  NULL as VALOR_FECHA,
  5 as PROCESO,
  'A' as ESTADO,
  'S' as OBLIGATORIO,
