/*******************************************************************************
    ...
    Archivo        altLDC_CARTDIARIA.sql

    Descripción:   Se altera la tabla LDC_CARTDIARIA agregando el campo VALOR_CASTIGADO
...
BEGIN
    ...
    IF nuCant = 0 THEN
        ...
        sbCommand := 'COMMENT ON COLUMN OPEN.'||sbTabla||'.VALOR_CASTIGADO IS ''VALOR CASTIGADO''';        
        EXECUTE IMMEDIATE sbCommand;
