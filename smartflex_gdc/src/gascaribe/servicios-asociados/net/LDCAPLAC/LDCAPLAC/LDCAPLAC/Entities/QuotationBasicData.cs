...
namespace LDCAPLAC.Entities
{
    public class QuotationBasicData
    {
       ...
       /* private GridDetaMedi chargeByConnTaskType = new GridDetaMedi();

        public GridDetaMedi ChargeByConnTaskType
        {
        ...
        private List<GridDetaMedi> itemsList = new List<GridDetaMedi>();

        public List<GridDetaMedi> ItemsList
        {
