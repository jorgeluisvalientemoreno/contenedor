MERGE INTO PERSONALIZACIONES.PARAMETROS A USING
 (SELECT
  'FORMATO_INDUSTRIA_NO_REG' as CODIGO,
  'IDENTIFICADOR DEL FORMATO DE IMPRESION PARA DE INDUSTRIA NO REGULADA MF FACTURACION|MD DIGITAL|EM ESTADO DE CUENTA' as DESCRIPCION,
  NULL as VALOR_NUMERICO,
  '72|83|83' as VALOR_CADENA,
  NULL as VALOR_FECHA,
  5 as PROCESO,
