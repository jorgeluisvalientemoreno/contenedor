CREATE OR REPLACE TRIGGER ADM_PERSON.TRGBIURLD_MAR_EXP_BUDGET
BEFORE INSERT OR UPDATE
ON Ld_Mar_Exp_Budget
...
BEGIN
  ...
  LD_BOVar_Validate_Co_Un.rctbLd_Mar_Exp_Budget.Mar_Exp_Budget_id  := :new.Mar_Exp_Budget_id;
  LD_BOVar_Validate_Co_Un.rctbLd_Mar_Exp_Budget.Rel_Mark_Budget_Id := :new.Rel_Mark_Budget_Id;
