CREATE OR REPLACE TRIGGER ADM_PERSON.TRGAUALLOCATEQUOTEMANUAL
AFTER INSERT OR UPDATE ON ld_manual_quota
REFERENCING OLD AS old NEW AS new
FOR EACH ROW
/*
    Propiedad intelectual de PETI

    Trigger     : trgauAllocateQuoteManual
...
BEGIN
    ldc_prQuotaFnb.prGetProduct(:new.subscription_id,nuProductId,nuProducStatus,nuSesuesfn);

    rcQuotaFNB.subscription_id := :new.subscription_id;
