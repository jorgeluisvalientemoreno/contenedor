CREATE OR REPLACE TRIGGER ADM_PERSON.TRGAILD_VALIDITY_POLICY_TYPE
AFTER INSERT ON Ld_Validity_Policy_Type

/**************************************************************
Propiedad intelectual de Open International Systems. (c).

Trigger       : trgAiLd_Validity_Policy_Type

Descripcion   : Valida que la Vigencia por Tipo de Poliza a insertar no se
...
--{
    ...
    --{
    	...
    	-- Elimina el registro de la tabla Temporal ya validado
    	delete Ld_Vali_Poli_Type_Temp where current of cuTablaTempo;
    --}
    END LOOP;
...
EXCEPTION
    ...
    when OTHERS then
        ...
        raise ex.CONTROLLED_ERROR;
--}
END TRGAILD_VALIDITY_POLICY_TYPE;
/
