...
{
    class BLNUMBERTOLETTER
    {
        private String[] UNIDADES = { "", "un ", "dos ", "tres ", "cuatro ", "cinco ", "seis ", "siete ", "ocho ", "nueve " };
        private String[] DECENAS = {"diez ", "once ", "doce ", "trece ", "catorce ", "quince ", "dieciséis ",
        ...
        //decimales
        public String Convertirdecimal(String numero, bool mayusculas)
        {
            ...
            if (mc.Count > 0)
            {
                ...
                if (Convert.ToInt64(Num[1]) == 0)
                    parte_decimal = "centavos M/L";
                else
                    parte_decimal = "centavos M/L";
        ...
        if (mc.Count > 0) {
            ...
            //de da formato al numero decimal
            if (Convert.ToInt64(Num[1])==0)
                parte_decimal = "pesos M/L";
            else
                parte_decimal = "pesos con " + Convertirdecimal(Num[1],false);//Num[1] + "/100 Centavos";
            //se convierte el numero a literal
        ...
        { //000 000 000        
            ...
            String n = "";
            if (millon.Length > 1 || Convert.ToInt64(millon)>1) 
            {
