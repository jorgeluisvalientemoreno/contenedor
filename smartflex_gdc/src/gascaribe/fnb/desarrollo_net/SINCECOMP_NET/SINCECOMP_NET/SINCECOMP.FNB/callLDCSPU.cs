 ...
 *===========================================================================================================
 * Unidad        : callLDCSPU
 * Descripcion   : Llamado dinámicamente a la forma LDCSPU
...
namespace SINCECOMP.FNB
{
    ...
    public class callLDCSPU : IOpenExecutable
    {
        public void Execute(Dictionary<string, object> parameters)
        {
            ...
            if (ififap_.Aceptar)
            {
                ...
                SINCECOMP.FNB.DAL.DALLDCSPU _DALDCSPU = new SINCECOMP.FNB.DAL.DALLDCSPU();
                ...
                if (_blFIFAP.GetLock(SubscriptionId) && flValVenta)
                {
                    ...
                    SINCECOMP.FNB.Entities.DataFIFAP _dataFIFAP = _DALDCSPU.getSubscriptionDataLDCSPU(SubscriptionId);
                    ...
                    if (_dataFIFAP.isGranSuperficie() && isValidateGranSuperficie)
                    {
                        ...
                        {
                            //general.mensajeERROR("Contrato[" + SubscriptionId .ToString() + "]");
                            using (LDCSPU frm = new LDCSPU(SubscriptionId, _dataFIFAP))
                            {
                                ////Agordillo Cambio.6853 04-10-2015
