...
namespace SINCECOMP.FNB.DAL
{
    internal class DALFIFAP
    {
      ...
      **************************************************************************************************/
      ...
      //Inicio 200-2422
      //Servicio para retornar informacion de la campaña configuarada para FNB
      //PLANFINAN --Plan de financiacion 
      //PRIMACARDIFCAMPANA -- Prima que manejara CARDIF si la venta tiene campaña configurada
      //CUOTAMINIMA -- Cuota minima configirada para la campaña
      //MONTOMINIMO -- Monto minimo configirada para la campaña
      //SUBLINEAEXCLUIDACAMPANA -- Sublineas consifuradas para excluir de la venta
      public static DataTable DALFNULINEACMAPANA(Int64 InuARTICLE_ID, Int64 InuID_CONTRATISTA, Int64 InuSUSCCODI)
      {
          DataSet DSpromissory = new DataSet("CAMPANAFNB");
          using (DbCommand cmdCommand = OpenDataBase.db.GetStoredProcCommand("LDC_PKCAMPANAFNB.FNULINEACAMPANA"))
          {
              OpenDataBase.db.AddInParameter(cmdCommand, "InuARTICLE_ID", DbType.Int64, InuARTICLE_ID);
              OpenDataBase.db.AddInParameter(cmdCommand, "InuID_CONTRATISTA", DbType.Int64, InuID_CONTRATISTA);
              OpenDataBase.db.AddInParameter(cmdCommand, "InuSUSCCODI", DbType.Int64, InuSUSCCODI);
              OpenDataBase.db.AddReturnRefCursor(cmdCommand);
              OpenDataBase.db.LoadDataSet(cmdCommand, DSpromissory, "CAMPANAFNB");
          }
          return DSpromissory.Tables["CAMPANAFNB"];
      }
        //Fin 200-2422
