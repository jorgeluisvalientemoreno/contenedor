...
namespace SINCECOMP.CANCELLATION.BL
{
   class BLConsultas
   {
      ...
      public static String CanalesdeVenta = "select reception_type_id Codigo, description Descripcion " +
         ...
         //"WHERE Regexp_instr(dald_parameter.fsbGetValue_Chain('SALES_CHANNEL_FNB'), reception_type_id) > 0 " +
      ...
      /// </summary>
      public static String CivilState = "select civil_state_id id, description descripcion from ge_civil_state";
      ...
      /// </summary>
      public static String Contratista = "SELECT distinct g.id_contratista Codigo,g.nombre_contratista Descripcion " +
      ...
      /// </summary>
      public static String ListadePreciosControladasC = "select price_list_id Codigo, description Descripcion " +
          "from ld_price_list " +
          "where approved = 'Y' ";
      ...
      /// </summary>
      public static String Proveedor = "SELECT ID_CONTRATISTA Identificacion, NOMBRE_CONTRATISTA Nombre " +
          "FROM GE_CONTRATISTA " +
      ...
      /// </summary>
      public static String Sublineas = "Select DISTINCT a.Subline_id Codigo, a.Description Descripcion " +
      ...
      /// </summary>
      public static String UbicacionGeografica = "SELECT a.geograp_location_id Codigo, a.description descripcion " +
