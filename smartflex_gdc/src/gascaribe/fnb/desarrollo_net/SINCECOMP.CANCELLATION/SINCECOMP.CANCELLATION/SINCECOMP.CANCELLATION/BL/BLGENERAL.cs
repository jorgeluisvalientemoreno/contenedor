...
namespace SINCECOMP.CANCELLATION.BL
{
    class BLGENERAL
    {
        ...
        public DataTable userConnect()
        {
            DataTable dataUserConnect = general.getUserConnect();
        ...
        public UltraDropDown valuelistNumberId(String query, String display, String value)
        {
            //DataTable tabla = new DataTable();
            //DataRow datos;
            //tabla.Columns.Add(value, System.Type.GetType("System.Int64"));
           // tabla.Columns.Add(display);
            //datos = tabla.NewRow();
            //tabla.Rows.Add(datos);
            DataTable tbDetail;
        ...
        //
        public UltraDropDown valuelist2(String query, String display, String value)
        {
            //DataTable tabla = new DataTable();
            //DataRow datos;
            //tabla.Columns.Add(value);
            //DataColumn idColumn = new DataColumn();
            //idColumn.DataType = System.Type.GetType("System.Int");
            //idColumn.ColumnName = "DOCUMENTO";
            ...
            dropDowntb.DataSource = tbDetail; //tabla;
            dropDowntb.ValueMember = value;
            dropDowntb.DisplayMember = display;

          
            //dropDowntb.DisplayLayout.Bands[0].Columns[0].Hidden = true;
            //dropDowntb.Layouts.   ..e.Layout.Bands.Columns["my column"].Hidden
            dropDowntb.DisplayLayout.Override.HeaderClickAction = Infragistics.Win.UltraWinGrid.HeaderClickAction.SortMulti;
            return dropDowntb;
        }
        //
        ...
        public void setColumnRequiered(UltraGrid ug, String[] Fields)
        {
            foreach (String column in Fields)
            {
                ...
                {   
                    ug.DisplayLayout.Bands[0].Columns[column].Header.Appearance.Image = global::SINCECOMP.CANCELLATION.Resource.asterisc;
        ...
        public Object getParam(String sbParam, String tipo)
        {
            ...
            {
                mensajeERROR("El Parametro: " + sbParam + ", no se encuentra configurado, favor validar.");
                return valor;
            }
        }
        ...
        /// <param name="numField">N˙mero de Campos que seran enviados al Procedimiento</param>
        ...
        //
        //private void generador_CellExported(object sender, Infragistics.Win.UltraWinGrid.ExcelExport.CellExportedEventArgs e)
        //{
        //    //foreach (object Col in vectorColumnas)
        //    //{
        //    //    if (e.GridColumn.Key == Col.ToString())//.Index == 1)
        //    //{
        //            int excelrow = e.CurrentRowIndex;
        //            int excelcol = e.CurrentColumnIndex;
        //            e.CurrentWorksheet.Rows[excelrow].Cells[excelcol].Value = Convert.ToString(e.GridRow.Cells[excelcol].Value); //+
        //                    //"|" + e.GridRow.Cells[Col.ToString()].Text;
        //    //}
        //    //}
        ...
        public void imprimirExcel(UltraGrid grilla)
        {
            try
            {
                ...
                //Question pregunta = new Question("LDAPB - Imprimir Reporte", "øDesea Imprimir el actual Reporte?", "Si", "No");
                //pregunta.ShowDialog();
            ...
            {
                mensajeERROR("Error durante la impresiÛn.\n" + exc.Message);
            }
        }
        ...
        /// <summary>
        /// Valida y Remplaza textos con tildes y Ascentos
        /// </summary>
        /// <param name="Texto"></param>
        /// <returns></returns>
        public String ValidarAscento(String Texto)
        {
