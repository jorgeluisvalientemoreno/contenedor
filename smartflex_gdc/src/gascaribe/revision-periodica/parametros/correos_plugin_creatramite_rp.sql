Prompt Creando el parametro CORREOS_PLUGIN_CREATRAMITE_RP
BEGIN
MERGE INTO OPEN.PARAMETROS A USING
 (SELECT
  'CORREOS_PLUGIN_CREATRAMITE_RP' as CODIGO,
  'Correos envio creación tramite correspondiente al plugin ldccreaflujosrpsusadmarsolsac' as DESCRIPCION,
  NULL as VALOR_NUMERICO,
  'hangulo@gascaribe.com;jmaestre@gascaribe.com' as VALOR_CADENA,
  NULL as VALOR_FECHA,
  3 as PROCESO,
  'A' as ESTADO,
  'S' as OBLIGATORIO,
