...
MERGE INTO OPEN.LD_PARAMETER A USING
 (SELECT
  'ACTI_YA_SUSP_AC' as PARAMETER_ID,
  100009122 as NUMERIC_VALUE,
  NULL as VALUE_CHAIN,
  'ACTIVIDAD A GENERAR CUANDO EL PRODUCTO YA SE ENCUENTRA SUSPENDIDO EN ACOMETIDA' as DESCRIPTION
  FROM DUAL) B
