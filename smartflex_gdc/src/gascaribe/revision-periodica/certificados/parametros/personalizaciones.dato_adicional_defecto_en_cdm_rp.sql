MERGE INTO PERSONALIZACIONES.PARAMETROS A USING
 (SELECT
  'DATO_ADICIONAL_DEFECTO_EN_CDM_RP' as "CODIGO",
  'DATO ADICIONAL PARA IDENTIFICAR SI O NO TIENE DEFECTO EN CENTRO DE MEDICION EN UNA CERTIFICACION' as "DESCRIPCION",
  NULL as "VALOR_NUMERICO",
  'DEFECTO_EN_CDM_RP' as "VALOR_CADENA",
  NULL as "VALOR_FECHA",
  3 as "PROCESO",
