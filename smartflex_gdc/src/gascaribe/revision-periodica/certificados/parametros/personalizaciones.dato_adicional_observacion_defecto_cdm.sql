MERGE INTO PERSONALIZACIONES.PARAMETROS A USING
 (SELECT
  'DATO_ADICIONAL_OBSERVACION_DEFECTO_CDM' as "CODIGO",
  'DATO ADICIONAL PARA CONTENER LA OBSERVACION ENCONTRADA CON EL DEFECTO EN EL CENTRO DE MEDICION EN UNA CERTIFICACION' as "DESCRIPCION",
  NULL as "VALOR_NUMERICO",
  'DEF_CDM_DESCRIPCION' as "VALOR_CADENA",
  NULL as "VALOR_FECHA",
  3 as "PROCESO",
