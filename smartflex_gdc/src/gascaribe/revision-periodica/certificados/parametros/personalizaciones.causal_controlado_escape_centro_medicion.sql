MERGE INTO PERSONALIZACIONES.PARAMETROS A USING
 (SELECT
  'CAUSAL_CONTROLADO_ESCAPE_CENTRO_MEDICION' as "CODIGO",
  'CAUSAL PARA IDENTIFICAR DEFECTO SERA CONTROLADO ESCAPE DE CENTRO DE MEDICION EN UNA CERTIFICACION' as "DESCRIPCION",
  292 as "VALOR_NUMERICO",
