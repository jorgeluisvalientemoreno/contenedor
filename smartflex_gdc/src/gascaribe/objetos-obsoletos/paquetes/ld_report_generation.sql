...
End ld_report_generation;
/
GRANT EXECUTE on LD_REPORT_GENERATION to SYSTEM_OBJ_PRIVS_ROLE;
GRANT EXECUTE on LD_REPORT_GENERATION to REXEOPEN;
GRANT EXECUTE on LD_REPORT_GENERATION to RSELSYS;
/
