create or replace package PERSONALIZACIONES.PKG_GESTION_PRODUCTO IS
  ...
  ***************************************************************************/
  ...
  -- OSF-1911
  -- Estados de Producto
  CNUESTADO_SUSPENDIDO_PRODUCTO  PR_PRODUCT.PRODUCT_STATUS_ID%TYPE := 2;
  CNUESTADO_RETIRADO_PRODUCTO    PR_PRODUCT.PRODUCT_STATUS_ID%TYPE := 3;
  CNUESTADO_PEND_INST_PRODUCTO   PR_PRODUCT.PRODUCT_STATUS_ID%TYPE := 15;
  CNUESTADO_RET_SIN_INS_PRODUCTO PR_PRODUCT.PRODUCT_STATUS_ID%TYPE := 16;
  CNUESTADO_PEND_RETIRO_PRODUCTO PR_PRODUCT.PRODUCT_STATUS_ID%TYPE := 20;
  ...
  --Estados de corte
  CNUESTADO_ORD_SUS_PAR_SERVSUSC SERVSUSC.SESUESCO%TYPE := 2;
  CNUESTADO_SUSP_PARC_SERVSUSC   SERVSUSC.SESUESCO%TYPE := 3;
  CNUESTADO_SUSP_TOTAL_SERVSUSC  SERVSUSC.SESUESCO%TYPE := 5;
  CNUESTADO_ORDEN_CONEX_SERVSUSC SERVSUSC.SESUESCO%TYPE := 6;
  CNUESTADO_RETIRO_DEF_SERVSUSC  SERVSUSC.SESUESCO%TYPE := 92;
  CNUESTADO_INI_RET_VOL_SERVSUSC SERVSUSC.SESUESCO%TYPE := 94;
  CNUESTADO_RETIRO_VOL_SERVSUSC  SERVSUSC.SESUESCO%TYPE := 95;
  CNUESTADO_PEND_INSTAL_SERVSUSC SERVSUSC.SESUESCO%TYPE := 96;
  CNUESTADO_CONVEN_PAGO_SERVSUSC SERVSUSC.SESUESCO%TYPE := 99;
  CNUESTADO_RET_SIN_INS_SERVSUSC SERVSUSC.SESUESCO%TYPE := 110;
