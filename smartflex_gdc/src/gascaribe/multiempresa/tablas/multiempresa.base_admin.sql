prompt "Creando la tabla multiempresa.base_admin"
declare

    -- OSF-3988
    sbSentencia     VARCHAR2(32767);

    sbTabla         VARCHAR2(30)    := UPPER('base_admin'); 
...
begin
    ...
    IF rcDBA_TABLES.TABLE_NAME IS NULL THEN
        ...
        sbSentencia := sbSentencia || 'BASE_ADMINISTRATIVA      NUMBER(15),' || CHR(10);
        ...
        pCreaComenColumna('BASE_ADMINISTRATIVA','Código de la base administrativa');
...
END;
/
prompt "Creando llave primaria para la tabla multiempresa.base_admin"
DECLARE
	...
	sbTableO	VARCHAR2(30)    := UPPER('base_admin');
	sbColumnO	VARCHAR2(30)    := UPPER('BASE_ADMINISTRATIVA');
