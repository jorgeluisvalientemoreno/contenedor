...
BEGIN
sa_bocreatePackages.CreatePackage('VW_MATERIALES_',
'CREATE OR REPLACE PACKAGE VW_MATERIALES_ IS ' || chr(10) ||
...
BEGIN ut_trace.trace('********************Comenzar proceso de objeto:VW_MATERIALES_******************************'); END;
/
...
DECLARE
    ...
    CURSOR  cuConfigExpression IS
        ...
        WHERE   GR_CONFIG_EXPRESSION.CONFIG_EXPRESSION_ID IN (
            ...
            WHERE   ENTITY_ID in (SELECT ENTITY_ID FROM GE_ENTITY WHERE NAME_='VW_MATERIALES')
            UNION
...
if (not VW_MATERIALES_.blProcessStatus) then
 return;
end if;
    ...
    DELETE FROM GE_ATTR_VAL_EXPRESS WHERE (ENTITY_ATTRIBUTE_ID) in (SELECT ENTITY_ATTRIBUTE_ID FROM GE_ENTITY_ATTRIBUTES WHERE (ENTITY_ID) in (SELECT ENTITY_ID FROM GE_ENTITY WHERE NAME_='VW_MATERIALES'));
    DELETE FROM GE_ATTR_ALLOWED_VALUES WHERE (ENTITY_ATTRIBUTE_ID) in (SELECT ENTITY_ATTRIBUTE_ID FROM GE_ENTITY_ATTRIBUTES WHERE (ENTITY_ID) in (SELECT ENTITY_ID FROM GE_ENTITY WHERE NAME_='VW_MATERIALES'));
...
BEGIN 
  VW_MATERIALES_.tbEntityAttributeName(90200499) := 'VW_MATERIALES@MATERIAL'; 
  VW_MATERIALES_.tbEntityAttributeName(90200500) := 'VW_MATERIALES@EMPRESA'; 
  VW_MATERIALES_.tbEntityAttributeName(90200501) := 'VW_MATERIALES@HABILITADO'; 
END;
/
...
VW_MATERIALES_.old_tb0_0(0):='VW_MATERIALES'
;
VW_MATERIALES_.tb0_0(0):='VW_MATERIALES';
VW_MATERIALES_.old_tb0_1(0):=6231;
VW_MATERIALES_.tb0_1(0):=GE_BOCATALOG.FNUGETIDSEQFROMCATALOG(VW_MATERIALES_.tb0_0(0), 'ENTITY', 'GE_BOSEQUENCE.NEXTGE_ENTITY');
VW_MATERIALES_.tb0_1(0):=VW_MATERIALES_.tb0_1(0);
ut_trace.trace('Actualizar tabla: GE_ENTITY fila (0)',1);
UPDATE GE_ENTITY SET DESCRIPTION='VW_MATERIALES'
,
DISPLAY_NAME='VW_MATERIALES'
,
ALLOWED_FULL_SCAN='N'

 WHERE ENTITY_ID = VW_MATERIALES_.tb0_1(0);

exception when others then
VW_MATERIALES_.blProcessStatus := false;
rollback;
ut_trace.trace('**ERROR:'||sqlerrm);
raise;
END;
...
VW_MATERIALES_.tb1_0(0):=VW_MATERIALES_.tb0_1(0);
VW_MATERIALES_.old_tb1_1(0):=90200499;
VW_MATERIALES_.tb1_1(0):=GE_BOCATALOG.FNUGETIDSEQFROMCATALOG(VW_MATERIALES_.TBENTITYATTRIBUTENAME(VW_MATERIALES_.old_tb1_1(0)), 'ATTRIBUTE', GE_BOSEQUENCE.NEXTGE_ENTITY_ATTRIBUTES);
VW_MATERIALES_.tb1_1(0):=VW_MATERIALES_.tb1_1(0);
...
UNCHECKED_VALUE=null
 WHERE ENTITY_ATTRIBUTE_ID = VW_MATERIALES_.tb1_1(0);
...
VW_MATERIALES_.tb1_0(1):=VW_MATERIALES_.tb0_1(0);
VW_MATERIALES_.old_tb1_1(1):=90200500;
VW_MATERIALES_.tb1_1(1):=GE_BOCATALOG.FNUGETIDSEQFROMCATALOG(VW_MATERIALES_.TBENTITYATTRIBUTENAME(VW_MATERIALES_.old_tb1_1(1)), 'ATTRIBUTE', GE_BOSEQUENCE.NEXTGE_ENTITY_ATTRIBUTES);
VW_MATERIALES_.tb1_1(1):=VW_MATERIALES_.tb1_1(1);
...
CHECKED_VALUE=null,
UNCHECKED_VALUE=null
 WHERE ENTITY_ATTRIBUTE_ID = VW_MATERIALES_.tb1_1(1);
...
VW_MATERIALES_.tb1_0(2):=VW_MATERIALES_.tb0_1(0);
VW_MATERIALES_.old_tb1_1(2):=90200501;
VW_MATERIALES_.tb1_1(2):=GE_BOCATALOG.FNUGETIDSEQFROMCATALOG(VW_MATERIALES_.TBENTITYATTRIBUTENAME(VW_MATERIALES_.old_tb1_1(2)), 'ATTRIBUTE', GE_BOSEQUENCE.NEXTGE_ENTITY_ATTRIBUTES);
VW_MATERIALES_.tb1_1(2):=VW_MATERIALES_.tb1_1(2);
...
CHECKED_VALUE=null,
UNCHECKED_VALUE=null
 WHERE ENTITY_ATTRIBUTE_ID = VW_MATERIALES_.tb1_1(2);
...
begin
SA_BOCreatePackages.DropPackage('VW_MATERIALES_');
end;
/

BEGIN ut_trace.trace('********************FIN  proceso de objeto:VW_MATERIALES_******************************'); end;
/
