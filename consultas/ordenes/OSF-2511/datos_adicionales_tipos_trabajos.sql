select tda.task_type_id,
  ...
  inner join open.ge_attributes_set sete  on sete.attribute_set_id = tda.attribute_set_id
   where tda.task_type_id = 12143
      and tda.active = 'Y'

/*update or_tasktype_add_data tda set gd.mandatory = 'Y'  where ai.items_id = 100002510 and ai.attribute_1_id = 5012045*/

/*select *
from or_tasktype_add_data da
where da.task_type_id in (12135,12143)
and   da.active = 'Y'
for update*/
