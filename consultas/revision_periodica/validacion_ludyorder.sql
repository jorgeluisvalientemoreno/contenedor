select distinct o.order_id,a.product_id,  o.operating_unit_id, (select name from open.or_operating_unit u where u.operating_unit_id=o.operating_unit_id) nombre,
FECHA_RECEPCION,
...
where li.Messagecode <> 0
  ...
  and o.task_type_id in (10450, 12457);
