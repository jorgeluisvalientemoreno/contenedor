...
/******************************************************************************************************************************
 ...
 HISTORIA DE MODIFICACIONES
   ...
   12/05/2021   HORBATH      CASO 602: *Crear un nuevo cursor llamado CUVALIDACAUTIPTRA. En este cursor se validara si el
                                       tipo de trabajo y causal estan configurados en el nuevo parametro llamado LDC_PARAREPE
                                       *Crear un nuevo cursor llamado CUDATAORDEN. Para obtener informacion de la orden legalizada.
  ...
  19-04-2024   Adrianavg	 OSF-2569: Se migra del esquema OPEN al esquema ADM_PERSON
	07/11/2024	jeerazomvm		OSF:3571: 1. Se agregan trazas
										  ...
										  3. Se elimina validacion fblaplicaentregaxcaso(0000602)
...
*******************************************************************************************************************************/
	...
	--Se declaran variables para la gestion de trazas
	...
	nuValidacion          	number;
	isbOrderComme         	varchar2(4000) := 'No se generaron tramites adicionales, porque el estado de corte del producto es igual a [5 - SUSPESION TOTAL] y/o su estado financiero es igual a CASTIGADO';
	...
	SBVALTIPOSUSP varchar2(10); --establecer el tipo de suspension del producto.
	------------------------------------
	...
	Descripcion : Procedimiento que realiza el envio de correos,
				  si la causal de legalizacion es de exito
	...
	HISTORIA DE MODIFICACIONES
	FECHA        AUTOR   		DESCRIPCION
	15/11/2024	 jeerazomvm		OSF:3571: Creacion
	*******************************************************************************************************************************/
	...
	IS
		...
		csbSubject					VARCHAR2(2000)			:= 'Error! PLUGIN: Crea tramite correspondiente de RP';
...
BEGIN
	...
	-- Valida si el tipo de trabajo y causal, esta configurados en el parametro TITR_CAUSAL_OTSUSPENSION
	...
	-- Obtiene la clase de causal de legalizacion
		...
		IF SBVALTIPOSUSP = 'CM' OR SBVALTIPOSUSP IS NULL THEN
            ...
            ELSE
				BEGIN
					...
					-- El producto NO se encuentra [5 - SUSPESION TOTAL] y/o [C - CASTIGADO]
