select mo_packages.package_id  "# Solicitud",
       ...
       mo_packages.attention_date   "Fecha de atencion",
...
where mo_packages.package_id in (191926691,196999089,191926692,196999090  )
order by mo_packages.package_id asc;
