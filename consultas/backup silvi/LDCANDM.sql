...
and ((cucosacu) - (cucovare) - (cucovrap))  >0  and coecfact = 'S' and sesususc > 11111111
...
left join open.confesco on coecserv=sesuserv and coecfact ='S' and coeccodi = sesuesco 
where cucosacu >0 and sesuserv in (7055) and sesusafa >=0   and rownum <=8
and ((cucosacu) - (cucovare) - (cucovrap))  >0  and coecfact = 'S'
