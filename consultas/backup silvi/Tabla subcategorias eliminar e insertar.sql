...
from ldc_coprsuca 
where cpscubge = 55
order by cpscanco desc 
for update 
  
DELETE FROM ldc_coprsuca where cpscubge = 55
  
UPDATE ldc_coprsuca SET  cpscprdi = 0  /*cpsccoto = 0*/ WHERE cpscubge = 55
UPDATE coprsuca SET cpscprdi = 0  /*cpsccoto = 0 */ WHERE cpscubge = 55
