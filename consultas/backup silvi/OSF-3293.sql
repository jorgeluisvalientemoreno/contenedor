select * 
from ge_subscriber 
where subscriber_id =54410
 ;

select * from pr_product where address_id = 235580 ;

select * from suscripc where suscclie = 84714 

select * 
from fe_validacion_identificacion
where id_cliente = 3185702 ;
...
begin
    ...
    END IF;   
    --DBMS_OUTPUT.PUT_LINE('nuModDigitoVer: '||nuModDigitoVer);
