with base as(select o.order_id,sesuesco,sesucate,sesuesfn,pr.product_status_id,
...
where o.task_type_id in (10043)
  and o.order_status_id in (0,5) --and sesucate = 2
  )
,
base2 as(
select base.*,
...
select*
from base8
--where califica1 = 2008 or califica2 = 2008  --and product_id = 17036761 ;
