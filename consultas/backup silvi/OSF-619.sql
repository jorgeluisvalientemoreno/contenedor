select a.product_id         Producto,
       pr.product_type_id   tipo_prod , 
       pr.product_status_id  || ' ' ||  ep.description  Estado_Producto,
       p.package_type_id  || ' ' ||  ts.description Desc_Tipo_Solicitud,
...
where a.product_id =50233519
and  p.package_type_id = 100231
and p.request_date   > '21/11/2022'
