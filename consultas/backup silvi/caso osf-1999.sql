select * from factura f where f.factcodi= 2054799017
;

select * from cuencobr br where br.cucofact= 2054799017
 ;
 --2055743480 , 2098487133
...
where br.cucofact= 2098487133 and cargdoso like '%PP%'
