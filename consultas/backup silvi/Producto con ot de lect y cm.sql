...
select or_order_activity.subscription_id  "Contrato", or_order_activity.product_id  "Producto", 
       ...
       or_order.created_date   "Fecha de Registro", or_order.assigned_date  "Fecha de Asignacion"
from open.or_order
