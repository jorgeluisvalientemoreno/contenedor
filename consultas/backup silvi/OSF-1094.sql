select sesucate "Categoria",
       ...
       round (( (sum(nvl(cosscoca, 0))/count(distinct cosssesu))/30 ), 4)  "Consumo promedio diario"
...
where c1.cosspefa in  (103922,103892)
and cossflli='S'
and sesuesfn <> 'C'
and ge_geogra_location.geograp_location_id = 33
