...
begin 
        ...
        dtfecha_exe_ini := to_date('02/05/2024 10:52:42','dd/mm/yyyy hh24:mi:ss')-1/86400;
        dtult_fecha_lect := to_date('02/05/2024 10:52:42','dd/mm/yyyy hh24:mi:ss');
        
        nuorden := 323599275;
        nucausal := 9688;
        nupersonid := pkg_bopersonal.fnugetpersonaid; --16504
        nuactividadot := 316484041;
        nulecturafinal := 211;
        nuActividad := 102008; 
        nuFlag := 0;
