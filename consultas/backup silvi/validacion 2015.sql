select  a.product_id , ab.geograp_location_id ,sesuesco,sesuesfn ,product_status_id, sesucate, sesusuca,
...
(select count ( distinct (o4.order_id)) 
 ...
 and o4.order_status_id in (0,5)
 and o4.created_date < '22/03/2023' ) as ot_onl_8_pend,
(select count ( distinct (o7.order_id)) 
 ...
 and o3.order_status_id in (0,5)
 and o3.created_date < '22/03/2023') as ot_onl_38_pend,
...
(select count ( distinct (o2.order_id)) 
 ...
 and o9.order_status_id in (0,5)
 and o9.created_date < '22/03/2023' ) as ot_onl_64_pend, 
 ...
 and o1.created_date < '22/03/2023' ) as ot_onl_82_pend, 
 ...
 and o5.created_date < '22/03/2023' ) as ot_onl_12_pen,
...
and r.legalization_date >= '23/03/2023 15:10:00'     
