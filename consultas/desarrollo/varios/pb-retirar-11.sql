WITH BASE AS(
      ...
      , base2 as(
            ...
            WHERE    name in ('LDCRCB','IMPCPS','LDCIMCUPT','LDCRVEEM','LDC_GOC','LDCLICA','PBDESNO','LDC_EXOGENA','LDCRELPNO','LDC_PBORDVENT','LDGIC','LDCPBGOC','LDC_PBCAMBIODIRORDEN','LDC_PBTRASINFOCLIENT','LDC_PBLDCRVPCON','LDC_CTRACC','LDCGNTTP','LDCGCAUC','LDCGPVANU')
...
where ex.name in ('LDCRCB','IMPCPS','LDCIMCUPT','LDCRVEEM','LDC_GOC','LDCLICA','PBDESNO','LDC_EXOGENA','LDCRELPNO','LDC_PBORDVENT','LDGIC','LDCPBGOC','LDC_PBCAMBIODIRORDEN','LDC_PBTRASINFOCLIENT','LDC_PBLDCRVPCON','LDC_CTRACC','LDCGNTTP','LDCGCAUC','LDCGPVANU')
