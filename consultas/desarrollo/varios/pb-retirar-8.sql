WITH BASE AS(
      ...
      , base2 as(
            ...
            WHERE    name in ('LDCVE','LDCACE','LDCVD','LDCMC','PBEQU','LDCCONPR','IRMFE','PBASV','CCSAC','LDCI_PVCM','LDRPBSE','ORTCI','LDRUSEXCO_PB','LDCCAIPA','MIOSA','AIOSA','LDC_DLRCLPB')
...
where ex.name in ('LDCVE','LDCACE','LDCVD','LDCMC','PBEQU','LDCCONPR','IRMFE','PBASV','CCSAC','LDCI_PVCM','LDRPBSE','ORTCI','LDRUSEXCO_PB','LDCCAIPA','MIOSA','AIOSA','LDC_DLRCLPB')
