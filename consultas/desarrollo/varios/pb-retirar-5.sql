WITH BASE AS(
      ...
      , base2 as(
            ...
            WHERE    name in ('OCRT_COPIA','PBAC','PBCS','FIRAD','PBNCM','LDICP','RUTEROS','PBRDO','ODTCI','PBRHD','PBGFR','CRGNC','IFMSP','DLRAPIR','LDRPESI','LDRPQRSUIA')
...
where ex.name in ('OCRT_COPIA','PBAC','PBCS','FIRAD','PBNCM','LDICP','RUTEROS','PBRDO','ODTCI','PBRHD','PBGFR','CRGNC','IFMSP','DLRAPIR','LDRPESI','LDRPQRSUIA')
