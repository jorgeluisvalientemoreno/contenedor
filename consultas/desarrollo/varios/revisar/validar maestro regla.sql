with base as(
select REGLA_VALIDACION   regla, 'GE_ITEMS_TIPO_ATR ' as tabla  from open.GE_ITEMS_TIPO_ATR   where REGLA_VALIDACION is not null union all
select REGLA_INICIO   regla, 'GE_ITEMS_TIPO_ATR ' as tabla  from open.GE_ITEMS_TIPO_ATR   where REGLA_INICIO is not null union all
select PACTREGL   regla, 'LE_PARACATR ' as tabla  from open.LE_PARACATR   where PACTREGL is not null union all
select RULE_ID  regla, 'GE_ACT_PRODTYPE_STAT ' as tabla from open.GE_ACT_PRODTYPE_STAT  where RULE_ID is not null union all
select VALID_EXPRESSION_4_ID  regla, 'GE_ITEMS_ATTRIBUTES ' as tabla  from open.GE_ITEMS_ATTRIBUTES   where VALID_EXPRESSION_4_ID is not null union all
select VALID_EXPRESSION_3_ID  regla, 'GE_ITEMS_ATTRIBUTES ' as tabla  from open.GE_ITEMS_ATTRIBUTES   where VALID_EXPRESSION_3_ID is not null union all
select VALID_EXPRESSION_2_ID  regla, 'GE_ITEMS_ATTRIBUTES ' as tabla  from open.GE_ITEMS_ATTRIBUTES   where VALID_EXPRESSION_2_ID is not null union all
select VALID_EXPRESSION_1_ID  regla, 'GE_ITEMS_ATTRIBUTES ' as tabla  from open.GE_ITEMS_ATTRIBUTES   where VALID_EXPRESSION_1_ID is not null union all
select INIT_EXPRESSION_4_ID   regla, 'GE_ITEMS_ATTRIBUTES ' as tabla  from open.GE_ITEMS_ATTRIBUTES   where INIT_EXPRESSION_4_ID is not null union all
select INIT_EXPRESSION_3_ID   regla, 'GE_ITEMS_ATTRIBUTES ' as tabla  from open.GE_ITEMS_ATTRIBUTES   where INIT_EXPRESSION_3_ID is not null union all
select INIT_EXPRESSION_2_ID   regla, 'GE_ITEMS_ATTRIBUTES ' as tabla  from open.GE_ITEMS_ATTRIBUTES   where INIT_EXPRESSION_2_ID is not null union all
select INIT_EXPRESSION_1_ID   regla, 'GE_ITEMS_ATTRIBUTES ' as tabla  from open.GE_ITEMS_ATTRIBUTES   where INIT_EXPRESSION_1_ID is not null union all
select ACGCREGL   regla, 'ACTIGECO ' as tabla from open.ACTIGECO  where ACGCREGL is not null union all
select ACGCREVP   regla, 'ACTIGECO ' as tabla from open.ACTIGECO  where ACGCREVP is not null union all
select ACGCREFA   regla, 'ACTIGECO ' as tabla from open.ACTIGECO  where ACGCREFA is not null union all
select CONFIG_EXPRESSION_ID   regla, 'PM_STAGE ' as tabla from open.PM_STAGE  where CONFIG_EXPRESSION_ID is not null union all
select TIFRCEID   regla, 'ED_TIPOFRAN ' as tabla  from open.ED_TIPOFRAN   where TIFRCEID is not null union all
select ITEMCEID   regla, 'ED_ITEM ' as tabla  from open.ED_ITEM   where ITEMCEID is not null union all
select CONFIG_EXPRESSION_ID   regla, 'GE_MESG_ALERT ' as tabla  from open.GE_MESG_ALERT   where CONFIG_EXPRESSION_ID is not null union all
select CAURCORE   regla, 'LE_CAMPUNRO ' as tabla  from open.LE_CAMPUNRO   where CAURCORE is not null union all
select ERROR_EXPRESION_ID   regla, 'GE_VARIABLE ' as tabla  from open.GE_VARIABLE   where ERROR_EXPRESION_ID is not null union all
select INIT_EXPRESSION_ID   regla, 'GE_TEMPLATE_VAR ' as tabla  from open.GE_TEMPLATE_VAR   where INIT_EXPRESSION_ID is not null union all
select VALID_EXPRESSION_ID  regla, 'GE_TEMPLATE_VAR ' as tabla  from open.GE_TEMPLATE_VAR   where VALID_EXPRESSION_ID is not null union all
select ERROR_EXPRESSION_ID  regla, 'GE_TEMPLATE_VAR ' as tabla  from open.GE_TEMPLATE_VAR   where ERROR_EXPRESSION_ID is not null union all
select DETCRECA   regla, 'GST_DETATACO ' as tabla from open.GST_DETATACO  where DETCRECA is not null union all
select INITIAL_EXPRESSION   regla, 'GE_ATTRIB_SET_ATTRIB ' as tabla from open.GE_ATTRIB_SET_ATTRIB  where INITIAL_EXPRESSION is not null union all
select VALID_EXPRESSION   regla, 'GE_ATTRIB_SET_ATTRIB ' as tabla from open.GE_ATTRIB_SET_ATTRIB  where VALID_EXPRESSION is not null union all
select CONFIG_EXPRESSION_ID   regla, 'WF_RECOVERY_ACTION ' as tabla from open.WF_RECOVERY_ACTION  where CONFIG_EXPRESSION_ID is not null union all
select ONLINE_EXEC_ID   regla, 'WF_INSTANCE ' as tabla  from open.WF_INSTANCE   where ONLINE_EXEC_ID is not null union all
select POS_EXPRESSION_ID  regla, 'WF_INSTANCE ' as tabla  from open.WF_INSTANCE   where POS_EXPRESSION_ID is not null union all
select PRE_EXPRESSION_ID  regla, 'WF_INSTANCE ' as tabla  from open.WF_INSTANCE   where PRE_EXPRESSION_ID is not null union all
select CONFIG_EXPRESSION_ID   regla, 'GE_PROCESS ' as tabla from open.GE_PROCESS  where CONFIG_EXPRESSION_ID is not null union all
select TIEVCORE   regla, 'LE_TIPOEVEN ' as tabla  from open.LE_TIPOEVEN   where TIEVCORE is not null union all
select CONFIG_EXPRESSION_ID   regla, 'IF_WHEN_LINK ' as tabla from open.IF_WHEN_LINK  where CONFIG_EXPRESSION_ID is not null union all
select INIT_EXPRESSION_ID   regla, 'GE_SUBS_TYPE_ATTRIB ' as tabla  from open.GE_SUBS_TYPE_ATTRIB   where INIT_EXPRESSION_ID is not null union all
select VALID_EXPRESSION_ID  regla, 'GE_SUBS_TYPE_ATTRIB ' as tabla  from open.GE_SUBS_TYPE_ATTRIB   where VALID_EXPRESSION_ID is not null union all
select CONFIG_EXPRESSION_ID   regla, 'GE_WHEN_ENTITY_EVENT ' as tabla from open.GE_WHEN_ENTITY_EVENT  where CONFIG_EXPRESSION_ID is not null union all
select CONFIG_EXPRESSION_ID   regla, 'IF_WHEN_ELEMENT ' as tabla  from open.IF_WHEN_ELEMENT   where CONFIG_EXPRESSION_ID is not null union all
select CODVIDPV   regla, 'RC_CONDDEVA ' as tabla  from open.RC_CONDDEVA   where CODVIDPV is not null union all
select COGVIDPA   regla, 'RC_CONDGEVA ' as tabla  from open.RC_CONDGEVA   where COGVIDPA is not null union all
select COGVIDPP   regla, 'RC_CONDGEVA ' as tabla  from open.RC_CONDGEVA   where COGVIDPP is not null union all
select AFTER_EXPRE_ID   regla, 'IF_STATUS_ACTION ' as tabla from open.IF_STATUS_ACTION  where AFTER_EXPRE_ID is not null union all
select BEFORE_EXPRE_ID  regla, 'IF_STATUS_ACTION ' as tabla from open.IF_STATUS_ACTION  where BEFORE_EXPRE_ID is not null union all
select EXPRESSION   regla, 'CC_ACTION_EVENT ' as tabla  from open.CC_ACTION_EVENT   where EXPRESSION is not null union all
select CONFIG_EXPRESSION_ID   regla, 'OR_OPUNI_TSKTYP_NOTI ' as tabla from open.OR_OPUNI_TSKTYP_NOTI  where CONFIG_EXPRESSION_ID is not null union all
select TIBLCEID   regla, 'ED_TIPOBLOQ ' as tabla  from open.ED_TIPOBLOQ   where TIBLCEID is not null union all
select CONFIG_EXPRESSION_ID   regla, 'OR_ACT_BY_REQ_ELEM ' as tabla from open.OR_ACT_BY_REQ_ELEM  where CONFIG_EXPRESSION_ID is not null union all
select CONFIG_EXPRESSION_ID   regla, 'OR_ACT_BY_REQ_DATA ' as tabla from open.OR_ACT_BY_REQ_DATA  where CONFIG_EXPRESSION_ID is not null union all
select CONFIG_EXPRESSION_ID   regla, 'OR_ACT_BY_TASK_MOD ' as tabla from open.OR_ACT_BY_TASK_MOD  where CONFIG_EXPRESSION_ID is not null union all
select CONFIG_EXPRESSION_ID   regla, 'GI_PROPERTIES_CONFIG ' as tabla from open.GI_PROPERTIES_CONFIG  where CONFIG_EXPRESSION_ID is not null union all
select BEFORE_EXPRESSION_ID   regla, 'GI_FRAME ' as tabla from open.GI_FRAME  where BEFORE_EXPRESSION_ID is not null union all
select AFTER_EXPRESSION_ID  regla, 'GI_FRAME ' as tabla from open.GI_FRAME  where AFTER_EXPRESSION_ID is not null union all
select ACCEPT_RULE_ID   regla, 'GI_CONFIG ' as tabla  from open.GI_CONFIG   where ACCEPT_RULE_ID is not null union all
select VALID_EXPRESSION_ID  regla, 'GI_COMP_ATTRIBS ' as tabla  from open.GI_COMP_ATTRIBS   where VALID_EXPRESSION_ID is not null union all
select INIT_EXPRESSION_ID   regla, 'GI_COMP_ATTRIBS ' as tabla  from open.GI_COMP_ATTRIBS   where INIT_EXPRESSION_ID is not null union all
select PRCAREAS   regla, 'PROGCART ' as tabla from open.PROGCART  where PRCAREAS is not null union all
select RECAIDRE   regla, 'REGLCALI ' as tabla from open.REGLCALI  where RECAIDRE is not null union all
select DECBREIN   regla, 'TA_DEFICRBT ' as tabla  from open.TA_DEFICRBT   where DECBREIN is not null union all
select DECBREVA   regla, 'TA_DEFICRBT ' as tabla  from open.TA_DEFICRBT   where DECBREVA is not null union all
select PRE_EXPRESSION_ID  regla, 'OR_TRANSITION ' as tabla  from open.OR_TRANSITION   where PRE_EXPRESSION_ID is not null union all
select POST_EXPRESSION_ID   regla, 'OR_TRANSITION ' as tabla  from open.OR_TRANSITION   where POST_EXPRESSION_ID is not null union all
select ASSIGN_RULE_ID   regla, 'LD_QUOTA_ASSIGN_POLICY ' as tabla from open.LD_QUOTA_ASSIGN_POLICY  where ASSIGN_RULE_ID is not null union all
select EQTNREVA   regla, 'LE_EQUITIEN ' as tabla  from open.LE_EQUITIEN   where EQTNREVA is not null union all
select CONFIG_EXPRESSION_ID   regla, 'OR_NOTIF_TIPO_TRABA ' as tabla  from open.OR_NOTIF_TIPO_TRABA   where CONFIG_EXPRESSION_ID is not null union all
select VALID_EXPRESSION_ID  regla, 'PS_MOTI_COMP_ATTRIBS ' as tabla from open.PS_MOTI_COMP_ATTRIBS  where VALID_EXPRESSION_ID is not null union all
select INIT_EXPRESSION_ID   regla, 'PS_MOTI_COMP_ATTRIBS ' as tabla from open.PS_MOTI_COMP_ATTRIBS  where INIT_EXPRESSION_ID is not null union all
select INIT_EXPRESSION_ID   regla, 'PS_PROD_MOTI_ATTRIB ' as tabla  from open.PS_PROD_MOTI_ATTRIB   where INIT_EXPRESSION_ID is not null union all
select VALID_EXPRESSION_ID  regla, 'PS_PROD_MOTI_ATTRIB ' as tabla  from open.PS_PROD_MOTI_ATTRIB   where VALID_EXPRESSION_ID is not null union all
select VALID_EXPRESSION_ID  regla, 'PS_PACKAGE_ATTRIBS ' as tabla from open.PS_PACKAGE_ATTRIBS  where VALID_EXPRESSION_ID is not null union all
select INIT_EXPRESSION_ID   regla, 'PS_PACKAGE_ATTRIBS ' as tabla from open.PS_PACKAGE_ATTRIBS  where INIT_EXPRESSION_ID is not null union all
select UPDATE_EXPRE_ID  regla, 'IF_ELEMENT_ATTRIBUTE ' as tabla from open.IF_ELEMENT_ATTRIBUTE  where UPDATE_EXPRE_ID is not null union all
select INSERT_EXPRE_ID  regla, 'IF_ELEMENT_ATTRIBUTE ' as tabla from open.IF_ELEMENT_ATTRIBUTE  where INSERT_EXPRE_ID is not null union all
select INITIALIZA_EXPRE_ID  regla, 'IF_ELEMENT_ATTRIBUTE ' as tabla from open.IF_ELEMENT_ATTRIBUTE  where INITIALIZA_EXPRE_ID is not null union all
select UPDATE_EXPRE_ID  regla, 'IF_CAPA_ELEM_ATTR ' as tabla  from open.IF_CAPA_ELEM_ATTR   where UPDATE_EXPRE_ID is not null union all
select INSERT_EXPRE_ID  regla, 'IF_CAPA_ELEM_ATTR ' as tabla  from open.IF_CAPA_ELEM_ATTR   where INSERT_EXPRE_ID is not null union all
select INITIALIZA_EXPRE_ID  regla, 'IF_CAPA_ELEM_ATTR ' as tabla  from open.IF_CAPA_ELEM_ATTR   where INITIALIZA_EXPRE_ID is not null union all
select CONFIG_EXPRESSION_ID   regla, 'IF_CAPACITY_TYPE ' as tabla from open.IF_CAPACITY_TYPE  where CONFIG_EXPRESSION_ID is not null union all
select CONFIG_EXPRESSION_ID   regla, 'AB_DOMAIN_COMP ' as tabla from open.AB_DOMAIN_COMP  where CONFIG_EXPRESSION_ID is not null union all
select CONFIG_EXPRESSION_ID   regla, 'IN_MESSAGE_TYPE ' as tabla  from open.IN_MESSAGE_TYPE   where CONFIG_EXPRESSION_ID is not null union all
select RVTAEXPR   regla, 'LE_REGLVATA ' as tabla  from open.LE_REGLVATA   where RVTAEXPR is not null union all
select CONFIG_EXPRESSION_ID   regla, 'CT_CONDITIONS ' as tabla  from open.CT_CONDITIONS   where CONFIG_EXPRESSION_ID is not null union all
select REPDIDEX   regla, 'RESTPLDI ' as tabla from open.RESTPLDI  where REPDIDEX is not null union all
select INIT_AREA_EXPRESSION_ID  regla, 'WF_UNIT_TYPE ' as tabla from open.WF_UNIT_TYPE  where INIT_AREA_EXPRESSION_ID is not null union all
select ONLINE_EXEC_ID   regla, 'WF_UNIT ' as tabla  from open.WF_UNIT   where ONLINE_EXEC_ID is not null union all
select POS_EXPRESSION_ID  regla, 'WF_UNIT ' as tabla  from open.WF_UNIT   where POS_EXPRESSION_ID is not null union all
select PRE_EXPRESSION_ID  regla, 'WF_UNIT ' as tabla  from open.WF_UNIT   where PRE_EXPRESSION_ID is not null union all
select INIT_EXPRESSION_ID   regla, 'PS_PROD_TYPE_ATTRIB ' as tabla  from open.PS_PROD_TYPE_ATTRIB   where INIT_EXPRESSION_ID is not null union all
select REC_CONFIG_EXPRES_ID   regla, 'IN_INTERF_TYPE_BATCH ' as tabla from open.IN_INTERF_TYPE_BATCH  where REC_CONFIG_EXPRES_ID is not null union all
select SEN_CONFIG_EXPRES_ID   regla, 'IN_INTERF_TYPE_BATCH ' as tabla from open.IN_INTERF_TYPE_BATCH  where SEN_CONFIG_EXPRES_ID is not null union all
select POS_EXP_EXEC_ID  regla, 'PS_PROD_MOTI_ACTION ' as tabla  from open.PS_PROD_MOTI_ACTION   where POS_EXP_EXEC_ID is not null union all
select PRE_EXP_EXEC_ID  regla, 'PS_PROD_MOTI_ACTION ' as tabla  from open.PS_PROD_MOTI_ACTION   where PRE_EXP_EXEC_ID is not null union all
select EXP_EXEC_ID  regla, 'PS_PACKAGE_ACTION ' as tabla  from open.PS_PACKAGE_ACTION   where EXP_EXEC_ID is not null union all
select VALID_EXPRESSION   regla, 'GE_ATTRIBUTES ' as tabla  from open.GE_ATTRIBUTES   where VALID_EXPRESSION is not null union all
select CONFIG_EXPRESSION_ID   regla, 'GE_ACTION_MODULE ' as tabla from open.GE_ACTION_MODULE  where CONFIG_EXPRESSION_ID is not null union all
select BANCIDRE   regla, 'BANCO ' as tabla  from open.BANCO   where BANCIDRE is not null union all
select VALI_DOC_SELE_EXP_ID   regla, 'IN_INTERFACE_MESSAGE ' as tabla from open.IN_INTERFACE_MESSAGE  where VALI_DOC_SELE_EXP_ID is not null union all
select TARGET_MODULE_EXP_ID   regla, 'IN_INTERFACE_MESSAGE ' as tabla from open.IN_INTERFACE_MESSAGE  where TARGET_MODULE_EXP_ID is not null union all
select POS_CONFIG_EXPRES_ID   regla, 'IN_STATUS_TRANSITION ' as tabla from open.IN_STATUS_TRANSITION  where POS_CONFIG_EXPRES_ID is not null union all
select PRE_CONFIG_EXPRES_ID   regla, 'IN_STATUS_TRANSITION ' as tabla from open.IN_STATUS_TRANSITION  where PRE_CONFIG_EXPRES_ID is not null union all
select CONFIG_EXPRESSION_ID   regla, 'FM_MULTLVL_METHOD ' as tabla  from open.FM_MULTLVL_METHOD   where CONFIG_EXPRESSION_ID is not null union all
select CAFPREGL   regla, 'LE_CAFRPERF ' as tabla  from open.LE_CAFRPERF   where CAFPREGL is not null union all
select BEFORE_EXPRE_ID  regla, 'PS_MOTIVE_ACTION ' as tabla from open.PS_MOTIVE_ACTION  where BEFORE_EXPRE_ID is not null union all
select AFTER_EXPRE_ID   regla, 'PS_MOTIVE_ACTION ' as tabla from open.PS_MOTIVE_ACTION  where AFTER_EXPRE_ID is not null union all
select CONFIG_EXPRESSION_ID   regla, 'PS_WHEN_MOTIVE ' as tabla from open.PS_WHEN_MOTIVE  where CONFIG_EXPRESSION_ID is not null union all
select VALID_EXPRESSION_ID  regla, 'GE_ENTITY_ATTRIBUTES ' as tabla from open.GE_ENTITY_ATTRIBUTES  where VALID_EXPRESSION_ID is not null union all
select INIT_EXPRESSION_ID   regla, 'GE_ENTITY_ATTRIBUTES ' as tabla from open.GE_ENTITY_ATTRIBUTES  where INIT_EXPRESSION_ID is not null union all
select ENCOIDRE   regla, 'ENTICOBR ' as tabla from open.ENTICOBR  where ENCOIDRE is not null union all
select PLSUREAP   regla, 'PLANSUSC ' as tabla from open.PLANSUSC  where PLSUREAP is not null union all
select CONFIG_EXPRESSION_ID   regla, 'CC_PROM_DETAIL ' as tabla from open.CC_PROM_DETAIL  where CONFIG_EXPRESSION_ID is not null union all
select CONFIG_EXPRESSION_ID   regla, 'PS_WHEN_PACKAGE ' as tabla  from open.PS_WHEN_PACKAGE   where CONFIG_EXPRESSION_ID is not null union all
select CONFIG_EXPRESSION_ID   regla, 'PS_WHEN_MOTI_COMPON ' as tabla  from open.PS_WHEN_MOTI_COMPON   where CONFIG_EXPRESSION_ID is not null union all
select EXPRESSION_ID  regla, 'GW_PROC_PARAMETER ' as tabla  from open.GW_PROC_PARAMETER   where EXPRESSION_ID is not null union all
select VALID_EXPRESSION_ID  regla, 'GW_EVENT_ENTITY_ATR ' as tabla  from open.GW_EVENT_ENTITY_ATR   where VALID_EXPRESSION_ID is not null union all
select INIT_EXPRESSION_ID   regla, 'GW_EVENT_ENTITY_ATR ' as tabla  from open.GW_EVENT_ENTITY_ATR   where INIT_EXPRESSION_ID is not null union all
select BEFORE_EXPR_ID   regla, 'GW_EVENT_ENTITY ' as tabla  from open.GW_EVENT_ENTITY   where BEFORE_EXPR_ID is not null 
)
select regla, tabla
from base;
