WITH BASE AS(
      ...
      , base2 as(
            ...
            WHERE    name in ('LDCFLCJ','LDC_FTABLE','LDC_REPBR','LDCREVEING','LDCMTS','LDC_PROCMGCTT','LDCAMAM','LDCCAMAAD','LDEMAIL','CTCCE','LDCGENCOMASE','LDRDRC','FCDCRG','FGRCG','FMAREG','LDCDESCAST','LDORANPU','LDCSUPSXVAL','GENORDPER')
...
where ex.name in ('LDCFLCJ','LDC_FTABLE','LDC_REPBR','LDCREVEING','LDCMTS','LDC_PROCMGCTT','LDCAMAM','LDCCAMAAD','LDEMAIL','CTCCE','LDCGENCOMASE','LDRDRC','FCDCRG','FGRCG','FMAREG','LDCDESCAST','LDORANPU','LDCSUPSXVAL','GENORDPER')
