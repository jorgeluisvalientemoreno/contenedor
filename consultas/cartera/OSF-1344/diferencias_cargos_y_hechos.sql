...
SELECT '31/08/2023',
  ...
  FROM
       (
        ...
        WHERE   movifeco >= to_date(to_char('30/08/2023' || ' 00:00:00') , 'dd-mm-yyyy hh24:mi:ss') -- to_date('01/02/2017','dd/mm/yyyy')
                ...
                AND movifeco <= to_date(to_char('31/08/2023' || ' 23:59:59') , 'dd-mm-yyyy hh24:mi:ss') -- to_date('28/02/2017','dd/mm/yyyy')
        ...
        where c.cargcaca = csc.cacacodi
          ...
          and c.cargfecr BETWEEN to_date(to_char('30/08/2023' || ' 00:00:00') , 'dd-mm-yyyy hh24:mi:ss') -- to_Date('01/02/2017 00:00:00', 'dd/mm/yyyy hh24:mi:ss')
                             AND to_date(to_char('31/08/2023' || ' 23:59:59') , 'dd-mm-yyyy hh24:mi:ss') -- to_Date('28/02/2017 23:59:59', 'dd/mm/yyyy hh24:mi:ss')
