...
order_persca as (select ldc_susp_persecucion.susp_persec_order_id as "ORDEN", 
                        ...
                        ldc_susp_persecucion.susp_persec_producto as "PRODUCTO",
                        ...
                        inner join open.or_order on or_order.order_id = ldc_susp_persecucion.susp_persec_order_id
                        ...
                        inner join open.cuencobr on cuencobr.cuconuse = ldc_susp_persecucion.susp_persec_producto 
                        where ldc_susp_persecucion.susp_persec_order_id is not null
                        group by ldc_susp_persecucion.susp_persec_order_id, or_order.order_status_id ||' : '|| or_order_status.description, 
                                 or_order.task_type_id ||' : '|| initcap(or_task_type.description), ldc_susp_persecucion.susp_persec_producto,
