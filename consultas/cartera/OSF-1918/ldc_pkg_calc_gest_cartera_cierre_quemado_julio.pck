  ...
  *******************************************************************************************************************************************************/
        ...
        CURSOR cuDetaProd(dtcufein    DATE,
          ...
          SELECT nuanoact,
            ...
            FROM (
                        ...
                        ,
                         nvl(
                                (
                                    ...
                                    WHERE nuano = 2024 --nuanoact
                                    AND numes = 7 --numesact
                         ...
                         NVL((SELECT nvl(r.deuda_no_corriente, 0) +
                              ...
                              WHERE nuano = decode((7 /*numesact*/-1),0,(2024 /*nuanoact*/-1),2024 /*nuanoact*/) -- caso:846
                                AND numes = decode((7 /*numesact*/-1),0,12,(7 /*numesact*/-1)) -- caso:846
                                AND producto = x.product_id
                   ...
                   and l.nuano = decode((7 /*numesact*/-1),0,(2024 /*nuanoact*/-1),2024 /*nuanoact*/)
                   and l.numes = decode((7 /*numesact*/-1),0,12,(7 /*numesact*/-1))
                     --
                  )
  ...
  PROCEDURE ldc_legaordergestcart_hilos(INUHILO    NUMBER,
    ...
    08/08/2023		OSF-1918	  jpinedc			Se modifica cuOrderR  agregando minCucoSaPe
                                                    para calcular la cuenta de cobro con saldo mas antigua
