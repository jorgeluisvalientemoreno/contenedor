            ...
            FROM (
                        ...
                        ,
                                    ...
                                    (
                                        ...
                                        (
                                            ...
                                            (
                                                ...
                                                AND cci.cucocodi >
                                                (
                                                    SELECT  MIN(cucocodi) cucocodi
                                                    FROM cuencobr ccm
                                                    WHERE (nvl( ccm.cucovare,0 ) + nvl(ccm.cucovrap,0)) > 0
                                                    AND ccm.cucofeve < sysdate
                                                    AND ccm.cuconuse = cci.cuconuse
                                                )
                                                AND cci.cucocodi <
                                                (
                                                    SELECT NVL(MIN(cucocodi),9999999999999999) cucocodi
                                                    FROM cuencobr ccnv
                                                    WHERE ccnv.cucofeve > sysdate
                                                    AND ccnv.cuconuse = cci.cuconuse
                                                )
                         ...
                         NVL((SELECT nvl(r.deuda_no_corriente, 0) +
                              ...
                              WHERE nuano = decode((6/*numesact*/-1),0,(2024/*nuanoact*/-1),2024/*nuanoact*/) -- caso:846
                                AND numes = decode((6/*numesact*/-1),0,12,(6/*numesact*/-1)) -- caso:846
                                AND producto = x.product_id
                   ...
                   and l.nuano = decode((6/*numesact*/-1),0,(2024/*nuanoact*/-1),2024/*nuanoact*/)
                   and l.numes = decode((6/*numesact*/-1),0,12,(6/*numesact*/-1))
                     --
                  )
