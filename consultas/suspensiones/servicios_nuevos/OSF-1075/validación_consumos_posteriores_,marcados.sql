-- Validación Consumos posteriores marcados
...
select p.product_id "Producto", sesucico "Ciclo consumo", trunc(o.execution_final_date) "Fecha suspension",
...
(      SELECT 
      ...
      AND ca.cargpeco = pc.pecscons)  "Consumos posteriores"
