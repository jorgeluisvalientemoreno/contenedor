...
begin
  delete from open.OR_UNI_ITEM_BALA_MOV_COPIA2 /*where operating_unit_id=1518*/;
  commit;
end;
/
declare
...
where m.id_items_documento in (418329, 418350, 418464, 418581,418585, 418751, 418856, 419127, 419144)
...
declare
  ...
  AND m.OPERATING_UNIT_ID IN (1850,1854,1878,1910,2024,2445,1518,1512,1515,1520,1521,1522,1527,1885,2199,2302,2402)
