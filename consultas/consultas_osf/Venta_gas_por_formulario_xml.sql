...
BEGIN
  ...
  inutipoformulario       := 1;
  inunumeroformulario     := 13867143;
  isbobservacion          := 'Ventas Digitales OSF Pruebas';
  inudireccionid          := 293599;
  ...
  inutipopredio           := NULL;--2;
  inuestadoley            := NULL;--1;
  inupromicion            := 419;--86; --84;
  inuplancomercial        := 5;--4;
  inuvalortotal           := 1452653;--2000256;--1926555
  inuplanfinanciacion     := NULL;--23;
  inucuotaincial          := 1452653;
  inunumerocuotas         := NULL;--72;
  inucuotamensual         := NULL;--47910.95;
  inuformapago            := NULL;--13;
