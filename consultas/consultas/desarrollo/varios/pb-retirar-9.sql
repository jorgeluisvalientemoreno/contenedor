WITH BASE AS(
      ...
      , base2 as(
            ...
            WHERE    name in ('LDCREMP','LDC_PROCNOUORT','LDC_PROCCARECI','LDCIMCG','LDCAAN','LDCRA','LDCCUS','LDCTEFAM','LDC_LDRREPDIRCOBRO','LDCREVPM','LDCTDSC','PROCARGALDRVOLU','LDCVEFM','LDCCTI','LDCCIS','LDCGENCAR','LDCGOV','LDCGOE')
...
where ex.name in ('LDCREMP','LDC_PROCNOUORT','LDC_PROCCARECI','LDCIMCG','LDCAAN','LDCRA','LDCCUS','LDCTEFAM','LDC_LDRREPDIRCOBRO','LDCREVPM','LDCTDSC','PROCARGALDRVOLU','LDCVEFM','LDCCTI','LDCCIS','LDCGENCAR','LDCGOV','LDCGOE')
