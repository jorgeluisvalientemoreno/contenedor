WITH BASE AS(
      ...
      , base2 as(
            ...
            WHERE    name in ('FILOT','LDALS','LDLQS','LDRQS','FIAPR','LDDEA','LDGLS','LDTSA','LDDBS','FGMD','CEDR','PBRRC','CCSMC','RCBLD','LDRAS','RCEPP')
...
where ex.name in ('FILOT','LDALS','LDLQS','LDRQS','FIAPR','LDDEA','LDGLS','LDTSA','LDDBS','FGMD','CEDR','PBRRC','CCSMC','RCBLD','LDRAS','RCEPP')
