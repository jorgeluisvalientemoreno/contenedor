WITH BASE AS(
      ...
      , base2 as(
            ...
            WHERE    name in ('RPSUI','LDC_PROCCARTCONCCIERRE','IENCO','DLRUSEX','CTCAN','RUTEROSCRM','LDCAC','LDCPA','LDCIREVCLACARTRO','LDCCT','ERARP','LDCPAA','LDRPLAM','LDC_LDRBTAF','LDCIPROVINGRERO','LDRIRBRI')
...
where ex.name in ('RPSUI','LDC_PROCCARTCONCCIERRE','IENCO','DLRUSEX','CTCAN','RUTEROSCRM','LDCAC','LDCPA','LDCIREVCLACARTRO','LDCCT','ERARP','LDCPAA','LDRPLAM','LDC_LDRBTAF','LDCIPROVINGRERO','LDRIRBRI')
