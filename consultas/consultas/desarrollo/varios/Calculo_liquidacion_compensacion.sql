   ...
   PROCEDURE CREATECHARGES
    ...
    BEGIN
     ...
     /*   PKINSTANCEDATAMGR.GETCG_SUBSSERVICE( NUSUBSSERVICE );        
        ...
        NUSUBSSERVICE:=3706089;
        NUSERVICE:=7014;
        NUCONCEPT:=25;
        NUPERICOSEITERAID:=61963;
        NUPERICOSEACTUALID:=61963;
        DTINSTALLDATE:=to_date('27/08/2012 00:00:00','dd/mm/YYYY hh24:mi:ss');
        
        RCCOMPSESU := PKBCCOMPSESU.FRCMAINCOMPBYPRODDATES
        (
            NUSUBSSERVICE,  
            to_date('06/03/2017 18:34:21','dd/mm/YYYY hh24:mi:ss'),        
            to_date('06/03/2017 18:34:21','dd/mm/YYYY hh24:mi:ss')         
        );
...
/
 ...
 select * from open.ge_error_log where 
ERROR_LOG_ID= 436490885
 and TIME_STAMP>sysdate-1 and OS_USER='alexanderb';
 
ERROR_LOG_ID, MESSAGE_ID, TIME_STAMP, DB_USER, OS_USER, SESSION_ID, APPLICATION, METHOD, CALL_STACK, ERROR_STACK, DESCRIPTION, MACHINE, TERMINAL, CLIENT_IP, STATUS, ACTION_DATE, ACTION_ADMIN
 436490885	-1476	30/06/2017 11:06:27	OPEN	alexanderb	204695195	SQL Developer		"FA_BODiscountTimeOutServ.CreateCharges
DiscountTimeOutServ"	"ORA-01476: divisor is equal to zero
"	ORA-01476: divisor is equal to zero [436490885]	CTGP-ABT	unknown	172.21.4.56	1		