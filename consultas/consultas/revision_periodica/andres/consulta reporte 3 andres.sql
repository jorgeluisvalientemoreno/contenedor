...
where ce.estimated_end_date>='01/03/2020'
  ...
  and ce.review_date=(select max(c2.review_date) from open.pr_certificate c2 where c2.estimated_end_date>='01/03/2020'  and c2.register_date<'01/03/2020' and ce.product_id=c2.product_id)
--979210
--946003
