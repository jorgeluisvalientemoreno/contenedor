...
and      ((select sum(c3.cargunid) from cargos c3 
        where c3.cargnuse = ss.sesunuse and c3.cargpeco in (select pc4.pecscons from pericose pc4 where pc4.pecscico = ss.sesucico and pc4.pecsfecf < pc1.pecsfecf) and c3.cargconc = 31 and c3.cargpefa >= c2.cargpefa
