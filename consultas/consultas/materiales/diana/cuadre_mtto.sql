...
begin
  delete from open.OR_UNI_ITEM_BALA_MOV_COPIA2  c;-- WHERE movement_type!='N' and c.operating_unit_id  in (3005);
  commit;
end;
/
              ...
              IF reg2.movement_type = 'D' then
                ...
                ELSE
                    ...
                    if open.daor_operating_unit.fnugetoper_unit_classif_id(reg2.target_oper_unit_id,null)=11 /*and reg2.total_value=0*/ then 
                       ...
                       if cuDatosTrasladoSap%found and nvl(rgIncremento.VALOR,0) <=  ValorJulio then
					  
							CantidadItem:=reg2.amount;--nvl(CantidadItem,0)+nvl(rgIncremento.CANT,0);
