select o.task_type_id,
       ...
       o.legalization_date
  from or_order o
left join or_task_type t on o.task_type_id = t.task_type_id
 ...
 Where o.order_id in (110437031)
group by (o.task_type_id,t.description,o.order_id, o.order_status_id,
       o.causal_id,c.description ,c.class_causal_id  ,
       o.operating_unit_id,p.person_id,pe.name_,
       o.created_date,o.legalization_date)