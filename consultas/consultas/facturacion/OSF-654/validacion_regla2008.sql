...
(select count ( distinct (c1.cosspecs)) from open.conssesu c1 
           ...
           and c1.cosscoca = 0 
           and c1.cossfere between '01/07/2022' and '01/01/2023'
...
(select count ( distinct (o2.order_id)) from open.or_order o2, open.or_order_activity a2
           ...
           and o2.created_date<'28/02/2023' )ot_pend_CM,substrc( a.value1,9,4) lectura ,
...
and r.legalization_date >= '28/02/2023 12:30:00' --CAMBIARRRRR
