...
inner join open.perifact@osfpl p on p.pefacodi=c.cosspefa and p.pefaano=2023 and p.pefames=11 and trunc(c.cossfere) between trunc(p.pefafimo) and trunc(p.pefaffmo)
