--registrar_pago_por_bd
DECLARE
    onuErrorCode NUMBER;
    osbErrorMessage VARCHAR(2000);
    osbxmlcoupons VARCHAR(2000);
BEGIN
    "OPEN".LDCI_PKBSSRECA.proPaymentRegister(1, '<?xml version="1.0" encoding="utf-8" ?><Pago_Cupon><Cupon>227055283</Cupon></Pago_Cupon>', '<?xml version="1.0" encoding="utf-8" ?>
<Informacion_Pago>
  <Conciliacion>
    <Cod_Conciliacion></Cod_Conciliacion>
    <Entidad_Conciliacion>700</Entidad_Conciliacion>
    <Fecha_Conciliacion>06-02-2024</Fecha_Conciliacion>
  </Conciliacion>
  <Entidad_Recaudo>700</Entidad_Recaudo>
  <Punto_Pago>1</Punto_Pago>
  <Valor_Pagado>50000</Valor_Pagado>
  <Fecha_Pago>06-02-2024</Fecha_Pago>
