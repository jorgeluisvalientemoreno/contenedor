select notas.notasusc  "Contrato",cargcodo "Cons documento",  
       ...
       initcap(cargos.cargprog)  "Programa",
...
where servsusc.sesususc in (1117714)
and notas.notafecr >= '30/08/2023'
and cargos.cargsign = 'DB'
group by notas.notasusc,notanume, servsusc.sesunuse, notas.notafecr, notas.notaobse,
notas.notacons || '-  ' || ge_document_type.description, cargos.cargcuco, cargos.cargprog, 
