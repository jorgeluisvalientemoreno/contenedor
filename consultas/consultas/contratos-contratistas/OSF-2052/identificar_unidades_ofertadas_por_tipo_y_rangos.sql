--identificar_unidades_ofertadas_por_tipo_y_rangos
select distinct(x.unidad_operativa), u.contractor_id, u.name
  ...
  left join open.ldc_zona_ofer_cart z on z.id_zona_oper = x.zona_ofertados
   ...
   and    x.unidad_operativa in (4250,4272,4277,4251,4283,4280)
   and   t.tipo_ofertado = 4
-- and   x.unidad_operativa = 3608 
