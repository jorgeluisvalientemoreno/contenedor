SELECT TIPOMOVI, timo, concclco, Desc_Clasi, PRODUCTO, Desc_Serv, CATEGO, CAUSAL, Des_Caca, 
  ...
  FROM ( /*Facturaci¢n por Concepto*/
        SELECT movitimo TIPOMOVI, 'Facturaci¢n por Concepto' TIMO, 
         ...
         GROUP BY moviserv, movicate, c.concclco, movitimo, movicaca
    UNION
...
group by TIPOMOVI, timo, concclco, Desc_Clasi, PRODUCTO, Desc_Serv, CATEGO, CAUSAL, Des_Caca
