select pefacicl, cargtipr, clcocodi, clcodesc, cargprog, procdesc, CausadeCargo, NombreCausadeCargo,   
       Concepto, Nombreconcepto, cargsign, Categoria, fecha, sum(valor) valor,   
       localidad
  from (   
        ...
        where c.cargcaca = csc.cacacodi   
          ...
          and c.cargfecr between to_date(to_char('09/02/2015 00:00:00'),'dd/mm/yyyy hh24:mi:ss')   
                             AND to_date(to_char('28/02/2015 23:59:59'),'dd/mm/yyyy hh24:mi:ss')   
        ...
        where c.cargcaca = csc.cacacodi   
          ...
          and cargtipr = 'A'   
          and cargsign NOT IN ('PA','AP')   
        group by ss.sesususc,pefacicl, cargtipr, clcocodi, clcodesc, cargprog, upper(procdesc), CARGCACA,csc.cacadesc,
                 CARGCONC,co.concdesc, CARGSIGN,CUCOCATE, trunc(FACTFEGE)
)   
group by pefacicl, cargtipr, clcocodi, clcodesc, cargprog, procdesc, CausadeCargo, NombreCausadeCargo,   
       Concepto, Nombreconcepto, cargsign,Categoria, fecha,  localidad
