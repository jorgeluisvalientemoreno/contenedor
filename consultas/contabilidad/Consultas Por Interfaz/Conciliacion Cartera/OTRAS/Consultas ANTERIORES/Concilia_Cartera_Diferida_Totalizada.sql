...
SELECT /*PRODUCTO,*/ SERVICIO, (DB - CR) VALOR, '2_MD' TIPO
  FROM (
        ...
        WHERE   modifech > to_date('01/03/2015 00:00:00','dd/mm/yyyy hh24:mi:ss')
                AND modifech <= to_date('15/03/2015 23:59:59','dd/mm/yyyy hh24:mi:ss')
