select cargnuse, cargdoso, cargsign, sum(cargvalo) TOT_CARGOS, TOT_DIFE
  from open.cargos, 
       (SELECT SERVICIO, caccnuse, sum(VALOR) TOT_DIFE
 ...
 where cargcuco != -1
   ...
   and cargnuse = u.caccnuse
group by cargnuse, cargdoso, cargsign, TOT_DIFE
