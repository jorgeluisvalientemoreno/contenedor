...
'N'
,
'SELECT  CLCOCODI "CÓDIGO" , CLCODESC "DESCRIPCIÓN"  FROM IC_CLASCONT WHERE CLCODOMI = '|| chr(39) ||'C'|| chr(39) ||' ORDER BY CLCODESC ASC '
,
'N'
,
'CÓDIGO'
...
'DESCRIPCIÓN'
,
'CLCOCODI Código|CLCODESC Descripción|'
,
'FROM IC_CLASCONT|'
,
...
'N'
,
'SELECT  CICLCODI "CÓDIGO" , CICLDESC "DESCRIPCIÓN"  FROM CICLO ORDER BY CICLCODI ASC '
,
'N'
,
'CÓDIGO'
