...
select Product_id, (select s.subscriber_name|| ' ' || s.subs_last_name
       ...
       Total Costo, Ing_otro, Ing_Int_Mig, Ing_CxC_Mig, Ing_RP_Mig, ING_INT_OSF, ING_CXC_OSF, ING_RP_OSF, 
       ING_INT_CON, ING_CXC_CON, ING_RP_CON
  from (
...
from ( 
      select tipo, product_id, acta, orden, titr, concept, total, t.clctclco, i.clcodesc, contratista, nombre, fec_lega,
        ...
        from (
              SELECT 'ACTA_F' tipo, o.product_id, a.id_acta acta, a.id_orden orden, o.task_type_id titr, ot.concept, 
                     ...
                     trunc(ro.legalization_date) fec_lega
                FROM OPEN.ge_detalle_acta a, open.or_order_activity o, open.mo_packages m, open.ge_acta ac, open.or_order ro,
              ...
              Group by 'ACTA_F', o.product_id, a.id_acta, a.id_orden, o.task_type_id, ot.concept, co.id_contratista, 
                       ta.nombre_contratista, trunc(ro.legalization_date)
              UNION ALL
              SELECT 'ACTA_N' tipo, o.product_id, null acta, o.order_id orden, o.task_type_id titr, ot.concept, sum(value) Total,
                     null contratista, null nombre, trunc(r.legalization_date) fec_lega
               ...
               where r.legalization_date < '01-08-2015'
                 ...
                 and (it.item_classif_id != 23 or it.items_id = 4001293)
              Group by 'ACTA_N', o.product_id, null, o.order_id, o.task_type_id, ot.concept, null, null, trunc(r.legalization_date)
              UNION ALL
              SELECT 'S_ACTA' tipo, o.product_id, null acta, o.order_id orden, o.task_type_id titr, ot.concept, 
                     sum(value) Total, null contratista, null nombre, trunc(r.legalization_date) fec_lega
                FROM open.or_order_activity o, open.mo_packages m, open.or_order_items oi, open.or_order r, open.ic_clascott tt,
                     open.or_task_type ot, open.ge_items it
               where r.legalization_date < '01-08-2015'
                 and r.order_status_id = 8
                 ...
                 and oi.items_id    = it.items_id 
                 and (it.item_classif_id != 23 or it.items_id = 4001293)                                
              Group by 'S_ACTA', o.product_id, null, o.order_id, o.task_type_id, ot.concept, null, null, trunc(r.legalization_date)
              UNION ALL -- COSTOS REPORTADOS MESES ANTERIORES                     
              select distinct 'ANTES' tipo, h.hcecnuse product_id, null acta, 0 orden, 12149 titr, 0 concept, 0 Total, null contratista, 
                     null nombre, null fec_lega
               from open.hicaesco h 
              where h.hcecfech >= '01-07-2015' and h.hcecfech < '01-08-2015' and h.hcecserv = 7014
                           ...
                           from (
                                SELECT distinct o.product_id
                                  FROM OPEN.ge_detalle_acta a, open.or_order_activity o, open.mo_packages m, 
                                       open.ge_acta ac, 
                                       open.ic_clascott tt, open.or_task_type ot, open.ge_contratista ta
                                 where ac.extern_pay_date >= '01-07-2015'
                                   and ac.extern_pay_date <  '01-08-2015'
                                   and ac.extern_invoice_num is not null
                                   and ac.id_acta   = a.id_acta
