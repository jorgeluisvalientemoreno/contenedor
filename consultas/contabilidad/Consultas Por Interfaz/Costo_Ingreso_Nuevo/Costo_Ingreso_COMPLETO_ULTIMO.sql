        ...
        from (
              ...
              from  (
                ...
                where ac.extern_pay_date >= '&FECHA_INICIAL'
                 ...
                 and tt.clctclco not in (311,246,303,252)
...
/*  where (nvl(Ing_Int_Mig,0) = 0 AND nvl(Ing_CxC_Mig,0) = 0 AND nvl(Ing_RP_Mig,0) = 0 AND 
         nvl(ING_INT_OSF,0) = 0 AND nvl(ING_CXC_OSF,0) = 0 AND nvl(ING_RP_OSF,0) = 0 AND
         nvl(ING_INT_CON,0) = 0 AND nvl(ING_CXC_CON,0) = 0 AND nvl(ING_RP_CON,0) = 0)*/
