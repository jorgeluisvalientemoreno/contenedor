...
from ( 
      select tipo, product_id, acta, orden, titr, concept, total, clctclco, icc.clcodesc, contratista, nombre, fec_lega,
        ...
        from (
              ...
              UNION
              SELECT 'ACTA_N' TIPO, oa.product_id, a.id_acta acta, ac.extern_invoice_num factura, trunc(ac.extern_pay_date) fecha, 
              ...
              select distinct 'ANTES' tipo, h.hcecnuse product_id, null acta, NULL FACTURA, NULL FECHA,  0 orden, 
                     12149 titr, 0 concept, 0 Total, null contratista, 
                     null nombre, null fec_lega, null
               from open.hicaesco h 
              where h.hcecfech >= '01-07-2015' and h.hcecfech < '01-08-2015' and h.hcecserv = 7014
