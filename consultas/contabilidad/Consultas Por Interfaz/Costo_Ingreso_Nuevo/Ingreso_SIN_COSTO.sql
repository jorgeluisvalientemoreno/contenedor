        ...
        select cargnuse, cargconc, sum(valor) valor
          from (
                ...
                where c.cargnuse = ss.sesunuse
                  ...
                  and concclco in (4,13,17,19,22,24,27,28,30,36,37,81,108,109,110,111,112,113,118,138,169,193,203,291,400,401)
        ...
        select cargnuse, cargconc , sum(valor) valor
          from (
                ...
                where c.cargcaca = csc.cacacodi
                  ...
                  --and cargconc in (19,30,291,674)
                  and c.cargfecr between to_date('01/09/2015 00:00:00','dd/mm/yyyy hh24:mi:ss') 
                                     and to_date('30/09/2015 23:59:59','dd/mm/yyyy hh24:mi:ss')
                  and concclco in (4,13,17,19,22,24,27,28,30,36,37,81,108,109,110,111,112,113,118,138,169,193,203,291,400,401)
                  AND CARGCUCO > 0
                  and cargtipr = 'P'
