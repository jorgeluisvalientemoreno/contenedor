  ...
  FROM (select TIPO,
           ...
           from (select TIPO,
                                    ...
                                    where m.invmsesu not in
                                          (select h.hcecnuse
                                            ...
                                            where h.hcececan = 96
                                              and h.hcececac = 1
                                              and hcecserv = 7014
                                              and h.hcecfech <= '31-10-2016 23:59:59'
                                                                 ...
                                                                 and h.hcecfech =
                                                                     (select max(st.hcecfech)
                                                                       ...
                                                                       where st.hcecnuse = product_id
                                                                         and st.hcecfech <= '31-10-2016 23:59:59')) est_tecnico,
                                                             sesucate,
                                               ...
                                               from (select cargnuse,
                                                             ...
                                                             (select count(*) from open.or_order_activity act, open.or_order oo
                                                               where act.package_id = substr(cargdoso,4,8)
                                                                 ...
                                                                 and oo.created_date <= '31-10-2016 23:59:59'
                                                ...
                                                and ort.product_id not in
                                                    (select h.hcecnuse
                                                      ...
                                                      where h.hcecnuse =
                                                           ...
                                                           --and h.hcececan = 96
                                                        and h.hcececac = 1
                                                        and h.hcecfech <= '31-10-2016 23:59:59')) xx
                                     group by cebe,
                                              loca,
                                              product_id,
                                              cargconc,
                   ...
                   where nuse not in
                         (select h.hcecnuse
                            from open.hicaesco h
                           where h.hcecfech <= '31-10-2016 23:59:59'
                             and h.hcecnuse = nuse
