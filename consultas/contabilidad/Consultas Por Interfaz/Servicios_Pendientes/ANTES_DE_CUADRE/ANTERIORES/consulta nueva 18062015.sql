select h.hcecnuse,
       ...
       sum(decode(l.invmconc, 674, l.invmvain)) REV_PRE,
       sum(decode((SELECT 1
                    ...
                    WHERE OR_related_order.rela_order_type_id in (4, 13) -- Tipo de Orden, de Apoyo o Relacionada
                      ...
                      AND OR_order.legalization_date > '08-02-2015' AND OR_order.legalization_date < '01-06-2015'
