...
select  --cebe, (select g.geo_loca_father_id from open.ge_geogra_location g where g.geograp_location_id = loca) DEPA,
        ...
        cargnuse, /*product_id NUSE,*/ --sesucate CATE, EST_TECNICO, DES_TECNICO, cargconc CONCEPTO, --o.concdesc,
        ...
        select distinct ort.product_id, cargnuse, cargconc, cargcaca, cargvalo, ventas, SOLICITUD,
               ...
               (decode((SELECT 1
                         ...
                         WHERE OR_related_order.rela_order_type_id in (4, 13) -- Tipo de Orden, de Apoyo o Relacionada
                           ...
                           AND OR_order.legalization_date > '08-02-2015' AND OR_order.legalization_date < '01-05-2015'
                           AND OR_order_activity.product_id = ort.product_id --cargnuse
          ...
          from
               ...
               ), open.or_order_activity ort--, open.suscripc c, open.servsusc s, open.estacort st
...
group by /*cebe, loca,*/cargnuse, /*product_id, */cargconc, cargvalo, ventas, --EST_TECNICO, DES_TECNICO, sesucate, --o.concdesc,
