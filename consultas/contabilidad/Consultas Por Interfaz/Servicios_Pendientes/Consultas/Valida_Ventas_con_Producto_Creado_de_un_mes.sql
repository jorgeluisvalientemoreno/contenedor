...
select  'CON_PRODUCTOS' TIPO, 
        ...
        (decode((SELECT 'X'
                  ...
                  WHERE OR_related_order.rela_order_type_id in (4, 13) -- Tipo de Orden, de Apoyo o Relacionada
                    ...
                    AND ROWNUM = 1), 'X', ((cargvalo/ventas)*-1), 0)) Int_Reportada
  from
       (
        select distinct ort.product_id, cargnuse, cargconc, cargcaca, cargvalo, ventas, SOLICITUD,
               ...
               sesucate, mo.package_type_id TIPO_SOLICITUD
          from
...
-- where est_tecnico != 1       
group by cebe, loca, product_id, cargconc, cargvalo, ventas, EST_TECNICO, sesucate, TIPO_SOLICITUD
