      ...
      (
       ...
       (select hcececac from open.hicaesco h
         where h.hcecnuse = nuse
           ...
           and h.hcecfech >= '01-09-2016 00:00:00' -- fecha inicial del mes de proceso
           and h.hcecfech <= '30-09-2016 23:59:59' -- fecha final del mes de proceso
       ...
       (select sum(decode(cargsign, 'DB',cargvalo,'AS', cargvalo,cargvalo*-1)) valor
         ...
         where c.cargnuse = nuse
           ...
           and c.cargfecr between '01-09-2016 00:00:00'   -- fecha inicial del mes de proceso
                              and '30-09-2016 23:59:59' -- fecha final del mes de proceso
           and CARGCUCO > 0
           and cargtipr = 'P'
                ...
                (select sum(decode(cargsign, 'DB',cargvalo,'AS', cargvalo, cargvalo*-1)) valor
                  ...
                  where c.cargnuse = nuse
                    ...
                    and c.cargfecr between '09-02-2015'             -- fecha fija
                                       and '31-08-2016 23:59:59' -- fecha final mes anterior
                    and CARGCUCO > 0
                    and cargtipr = 'P'
                    and cargsign NOT IN ('PA','AP')
                    and substr(cargdoso,1,1) IN ('N')
                   ...
                   select 'PROD_MIGRADOS' TIPO,
                          ...
                          decode((SELECT 1
                                   ...
                                   WHERE OR_related_order.rela_order_type_id in (4, 13) --Tipo de Orden, de Apoyo o Relacionada
                                     ...
                                     AND OR_order.legalization_date >= '01-09-2016 00:00:00' -- fecha inicial del mes de proceso
                                     AND OR_order.legalization_date <= '30-09-2016 23:59:59' -- fecha final del mes de proceso
                          ...
                          select (select l.celocebe
                                 ...
                                 decode((SELECT 1
                                          ...
                                          WHERE OR_related_order.rela_order_type_id in (4, 13)-- Tipo de Orden, de Apoyo o Relacionada
                                            ...
                                            AND OR_order.legalization_date <= '31-08-2016 23:59:59' -- fecha final mes anterior
       ...
       select 'CON_PRODUCTOS' TIPO, cebe,
              ...
              (decode((SELECT 'X'
                        ...
                        WHERE OR_related_order.rela_order_type_id in (4, 13) --Tipo de Orden, de Apoyo o Relacionada
                          ...
                          AND mo_packages.package_type_id in (323, 100229)
                          AND OR_order.order_id = OR_related_order.related_order_id
                          AND OR_order.legalization_date >= '01-09-2016' -- fecha fija
                          AND OR_order.legalization_date <= '30-09-2016 23:59:59'
                          AND OR_order_activity.product_id = xx.product_id
                          AND cargconc in (30,291)
         ...
         where VENTAS > 0
           ...
           and ort.product_id not in (select h.hcecnuse from open.hicaesco h
                                       where h.hcecnuse = ort.product_id
                                         and h.hcececac = 1 and h.hcecfech <= '31-08-2016 23:59:59') -- fecha final mes anterior
       ) xx
...
where nuse not in (select h.hcecnuse from open.hicaesco h
                    where h.hcecfech <= '31-08-2016 23:59:59' -- fecha final mes anterior
       ...
       select  'CON_PRODUCTOS' TIPO,
              ...
              (decode((SELECT 'X'
                        ...
                        WHERE OR_related_order.rela_order_type_id in (4, 13) --Tipo de Orden, de Apoyo o Relacionada
                          ...
                          AND mo_packages.package_type_id in (323, 100229)
                          AND OR_order.order_id = OR_related_order.related_order_id
                          AND OR_order.legalization_date >= '01-09-2016'
                          AND OR_order.legalization_date <= '30-09-2016 23:59:59'
                          AND OR_order_activity.product_id = xx.product_id
                          AND cargconc in (30,291)
                          AND ROWNUM = 1), 'X', ((cargvalo/ventas)*-1), 0)) INGRESO_MES
        ...
        select distinct ort.product_id, cargnuse, cargconc, cargcaca, cargvalo, ventas, SOLICITUD,
               ...
               (select h.hcececac from open.hicaesco h
                 where h.hcecnuse = product_id
                   and h.hcecfech = (select max(st.hcecfech) from open.hicaesco st
                                      where st.hcecnuse = product_id
                                        and st.hcecfech <= '30-09-2016 23:59:59')) -- fecha final del mes de proceso
               est_tecnico,
               sesucate, mo.package_type_id TIPO_SOLICITUD, fec_cargo
          from
               (select cargnuse, cargconc, cargcaca, cargvalo,
                 ...
                 where cargcuco != -1
                   ...
                   and CARGCUCO =  CUCOCODI
                   and factcodi =  CUCOfact
                   and FACTFEGE BETWEEN '01-09-2016 00:00:00' -- fecha incial del mes de proceso
                                    and '30-09-2016 23:59:59' -- fecha final del mes de proceso
                   and cargconc in (19,30,674,291)
                   and cargtipr =  'A'
  ...
  from (
        select (select l.celocebe
             ...
             where cargcuco != -1
               ...
               and CARGCUCO =  CUCOCODI
               and factcodi =  CUCOfact
               and FACTFEGE BETWEEN '01-09-2016 00:00:00' -- fecha inicial del mes de proceso
                                and '30-09-2016 23:59:59' -- fecha final del mes de proceso
               and cargconc in (19,30,674,291)
               and substr(cargdoso, 4, 8) = mo.package_id
               and cargtipr =  'A'
