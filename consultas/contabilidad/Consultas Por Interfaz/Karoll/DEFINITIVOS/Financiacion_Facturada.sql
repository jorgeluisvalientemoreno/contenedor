...
select substr(cargdoso, 1, 2) Tipo, cargcaca, cargsign, cargconc, co.concdesc, sum(cargvalo)
 ...
 where c.cargcaca = csc.cacacodi    
   ...
   and cargtipr  = 'A'    
   and cargsign  not in ('TS', 'ST', 'DV')
   and concclco  in (56,57,58,59,86,87,88,98,102,103,120,121,126)
   and cargcaca  = 51 and cargdoso like 'ID%'  
group by substr(cargdoso, 1, 2), cargcaca, cargsign, cargconc, co.concdesc
