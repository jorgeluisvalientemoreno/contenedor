-- Internas MIGRADAS
SELECT m.invmsesu, sesucate, invmconc, o.concdesc, 'DB', sum(invmvain), l.celocebe  
...
where m.invmsesu in (SELECT DISTINCT OR_order_activity.product_id
                       ...
                       WHERE OR_related_order.rela_order_type_id in (4, 13) -- Tipo de Orden, de Apoyo o Relacionada
                         ...
                         AND OR_order.legalization_date >= '01-10-2015'
                         AND OR_order.legalization_date <= '31-10-2015 23:59:59')
