...
select 'Ing_Interna_Osf' Tipo, orden, product_id, SESUCATE, CARGCONC, CONCDESC, /*SUM*/(VALOR) TOTAL, 0 Reportada, /*SUM*/(VALOR) Contabilizar, CEBE
  FROM (
select (select l.celocebe
       ...
       product_id, orden, package_type_id, sesucate, sesusuca, cargconc, concdesc, Vr_Unitario Valor
