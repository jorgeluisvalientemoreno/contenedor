          ...
          FROM (select TIPO,
                  ...
                  from (select TIPO,
                          ...
                          from (select 'PROD_MIGRADOS' TIPO,
                                  ...
                                  from (select (select l.celocebe
                                          ...
                                          from open.ldci_ingrevemi m,
                                               ...
                                               open.suscripc       s,
                                               open.estacort       st
                                         where m.invmsesu not in (select h.hcecnuse
                                                                    from open.hicaesco h
                                                                   where h.hcececan = 96
                                                                     and h.hcececac = 1
                                                                     and hcecserv = 7014
                                                                     and h.hcecfech <= '30-04-2017 23:59:59'
                                                                    ...
                                                                    and h.hcecfech =
                                                                        (select max(st.hcecfech)
                                                                          ...
                                                                          where st.hcecnuse = product_id
                                                                            and st.hcecfech <= '30-04-2017 23:59:59')) est_tecnico,
                                                                sesucate,
                                                  ...
                                                  from (select cargnuse,
                                                               ...
                                                               (select count(*)
                                                                 ...
                                                                 where act.package_id = substr(cargdoso, 4, 8)
                                                                   ...
                                                                   and oo.created_date <= '30-04-2017 23:59:59'
                                                 ...
                                                 where VENTAS > 0
                                                   ...
                                                   and ort.product_id not in (select h.hcecnuse
                                                                               ...
                                                                               where h.hcecnuse = ort.product_id
                                                                                    --and h.hcececan = 96
                                                                                 and h.hcececac = 1
                                                                                 and h.hcecfech <= '30-04-2017 23:59:59')) xx
                         ...
                         where nuse not in
                               (select h.hcecnuse
                                  from open.hicaesco h
                                 where h.hcecfech <= '30-04-2017 23:59:59'
                                   and h.hcecnuse = nuse
