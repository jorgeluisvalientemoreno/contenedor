...
select *
  from 
(
SELECT TIPO, CEBE, DESCRIPCION_CEBE, DEPA, DESCRIPCION_DEPARTAMENTO, LOCA, DESCRIPCION, NUSE, CATE, DESC_CATEGORIA,
       EST_TECNICO, DES_TECNICO, CONCDESC, VR_INGRESO, SOLICITUD, TIPO_SOLICITUD, descripcion_tipo_solicitud,
       FEC_VENTA, FEC_CARGO, ING_REPORTADO, NOTAS
  FROM (select TIPO,
                CEBE,
                (SELECT cb.cebedesc
           ...
           from (select TIPO,
                             ...
                             from (select (select l.celocebe
                                          ...
                                          decode((SELECT 1
                                                  ...
                                                  WHERE OR_related_order.rela_order_type_id in (4, 13)
                                                    ...
                                                    AND OR_order.legalization_date <= '30-11-2016 23:59:59'
                                    ...
                                    where m.invmsesu not in
                                          (select h.hcecnuse
                                            ...
                                            where h.hcececan = 96
                                              and h.hcececac = 1
                                              and hcecserv = 7014
                                              and h.hcecfech <= '30-11-2016 23:59:59'
                                                                 ...
                                                                 and h.hcecfech =
                                                                     (select max(st.hcecfech)
                                                                       ...
                                                                       where st.hcecnuse = product_id
                                                                         and st.hcecfech <= '30-11-2016 23:59:59')) est_tecnico,
                                                             sesucate,
                                               ...
                                               from (select cargnuse,
                                                             ...
                                                             (select count(*) from open.or_order_activity act, open.or_order oo
                                                               where act.package_id = substr(cargdoso,4,8)
                                                                 ...
                                                                 and oo.created_date <= '30-11-2016 23:59:59'
                                                ...
                                                and ort.product_id not in
                                                    (select h.hcecnuse
                                                      ...
                                                      where h.hcecnuse =
                                                           ...
                                                           --and h.hcececan = 96
                                                        and h.hcececac = 1
                                                        and h.hcecfech <= '30-11-2016 23:59:59')) xx
                                     group by cebe,
                                              loca,
                                              product_id,
                                              cargconc,
                   ...
                   where nuse not in
                         (select h.hcecnuse
                            from open.hicaesco h
                           where h.hcecfech <= '30-11-2016 23:59:59'
                             and h.hcecnuse = nuse
...
select construct, loca, concepto, total,  
       (select sum(decode(cargsign, 'DB', cargvalo, -cargvalo)) tot_gen
         ...
         where cc.cargnuse = construct
           ...
           AND factfege <= to_Date('30-11-2016 23:59:59', 'dd/mm/yyyy hh24:mi:ss')
           AND cucofact =  factcodi
           AND cargfecr <= to_Date('30-11-2016 23:59:59', 'dd/mm/yyyy hh24:mi:ss')
           AND cargcuco >  0
           AND cargtipr =  'A'
       ...
       and c.cargnuse in 
               (select distinct cargnuse--, solicitud
                  from (
                        select cargnuse, substr(cargdoso, 4, 8) SOLICITUD,
                               ...
                               (select count(*) from open.or_order_activity act, open.or_order oo
                                 where act.package_id  =  substr(cargdoso, 4, 8)
                                   and act.order_id    =  oo.order_id
                                   and oo.created_date <= '30-11-2016 23:59:59' -- fecha final del mes de proceso
                                   and (oo.task_type_id in (12150, 12152, 12153)
                                        OR (oo.task_type_id = 12149
                                            and act.package_id not in (select att.package_id
                                                                         from open.or_order_activity att, open.or_order ot
                         ...
                         where cargcuco != -1
                           ...
                           and FACTFEGE BETWEEN '09-02-2015 00:00:00' -- fecha fija
                                            and '30-11-2016 23:59:59' -- fecha final mes anterior
                 ...
                 where VENTAS > 0
                   ...
                   --                              and h.hcececac = 1 and h.hcecfech <= '30-11-2016 23:59:59') -- fecha final mes anterior
               )
