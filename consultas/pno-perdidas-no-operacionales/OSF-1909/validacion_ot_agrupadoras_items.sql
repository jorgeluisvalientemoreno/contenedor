-- validacion_ot_agrupadoras_items
...
inner join open.or_order_items oi2 on oi2.order_id = a.order_id and oi.items_id = oi2.items_id
...
--and   ag.orden_agrupadora  in (305899104)
