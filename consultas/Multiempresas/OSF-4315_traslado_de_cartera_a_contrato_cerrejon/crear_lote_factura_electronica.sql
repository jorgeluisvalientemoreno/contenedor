...
begin
  ...
  update factura set factfege = trunc(sysdate) where factcodi in (2153989837);
  
/* 
  delete factura_elect_general where documento in (2153989837);
  delete facturas_emitidas  where documento in (2153989837);*/
