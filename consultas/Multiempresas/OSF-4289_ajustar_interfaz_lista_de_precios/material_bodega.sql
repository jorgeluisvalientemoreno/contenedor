select  a.operating_unit_id, 
    ...
    open.daor_operating_unit.fnugetcontractor_id(a.operating_unit_id,null) contratista, 
    a.items_id,
...
where 1 = 1
and   a.operating_unit_id in (4639)
and   inv.balance > 0
and      a.items_id = 10000089
order by a.operating_unit_id, a.items_id



--update or_ope_uni_item_bala a1 set a1.balance = 1 where a1.operating_unit_id = 4639 and  a1.items_id = 10000089
