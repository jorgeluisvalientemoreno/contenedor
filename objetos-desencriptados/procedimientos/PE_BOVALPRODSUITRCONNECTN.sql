  ...
  CREATE OR REPLACE PACKAGE "OPEN"."PE_BOVALPRODSUITRCONNECTN" AS
/*
...
CREATE OR REPLACE PACKAGE BODY "OPEN"."PE_BOVALPRODSUITRCONNECTN" AS
/*
    Propiedad intelectual de Open International Systems (c).
...
--------------------------------------------------------------------------------
    ...
    */
    ...
    BEGIN
        ...
        if (rcServsusc.sesuesco in (gnuCutOffStatusPartial,gnuCutOffStatusTotal,gnuCutOrderSuspension) AND nuValCarCast=0 AND osbHasRecPayOrd=ge_boConstants.csbNO) then
