CREATE OR REPLACE PACKAGE BODY OR_BOITEMVALUE IS
   CSBVERSION CONSTANT VARCHAR2( 20 ) := 'SAO233662';
   ...
   FUNCTION FSBVERSION
    ...
    BEGIN
      RETURN CSBVERSION;
   END;
   FUNCTION FNUGETGENERICVALUE( INUITEMID IN GE_ITEMS.ITEMS_ID%TYPE, IDTASSIGNED IN OR_ORDER.ASSIGNED_DATE%TYPE )
   ...
   END;
   PROCEDURE GETCOSTLISTVALUE( INUITEMID IN GE_ITEMS.ITEMS_ID%TYPE, INUOPERUNIT IN OR_OPERATING_UNIT.OPERATING_UNIT_ID%TYPE, IDTASSIGNED IN OR_ORDER.ASSIGNED_DATE%TYPE, INUAMOUNT IN OR_ORDER_ITEMS.LEGAL_ITEM_AMOUNT%TYPE, ONUTOTALVALUEITEM OUT GE_UNIT_COST_ITE_LIS.PRICE%TYPE, INUORDER IN OR_ORDER_ITEMS.ORDER_ID%TYPE := NULL, INUCONTRACTORID IN GE_CONTRATO.ID_CONTRATISTA%TYPE := NULL, INUCONTRACTID IN GE_CONTRATO.ID_CONTRATO%TYPE := NULL )
    IS
      NUVALUE GE_UNIT_COST_ITE_LIS.PRICE%TYPE;
    BEGIN
      UT_TRACE.TRACE( '[OR_BOItemValue.GetCostListValue] INICIO', 3 );
      NUVALUE := FNUGETITEMCOST( INUITEMID, INUOPERUNIT, INUORDER, INUCONTRACTORID, INUCONTRACTID );
   ...
   PROCEDURE GETAVERAGECOSTVALUE( INUITEMID IN GE_ITEMS.ITEMS_ID%TYPE, INUOPERUNITID IN OR_OPERATING_UNIT.OPERATING_UNIT_ID%TYPE, INUAMOUNT IN OR_ORDER_ITEMS.LEGAL_ITEM_AMOUNT%TYPE, ONUBALANCE OUT OR_OPE_UNI_ITEM_BALA.BALANCE%TYPE, ONUBALANCEPRICE OUT OR_OPE_UNI_ITEM_BALA.TOTAL_COSTS%TYPE, ONUTOTALVALUEITEM OUT OR_OPE_UNI_ITEM_BALA.TOTAL_COSTS%TYPE )
    IS
      NUPRICEQUANTITY OR_OPE_UNI_ITEM_BALA.TOTAL_COSTS%TYPE := 0;
      FUNCTION FNUGETAVERAGECOSTVALUEALLOPUN( INUITEMID IN GE_ITEMS.ITEMS_ID%TYPE )
       RETURN NUMBER
       IS
         NUTOTALVALUE OR_OPE_UNI_ITEM_BALA.TOTAL_COSTS%TYPE := 0;
         CURSOR CUAVERAGECOSTVALUEALLOPUN( NUITEMID IN GE_ITEMS.ITEMS_ID%TYPE ) IS
SELECT sum(total_costs)/sum(balance)
       ...
       BEGIN
         ...
         FETCH CUAVERAGECOSTVALUEALLOPUN
            INTO NUTOTALVALUE;
         CLOSE CUAVERAGECOSTVALUEALLOPUN;
         RETURN NUTOTALVALUE;
       EXCEPTION
    ...
    BEGIN
      ...
      IF DAOR_OPE_UNI_ITEM_BALA.FBLEXIST( INUITEMID, INUOPERUNITID ) THEN
         NUPRICEQUANTITY := OR_BOOPEUNIITEMBALA.FNUGETITEMSPRICE( INUITEMID, INUOPERUNITID, INUAMOUNT );
       ELSE
    ...
    EXCEPTION
      ...
      WHEN OTHERS THEN
         ...
         RAISE EX.CONTROLLED_ERROR;
   END;
   PROCEDURE GETITEMVALUEANDCOSTMETHOD( INUITEMID IN GE_ITEMS.ITEMS_ID%TYPE, INUAMOUNT IN OR_ORDER_ITEMS.LEGAL_ITEM_AMOUNT%TYPE, INUOPERUNITID IN OR_OPERATING_UNIT.OPERATING_UNIT_ID%TYPE, IDTASSIGNED IN OR_ORDER.ASSIGNED_DATE%TYPE, ISBOUT_ IN OR_ORDER_ITEMS.OUT_%TYPE, ONUBALANCE OUT OR_OPE_UNI_ITEM_BALA.BALANCE%TYPE, ONUBALANCEPRICE OUT OR_OPE_UNI_ITEM_BALA.TOTAL_COSTS%TYPE, ONUTOTALVALUEITEM OUT OR_ORDER_ITEMS.VALUE%TYPE, OSBCOSTMETHOD OUT GE_ITEM_CLASSIF.COST_METHOD%TYPE, OSBQUANTITYCONTROL OUT GE_ITEM_CLASSIF.QUANTITY_CONTROL%TYPE, ISBFORCELISTCOST IN VARCHAR2 := GE_BOCONSTANTS.CSBNO, INUORDER IN OR_ORDER.ORDER_ID%TYPE := NULL, INUCONTRACTORID IN GE_CONTRATO.ID_CONTRATISTA%TYPE := NULL, INUCONTRACTID IN GE_CONTRATO.ID_CONTRATO%TYPE := NULL, INUADRESSID IN AB_ADDRESS.ADDRESS_ID%TYPE := NULL )
    IS
    ...
    BEGIN
      ...
      IF ( ( ISBOUT_ IS NULL AND OSBQUANTITYCONTROL != OR_BOCONSTANTS.CNUINCREASE ) OR ( NVL( ISBOUT_, GE_BOCONSTANTS.CSBNO ) = GE_BOCONSTANTS.CSBYES ) ) THEN
         IF ( OSBCOSTMETHOD = CSBCOSTLIST ) THEN
            IF ( INUADRESSID IS NOT NULL ) THEN
               ONUTOTALVALUEITEM := OR_BOITEMVALUE.FNUGETITEMCOSTTOCOTI( INUITEMID, NUOPEUNIMOV, INUADRESSID, INUCONTRACTORID, INUCONTRACTID );
             ELSE
               GETCOSTLISTVALUE( INUITEMID, NUOPEUNIMOV, IDTASSIGNED, INUAMOUNT, ONUTOTALVALUEITEM, INUORDER, INUCONTRACTORID, INUCONTRACTID );
            END IF;
          ELSE
            GETAVERAGECOSTVALUE( INUITEMID, NUOPEUNIMOV, INUAMOUNT, ONUBALANCE, ONUBALANCEPRICE, ONUTOTALVALUEITEM );
         END IF;
       ELSE
         ONUTOTALVALUEITEM := 0;
      END IF;
    ...
    EXCEPTION
      ...
      WHEN OTHERS THEN
         ...
         RAISE EX.CONTROLLED_ERROR;
   END;
   PROCEDURE GETITEMVALUEPLANNEDORDER( INUORDERID IN OR_ORDER.ORDER_ID%TYPE, INUITEMID IN GE_ITEMS.ITEMS_ID%TYPE, INUITEMAMOUNT IN OR_PLANNED_ITEMS.ITEM_AMOUNT%TYPE, ONUITEMVALUE OUT OR_PLANNED_ITEMS.VALUE%TYPE )
    IS
    ...
    BEGIN
      ...
      GETITEMVALUEANDCOSTMETHOD( INUITEMID, INUITEMAMOUNT, NULL, DTASSIGNED, SBOUT_, NUBALANCE, NUBALANCEPRICE, ONUITEMVALUE, SBCOSTMETHOD, SBQUANTITYCONTROL );
    ...
    EXCEPTION
      ...
      WHEN OTHERS THEN
         ...
         RAISE EX.CONTROLLED_ERROR;
   END;
   PROCEDURE GETPLANNEDITEMSVALUE( INUPACKAGEID IN OR_ORDER_ACTIVITY.PACKAGE_ID%TYPE, ISBTASKTYPELIST IN VARCHAR2, ISBITEMSLIST IN VARCHAR2, ONUVALUE OUT NUMBER )
    IS
      SBTASKTYPELIST VARCHAR2( 4000 );
      SBITEMSLIST VARCHAR2( 4000 );
      PROCEDURE GETPLANNEDITEMSVALUEFORTASITE( INUPACKAGEID IN OR_ORDER_ACTIVITY.PACKAGE_ID%TYPE, ISBTASKTYPELIST IN VARCHAR2, ISBITEMSLIST IN VARCHAR2, ONUVALUE OUT NUMBER )
       IS
       ...
       BEGIN
         ...
         FETCH OR_BCPLANNINGACTIVIT.CUORDERBYPACKAGEIDPENDFORTAIT
            INTO ONUVALUE;
         CLOSE OR_BCPLANNINGACTIVIT.CUORDERBYPACKAGEIDPENDFORTAIT;
       EXCEPTION
         WHEN EX.CONTROLLED_ERROR THEN
         ...
         WHEN OTHERS THEN
            ...
            RAISE EX.CONTROLLED_ERROR;
      END;
      PROCEDURE GETPLANNEDITEMSVALUEFORITE( INUPACKAGEID IN OR_ORDER_ACTIVITY.PACKAGE_ID%TYPE, ISBITEMSLIST IN VARCHAR2, ONUVALUE OUT NUMBER )
       IS
         PROCEDURE CLOSE_CURSOR
          IS
          BEGIN
       ...
       BEGIN
         ...
         FETCH OR_BCPLANNINGACTIVIT.CUORDERBYPACKAGEIDPENDFORIT
            INTO ONUVALUE;
         CLOSE OR_BCPLANNINGACTIVIT.CUORDERBYPACKAGEIDPENDFORIT;
       EXCEPTION
         WHEN EX.CONTROLLED_ERROR THEN
         ...
         WHEN OTHERS THEN
            ...
            RAISE EX.CONTROLLED_ERROR;
      END;
      PROCEDURE GETPLANNEDITEMSVALUEFORTAS( INUPACKAGEID IN OR_ORDER_ACTIVITY.PACKAGE_ID%TYPE, ISBTASKTYPELIST IN VARCHAR2, ONUVALUE OUT NUMBER )
       IS
         PROCEDURE CLOSE_CURSOR
          IS
          BEGIN
       ...
       BEGIN
         ...
         FETCH OR_BCPLANNINGACTIVIT.CUORDERBYPACKAGEIDPENDFORTA
            INTO ONUVALUE;
         CLOSE OR_BCPLANNINGACTIVIT.CUORDERBYPACKAGEIDPENDFORTA;
       EXCEPTION
         WHEN EX.CONTROLLED_ERROR THEN
         ...
         WHEN OTHERS THEN
            ...
            RAISE EX.CONTROLLED_ERROR;
      END;
      PROCEDURE GETPLANNEDITEMSVALUEALL( INUPACKAGEID IN OR_ORDER_ACTIVITY.PACKAGE_ID%TYPE, ONUVALUE OUT NUMBER )
       IS
         PROCEDURE CLOSE_CURSOR
          IS
          BEGIN
       ...
       BEGIN
         ...
         FETCH OR_BCPLANNINGACTIVIT.CUORDERBYPACKAGEIDPEND
            INTO ONUVALUE;
         CLOSE OR_BCPLANNINGACTIVIT.CUORDERBYPACKAGEIDPEND;
       EXCEPTION
         WHEN EX.CONTROLLED_ERROR THEN
         ...
         WHEN OTHERS THEN
            ...
            RAISE EX.CONTROLLED_ERROR;
      END;
      FUNCTION FSBGETCOMPOSESTRING( ISBSTRING IN VARCHAR2 )
       RETURN VARCHAR2
       IS
    ...
    EXCEPTION
      ...
      WHEN OTHERS THEN
         ...
         RAISE EX.CONTROLLED_ERROR;
   END;
   FUNCTION FNUGETOPERATIVEAIU( INUORDER IN OR_ORDER.ORDER_ID%TYPE, INUORDERVALUE IN OR_ORDER.ORDER_COST_BY_LIST%TYPE, INUITEMID IN GE_ITEMS.ITEMS_ID%TYPE, INUOPERUNITID IN OR_OPERATING_UNIT.OPERATING_UNIT_ID%TYPE := NULL )
    ...
    BEGIN
      ...
      IF DAGE_ITEMS.FNUGETITEM_CLASSIF_ID( INUITEMID ) IN ( OR_BOCONSTANTS.CNUITEMS_CLASS_TO_ACTIVITY, CNUACTIVIDADESSECUNDARIAS, CNUSUMINISTRUNIDCONSTR ) THEN
         ...
         IF ( RCOPERATINGUNIT.AIU_VALUE_ADMIN > 0 OR RCOPERATINGUNIT.AIU_VALUE_UNEXPECTED > 0 OR RCOPERATINGUNIT.AIU_VALUE_UTIL > 0 ) THEN
            NUPORCENTAJE := NVL( RCOPERATINGUNIT.AIU_VALUE_ADMIN, 0 ) + NVL( RCOPERATINGUNIT.AIU_VALUE_UNEXPECTED, 0 ) + NVL( RCOPERATINGUNIT.AIU_VALUE_UTIL, 0 );
            UT_TRACE.TRACE( 'Tiene en cuenta el AIU de la Unidad de Trabajo : ' || NUPORCENTAJE, 2 );
          ELSIF ( RCCONTRACT.VALOR_AUI_ADMIN IS NOT NULL OR RCCONTRACT.VALOR_AUI_UTIL IS NOT NULL OR RCCONTRACT.VALOR_AUI_IMPREV IS NOT NULL ) THEN
            NUPORCENTAJE := NVL( RCCONTRACT.VALOR_AUI_ADMIN, 0 ) + NVL( RCCONTRACT.VALOR_AUI_UTIL, 0 ) + NVL( RCCONTRACT.VALOR_AUI_IMPREV, 0 );
            UT_TRACE.TRACE( 'Tiene en cuenta el AIU del contrato: ' || NUPORCENTAJE, 2 );
          ELSE
            NUPORCENTAJE := FNUGETDEFAULTAIUOPER;
            UT_TRACE.TRACE( 'Tiene en cuenta AIU según parámetros del sistema: ' || NUPORCENTAJE, 2 );
         END IF;
   ...
   FUNCTION FNUGETADMINAIU( INUORDERVALUE IN OR_ORDER.ORDER_COST_BY_LIST%TYPE, INUOPERATIVEAIU IN OR_ORDER.OPERATIVE_AIU_VALUE%TYPE )
    RETURN OR_ORDER.OPERATIVE_AIU_VALUE%TYPE
    IS
      NURESULT OR_ORDER.OPERATIVE_AIU_VALUE%TYPE;
      NUAIU NUMBER;
    BEGIN
      NUAIU := NVL( GE_BOPARAMETER.FNUGET( 'AIU_ADMIN_ADMIN' ), 0 ) + NVL( GE_BOPARAMETER.FNUGET( 'AIU_ADMIN_UNEXPECTED' ), 0 ) + NVL( GE_BOPARAMETER.FNUGET( 'AIU_ADMIN_UTIL' ), 0 );
      IF ( NUAIU = 0 ) THEN
         RETURN 0;
      END IF;
    ...
    EXCEPTION
      ...
      WHEN OTHERS THEN
         ...
         RAISE EX.CONTROLLED_ERROR;
   END;
   FUNCTION FNUGETITEMVALUE( INUITEMID IN GE_ITEMS.ITEMS_ID%TYPE, INUREQUESTOPERUNIT IN OR_OPERATING_UNIT.OPERATING_UNIT_ID%TYPE )
    ...
    BEGIN
      ...
      GE_BCCERTCONTRATISTA.OBTENERCOSTOITEMLISTA( INUITEMID, UT_DATE.FDTSYSDATE, NULL, NULL, INUREQUESTOPERUNIT, NULL, NUPRICELISTID, NUVALUE, NUSALESVALUE );
    ...
    EXCEPTION
      ...
      WHEN OTHERS THEN
         ...
         RAISE EX.CONTROLLED_ERROR;
   END FNUGETITEMVALUE;
   FUNCTION FNUGETITEMCOST( INUITEMID IN GE_ITEMS.ITEMS_ID%TYPE, INUREQUESTOPERUNIT IN OR_OPERATING_UNIT.OPERATING_UNIT_ID%TYPE, INUORDER IN OR_ORDER_ITEMS.ORDER_ID%TYPE := NULL, INUCONTRACTORID IN GE_CONTRATO.ID_CONTRATISTA%TYPE := NULL, INUCONTRACTID IN GE_CONTRATO.ID_CONTRATO%TYPE := NULL )
    RETURN GE_UNIT_COST_ITE_LIS.PRICE%TYPE
    IS
      NUVALUE GE_UNIT_COST_ITE_LIS.PRICE%TYPE;
      NUSALESVALUE GE_UNIT_COST_ITE_LIS.SALES_VALUE%TYPE;
      ...
      PROCEDURE CLEARCACHE
       ...
       EXCEPTION
         ...
         WHEN OTHERS THEN
            ...
            RAISE EX.CONTROLLED_ERROR;
      END CLEARCACHE;
      PROCEDURE LOADCACHE( INUREQUESTITEMID IN GE_ITEMS.ITEMS_ID%TYPE, INUREQUESTOPERUNITID IN OR_OPERATING_UNIT.OPERATING_UNIT_ID%TYPE, INUUNITARYCOSTID IN GE_UNIT_COST_ITE_LIS.LIST_UNITARY_COST_ID%TYPE )
       IS
       BEGIN
         IF ( GNUITEMID != INUREQUESTITEMID OR GNUOPERUNITID != INUREQUESTOPERUNITID ) THEN
            CLEARCACHE;
    ...
    BEGIN
      ...
      IF ( INUORDER IS NOT NULL ) THEN
         NULOCATIONID := GE_BOCERTCONTRATISTA.FNUGETGEOLOCATIONBYADDRESS( DAOR_ORDER.FNUGETEXTERNAL_ADDRESS_ID( INUORDER ) );
      END IF;
      GE_BCCERTCONTRATISTA.OBTENERCOSTOITEMLISTA( INUITEMID, UT_DATE.FDTSYSDATE, NULOCATIONID, INUCONTRACTORID, INUREQUESTOPERUNIT, INUCONTRACTID, NUPRICELISTID, NUVALUE, NUSALESVALUE );
    ...
    EXCEPTION
      ...
      WHEN OTHERS THEN
         ...
         RAISE EX.CONTROLLED_ERROR;
   END FNUGETITEMCOST;
   FUNCTION FNUGETITEMOPERCOST( INUORDER IN OR_ORDER.ORDER_ID%TYPE, INUITEMID IN GE_ITEMS.ITEMS_ID%TYPE, INUAMOUNT IN OR_ORDER_ITEMS.LEGAL_ITEM_AMOUNT%TYPE, INUOPERUNITID IN OR_OPERATING_UNIT.OPERATING_UNIT_ID%TYPE, IDTASSIGNED IN OR_ORDER.ASSIGNED_DATE%TYPE, INUCONTRACTORID IN GE_CONTRATO.ID_CONTRATISTA%TYPE := NULL, INUCONTRACTID IN GE_CONTRATO.ID_CONTRATO%TYPE := NULL, ISBOUT_ IN OR_ORDER_ITEMS.OUT_%TYPE := GE_BOCONSTANTS.CSBYES, ISBFORCELISTCOST IN VARCHAR2 := GE_BOCONSTANTS.CSBNO )
    ...
    BEGIN
      ...
      END IF;
      GETITEMVALUEANDCOSTMETHOD( INUITEMID, INUAMOUNT, INUOPERUNITID, IDTASSIGNED, ISBOUT_, NUBALANCE, NUBALANCEPRICE, NUTOTALVALUEITEM, SBCOSTMETHOD, SBQUANTITYCONTROL, ISBFORCELISTCOST, INUORDER, NUCONTRACTORID, NUCONTRACTID );
   ...
   FUNCTION FNUGETITEMVALUEPLANNEDORDER( INUACTIVITYID IN OR_PLANNED_ACTIVIT.ACTIVITY_ID%TYPE, INUORDERID IN OR_ORDER.ORDER_ID%TYPE, INUOPERUNITID IN OR_OPERATING_UNIT.OPERATING_UNIT_ID%TYPE, IDTASSIGNEDDATE IN OR_ORDER.ASSIGNED_DATE%TYPE )
    RETURN NUMBER
    IS
    ...
    BEGIN
      ...
      OR_BOITEMVALUE.GETITEMVALUEPLANNEDORDER( INUORDERID, INUACTIVITYID, 1, NUITEMVALUE );
   ...
   FUNCTION FNUGETITEMCOSTTOCOTI( INUITEMID IN GE_ITEMS.ITEMS_ID%TYPE, INUOPERUNIT IN OR_OPERATING_UNIT.OPERATING_UNIT_ID%TYPE := NULL, INUADRESSID IN AB_ADDRESS.ADDRESS_ID%TYPE := NULL, INUCONTRACTORID IN GE_CONTRATO.ID_CONTRATISTA%TYPE := NULL, INUCONTRACTID IN GE_CONTRATO.ID_CONTRATO%TYPE := NULL )
    RETURN GE_UNIT_COST_ITE_LIS.PRICE%TYPE
    IS
      NUVALUE GE_UNIT_COST_ITE_LIS.PRICE%TYPE;
      NUSALESVALUE GE_UNIT_COST_ITE_LIS.SALES_VALUE%TYPE;
      NULOCATIONID GE_GEOGRA_LOCATION.GEOGRAP_LOCATION_ID%TYPE;
    BEGIN
      UT_TRACE.TRACE( 'INICIO OR_BOItemValue.fnuGetItemCostToCoti. inuItemId: ' || TO_CHAR( INUITEMID ) || ' inuOperUnit: ' || TO_CHAR( INUOPERUNIT ) || ' inuAdressId: ' || TO_CHAR( INUADRESSID ) || ' inuContractorId: ' || TO_CHAR( INUCONTRACTORID ) || ' inuContractId: ' || TO_CHAR( INUCONTRACTID ), 2 );
      IF ( INUADRESSID IS NOT NULL ) THEN
         NULOCATIONID := GE_BOCERTCONTRATISTA.FNUGETGEOLOCATIONBYADDRESS( INUADRESSID );
      END IF;
      GE_BCCERTCONTRATISTA.OBTENERCOSTOITEMLISTA( INUITEMID, UT_DATE.FDTSYSDATE, NULOCATIONID, INUCONTRACTORID, INUOPERUNIT, INUCONTRACTID, NUPRICELISTID, NUVALUE, NUSALESVALUE );
   ...
   FUNCTION FNUGETPRICELISTID
    RETURN GE_UNIT_COST_ITE_LIS.LIST_UNITARY_COST_ID%TYPE
    IS
    BEGIN
   ...
   PROCEDURE GETLIQMETHOD( INUORDERID IN OR_ORDER.ORDER_ID%TYPE, IONUPACKAGEID IN OUT MO_PACKAGES.PACKAGE_ID%TYPE, ONULIQMETHOD OUT PS_PACKAGE_TYPE.LIQUIDATION_METHOD%TYPE )
    IS
      NUPACKAGEID MO_PACKAGES.PACKAGE_ID%TYPE;
    ...
    EXCEPTION
      ...
      WHEN OTHERS THEN
         ...
         RAISE EX.CONTROLLED_ERROR;
   END GETLIQMETHOD;
   FUNCTION FNUGETITEMPRICE( INUITEMID IN GE_ITEMS.ITEMS_ID%TYPE, INUOPERUNITID IN OR_OPERATING_UNIT.OPERATING_UNIT_ID%TYPE, INUADDRESSID IN AB_ADDRESS.ADDRESS_ID%TYPE, INUTASKTYPEID IN OR_TASK_TYPE.TASK_TYPE_ID%TYPE )
    RETURN GE_UNIT_COST_ITE_LIS.SALES_VALUE%TYPE
    IS
    ...
    BEGIN
      UT_TRACE.TRACE( 'INICIO OR_BOItemValue.fnuGetItemPrice. inuItemId: ' || TO_CHAR( INUITEMID ) || ' inuOperUnitId: ' || TO_CHAR( INUOPERUNITID ) || ' inuAddressId: ' || TO_CHAR( INUADDRESSID ) || ' inuTaskTypeId: ' || TO_CHAR( INUTASKTYPEID ), 2 );
      IF ( INUADDRESSID IS NOT NULL ) THEN
         NULOCATIONID := GE_BOCERTCONTRATISTA.FNUGETGEOLOCATIONBYADDRESS( INUADDRESSID );
      END IF;
      ...
      END IF;
      GE_BCCERTCONTRATISTA.OBTENERCOSTOITEMLISTA( INUITEMID, UT_DATE.FDTSYSDATE, NULOCATIONID, NUCONTRACTORID, INUOPERUNITID, NUCONTRACTID, NUPRICELISTID, NUCOST, NUPRICE );
      UT_TRACE.TRACE( 'FIN OR_BOItemValue.fnuGetItemPrice. nuCost: ' || TO_CHAR( NUCOST ) || ' nuPrice: ' || TO_CHAR( NUPRICE ) || ' nuLocationId: ' || TO_CHAR( NULOCATIONID ) || ' nuPriceListId: ' || TO_CHAR( NUPRICELISTID ), 2 );
   ...
   FUNCTION FNUGETDEFAULTAIUOPER
    ...
    BEGIN
      ...
      END IF;
      NUOPERAIU := GNUDEFAULTAIU_OPER_ADMIN + GNUDEFAULTAIU_OPER_UNEXPECTED + GNUDEFAULTAIU_OPER_UTIL;
