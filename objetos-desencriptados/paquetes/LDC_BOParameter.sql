PACKAGE LDC_BOParameter AS
    ...
    CSBYES               CONSTANT    VARCHAR2(3) := 'Y';
    CSBNO                CONSTANT    VARCHAR2(2) := 'N';
    
    
    
    TYPE TYTBPARAMETER_ID IS TABLE OF GE_PARAMETER.PARAMETER_ID%TYPE INDEX BY BINARY_INTEGER;
    TYPE TYTBDATA_TYPE IS TABLE OF GE_PARAMETER.DATA_TYPE%TYPE INDEX BY BINARY_INTEGER;
    TYPE TYTBVALUE IS TABLE OF GE_PARAMETER.VALUE%TYPE INDEX BY BINARY_INTEGER;
    ...
    PROCEDURE UPDATEPARAMETERVALUE(ISBPARAMETER_ID IN VARCHAR2, SBVALUE IN VARCHAR2);
    ...
    PROCEDURE VALPARAMLISTCOST ( SBNEWVALUE VARCHAR2);
